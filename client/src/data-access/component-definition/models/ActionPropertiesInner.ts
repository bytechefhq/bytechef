...
/**
 * @type ActionPropertiesInner
 * 
 * @export
 */
export type ActionPropertiesInner = AnyProperty | ArrayProperty | BooleanProperty | DateProperty | DateTimeProperty | IntegerProperty | NullProperty | NumberProperty | ObjectProperty | StringProperty;

export function ActionPropertiesInnerFromJSON(json: any): ActionPropertiesInner {
    return ActionPropertiesInnerFromJSONTyped(json, false);
}

export function ActionPropertiesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ActionPropertiesInner {
...
export function ActionPropertiesInnerToJSON(value?: ActionPropertiesInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
