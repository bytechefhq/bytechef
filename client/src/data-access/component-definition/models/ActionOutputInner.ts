...
/**
 * @type ActionOutputInner
 * 
 * @export
 */
export type ActionOutputInner = AnyProperty | ArrayProperty | BooleanProperty | DateProperty | DateTimeProperty | IntegerProperty | NullProperty | NumberProperty | ObjectProperty | StringProperty;

export function ActionOutputInnerFromJSON(json: any): ActionOutputInner {
    return ActionOutputInnerFromJSONTyped(json, false);
}

export function ActionOutputInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ActionOutputInner {
...
export function ActionOutputInnerToJSON(value?: ActionOutputInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
