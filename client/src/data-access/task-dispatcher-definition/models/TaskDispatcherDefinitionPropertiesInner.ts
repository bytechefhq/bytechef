...
/**
 * @type TaskDispatcherDefinitionPropertiesInner
 * 
 * @export
 */
export type TaskDispatcherDefinitionPropertiesInner = AnyProperty | ArrayProperty | BooleanProperty | DateProperty | DateTimeProperty | IntegerProperty | NullProperty | NumberProperty | ObjectProperty | StringProperty;

export function TaskDispatcherDefinitionPropertiesInnerFromJSON(json: any): TaskDispatcherDefinitionPropertiesInner {
    return TaskDispatcherDefinitionPropertiesInnerFromJSONTyped(json, false);
}

export function TaskDispatcherDefinitionPropertiesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaskDispatcherDefinitionPropertiesInner {
...
export function TaskDispatcherDefinitionPropertiesInnerToJSON(value?: TaskDispatcherDefinitionPropertiesInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
