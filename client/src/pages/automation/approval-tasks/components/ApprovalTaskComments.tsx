...
import {formatTimestamp, getInitials} from '../utils/approval-task-utils';
import {useApprovalTaskComments} from './hooks/useApprovalTaskComments';

import type {ApprovalTaskCommentI} from '../types/types';

interface ApprovalTaskCommentsProps {
    comments: ApprovalTaskCommentI[];
}

export default function ApprovalTaskComments({comments}: ApprovalTaskCommentsProps) {
    const {canSubmit, handleCommentChange, handleSubmitComment, newComment} = useApprovalTaskComments();
