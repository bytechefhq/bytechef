...
import {getPriorityLabel, getStatusLabel} from '../utils/approval-task-utils';
import {useApprovalTaskActiveFilterBadges} from './hooks/useApprovalTaskActiveFilterBadges';

export default function ApprovalTaskActiveFilterBadges() {
    const {
        filters,
        ...
        handleResetFilters,
        hasActiveFilters,
    } = useApprovalTaskActiveFilterBadges();
