...
import {useApprovalTaskSearch} from './hooks/useApprovalTaskSearch';

export default function ApprovalTaskSearch() {
    const {
        handleInputFocus,
        handleKeyDown,
        handleSearchChange,
        ...
        <div className="relative">
            <div className="relative w-full">
                ...
                <Input
                    ...
                    placeholder="Search approval tasks..."
                    ref={searchInputRef}
                    value={searchQuery}
                />
            </div>
