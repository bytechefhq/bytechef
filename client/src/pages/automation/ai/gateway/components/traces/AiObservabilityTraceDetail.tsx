...
const AiObservabilityTraceDetail = ({onBack, traceId}: AiObservabilityTraceDetailProps) => {
    ...
    return (
        <div className="w-full px-2 2xl:mx-auto 2xl:w-4/5">
            ...
            {experimentRun != null && (
                <div className="mb-4 flex items-center gap-2 rounded-md border border-amber-300 bg-amber-50 px-4 py-3 text-sm dark:border-amber-700 dark:bg-amber-950/40">
                    <FlaskConicalIcon className="size-4 shrink-0 text-amber-700 dark:text-amber-300" />
