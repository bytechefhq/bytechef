...
interface ComponentsListProps {
    componentDefinitions: ComponentDefinitionBasicModel[] | undefined;
    taskDispatcherDefinitions: TaskDispatcherDefinitionModel[] | undefined;
    edge?: boolean;
...
WorkflowNodes.displayName = 'WorkflowNodes';
