...
import {useCreateSigningKeyMutation, useUpdateSigningKeyMutation} from '@/mutations/embedded/signingKeys.mutations';
                    ...
                    <form className="flex flex-col gap-4" onSubmit={handleSubmit(saveSigningKey)}>
                        <DialogHeader>
                            <div className="flex items-center justify-between">
                                <DialogTitle>
                                    {privateKey
                                        ? 'Save your private Signing Key'
                                        : `${signingKey?.id ? 'Edit' : 'Create'}`}{' '}
                                    Signing Key
                                </DialogTitle>
                        ...
                        {privateKey ? (
                            <div className="space-y-4">
                                ...
                                <div className="flex flex-col space-y-1">
                                    <Textarea readOnly={true} value={privateKey} />
