...
const WorkflowNodeDetailsPanel = ({
    ...
    return (
        <div
            className="absolute inset-y-4 right-[69px] z-10 w-screen max-w-workflow-node-details-panel-width overflow-hidden rounded-lg border border-border/50 bg-background"
