...
const WorkflowNodeDetailsPanel = ({
    ...
    return (
        <div
            className="max-w-workflow-node-details-panel-width absolute inset-y-4 right-4 z-10 w-screen overflow-hidden rounded-xl border border-muted bg-white shadow-lg"
