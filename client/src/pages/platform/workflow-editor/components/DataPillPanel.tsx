...
const DataPillPanel = ({
    ...
    return (
        <div className="absolute inset-y-4 right-data-pill-panel-placement z-10 w-screen max-w-data-pill-panel-width overflow-hidden rounded-lg border border-border/50 bg-background">
