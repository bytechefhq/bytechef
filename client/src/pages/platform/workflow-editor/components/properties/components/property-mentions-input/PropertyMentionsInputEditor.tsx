    ...
    (
        ...
        useEffect(() => {
            ...
            if (typeof propertyValue === 'string' && propertyValue.startsWith('=')) {
                console.log('setting editor value 1: ', propertyValue);
                setEditorValue(propertyValue.substring(1));
            } else {
                console.log('setting editor value 2: ', propertyValue);
        ...
        useEffect(() => {
            ...
            if (currentComponent?.metadata?.ui?.fromAi?.includes(path)) {
                ...
                editor.storage.fromAi.fromAi = isFromAi; // TODO: double-check this is needed
            }
