...
export const useProperty = ({
    ...
    useEffect(() => {
        ...
        if (Object.keys(parameters).length && (!propertyParameterValue || propertyParameterValue === defaultValue)) {
            ...
            if (valueFromDefinition !== undefined && valueFromDefinition !== null) {
                ...
                const valueFromParameters = encodedParameters[name];

                if (valueFromParameters !== undefined && valueFromParameters !== null) {
                    setPropertyParameterValue(valueFromParameters);
                }
            }
        }
    ...
    useEffect(() => {
        ...
        if (valueFromDefinition !== undefined) {
            setPropertyParameterValue(valueFromDefinition);
