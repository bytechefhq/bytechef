...
import CustomComponentList from '@/pages/settings/platform/custom-components/components/CustomComponentList';
import {useGetCustomComponentsQuery} from '@/pages/settings/platform/custom-components/queries/customComponents.queries';
