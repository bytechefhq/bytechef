...
import {IntegrationInstanceConfigurationModel, TagModel} from '@/middleware/embedded/configuration';
                ...
                <div className="flex flex-1 items-center border-b border-muted py-5 group-data-[state='open']:border-none">
                    ...
                    <div className="flex items-center justify-end gap-x-6">
                        <div className="flex flex-col items-end gap-y-4">
                            <Badge variant={integrationInstanceConfiguration.enabled ? 'success_outline' : 'secondary'}>
