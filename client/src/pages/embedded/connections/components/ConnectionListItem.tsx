...
import {ConnectionModel, TagModel} from '@/middleware/embedded/connection';
import {useUpdateConnectionTagsMutation} from '@/mutations/embedded/connectionTags.mutations';
import {useDeleteConnectionMutation, useUpdateConnectionMutation} from '@/mutations/embedded/connections.mutations';
import ConnectionDialog from '@/pages/platform/connection/components/ConnectionDialog';
import {ConnectionKeys, useGetConnectionTagsQuery} from '@/queries/embedded/connections.queries';
...
const ConnectionListItem = ({connection, remainingTags}: ConnectionListItemProps) => {
    ...
    return (
        <li key={connection.id}>
            <div className="group rounded-md bg-white px-2 py-5 hover:bg-gray-50">
