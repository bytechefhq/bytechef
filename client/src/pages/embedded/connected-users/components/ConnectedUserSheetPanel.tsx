...
import {useGetIntegrationInstanceQuery} from '@/shared/queries/embedded/integrationInstances.queries';
        ...
        <div className="flex w-full flex-col gap-4 p-4">
            <div className="flex w-full items-center justify-between">
                <div className="flex items-start space-x-2">
                    <h3 className="text-lg">{connectedUser.name ?? connectedUser.externalId}</h3>
