...
const IntegrationHeader = ({
    ...
    const createIntegrationWorkflowMutation = useCreateIntegrationWorkflowMutation({
        onSuccess: (workflow) => {
            ...
            navigate(`/embedded/integrations/${integrationId}/workflows/${workflow.id}`);
        },
    });
    ...
    const handleIntegrationWorkflowValueChange = (id: string) => {
        setWorkflowTestExecution(undefined);

        navigate(`/embedded/integrations/${integrationId}/workflows/${id}`);
    };
