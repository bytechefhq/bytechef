...
import IntegrationPortalConfigurationOverviewForm from '@/pages/embedded/integration/components/IntegrationPortalConfigurationOverviewForm';
import IntegrationPortalConfigurationSettings from '@/pages/embedded/integration/components/IntegrationPortalConfigurationSettings';
import IntegrationPortalConfigurationWorkflowList from '@/pages/embedded/integration/components/IntegrationPortalConfigurationWorkflowList';
import IntegrationPortalDialogContent from '@/pages/embedded/integration/components/IntegrationPortalDialogContent';
import * as React from 'react';

const IntegrationPortalConfiguration = () => {
    return (
        <LayoutContainer
            className="bg-muted"
...
export default IntegrationPortalConfiguration;
