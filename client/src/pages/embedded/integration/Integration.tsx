...
import {useCreateConnectionMutation} from '@/mutations/embedded/connections.mutations';
import {
    useDeleteWorkflowNodeParameterMutation,
    useUpdateWorkflowNodeParameterMutation,
} from '@/mutations/embedded/workflowNodeParameters.mutations';
import {useUpdateWorkflowMutation} from '@/mutations/embedded/workflows.mutations';
...
import {IntegrationWorkflowKeys, useGetIntegrationWorkflowQuery} from '@/queries/embedded/integrationWorkflows.queries';
