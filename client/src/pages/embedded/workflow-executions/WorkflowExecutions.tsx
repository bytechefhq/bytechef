...
export const WorkflowExecutions = () => {
    ...
    const handleEndDateChange = (date?: Date) => {
        search(filterStatus, filterIntegrationId, undefined, filterWorkflowId, filterStartDate, date, filterPageNumber);
    ...
    const handleStartDateChange = (date?: Date) => {
        search(filterStatus, filterIntegrationId, undefined, filterWorkflowId, date, filterEndDate, filterPageNumber);
