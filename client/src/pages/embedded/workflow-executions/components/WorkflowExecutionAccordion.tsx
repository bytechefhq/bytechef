...
import WorkflowExecutionTaskAccordionItem from '@/pages/embedded/workflow-executions/components/WorkflowExecutionTaskAccordionItem';
import WorkflowExecutionTriggerAccordionItem from '@/pages/embedded/workflow-executions/components/WorkflowExecutionTriggerAccordionItem';
import {CheckCircledIcon} from '@radix-ui/react-icons';
import {twMerge} from 'tailwind-merge';

const WorkflowExecutionAccordion = ({workflowExecution}: {workflowExecution: WorkflowExecutionModel}) => {
            ...
            <div className="overflow-y-auto">
                <Accordion collapsible defaultValue={workflowExecution.triggerExecution?.id || ''} type="single">
                    {workflowExecution.triggerExecution && (
                        <WorkflowExecutionTriggerAccordionItem
                            triggerExecution={workflowExecution.triggerExecution}
                            triggerExecutionCompleted={triggerExecutionCompleted}
                        />
                    )}

                    {workflowExecution.job?.taskExecutions && (
                        <WorkflowExecutionTaskAccordionItem
