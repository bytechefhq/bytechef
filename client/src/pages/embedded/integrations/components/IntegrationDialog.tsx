...
import {CategoryModel, IntegrationModel, TagModel} from '@/middleware/embedded/configuration';
import {ComponentDefinitionBasicModel} from '@/middleware/platform/configuration';
import {useCreateIntegrationMutation, useUpdateIntegrationMutation} from '@/mutations/embedded/integrations.mutations';
import {
    IntegrationCategoryKeys,
    useGetIntegrationCategoriesQuery,
} from '@/queries/embedded/integrationCategories.queries';
import {IntegrationTagKeys, useGetIntegrationTagsQuery} from '@/queries/embedded/integrationTags.quries';
import {IntegrationKeys, useGetIntegrationsQuery} from '@/queries/embedded/integrations.queries';
