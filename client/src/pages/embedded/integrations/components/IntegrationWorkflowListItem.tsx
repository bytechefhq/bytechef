    ...
    const updateWorkflowMutation = useUpdateWorkflowMutation({
        onSuccess: (workflow) => {
            queryClient.invalidateQueries({
                queryKey: WorkflowKeys.integrationWorkflows(integration.id!),
            });
    ...
    return (
        <>
            <Link
                ...
                to={`/embedded/integrations/${integration.id}/workflows/${workflow.id}`}
            >
                ...
                <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction
                            ...
                            onClick={() => {
                                if (integration?.id && selectedWorkflow?.id) {
