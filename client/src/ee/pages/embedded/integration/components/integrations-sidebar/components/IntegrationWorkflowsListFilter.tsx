...
interface IntegrationWorkflowsListFilterProps {
    searchValue: string;
...
const IntegrationWorkflowsListFilter = forwardRef<HTMLInputElement, IntegrationWorkflowsListFilterProps>(
...
IntegrationWorkflowsListFilter.displayName = 'IntegrationWorkflowsListFilter';

export default IntegrationWorkflowsListFilter;
