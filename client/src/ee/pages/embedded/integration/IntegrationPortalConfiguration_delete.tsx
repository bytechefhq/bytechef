...
import IntegrationPortalConfigurationOverviewForm from '@/ee/pages/embedded/integration/components/delete/IntegrationPortalConfigurationOverviewForm';
import IntegrationPortalConfigurationSettings from '@/ee/pages/embedded/integration/components/delete/IntegrationPortalConfigurationSettings';
import IntegrationPortalConfigurationWorkflowList from '@/ee/pages/embedded/integration/components/delete/IntegrationPortalConfigurationWorkflowList';
...
const IntegrationPortalConfiguration_delete = () => {
    return (
        <LayoutContainer
            className="bg-muted"
            header={<Header position="main" title="Integration Portal" />}
            ...
            rightSidebarHeader={<Header position="main" title="Custommize" />}
