import IntegrationSettingsConnectionForm from '@/ee/pages/embedded/integration/components/delete/IntegrationSettingsConnectionForm';
import IntegrationSettingsDeleteForm from '@/ee/pages/embedded/integration/components/delete/IntegrationSettingsDeleteForm';
