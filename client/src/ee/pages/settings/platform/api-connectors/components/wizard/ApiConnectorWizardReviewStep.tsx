...
const ApiConnectorWizardReviewStep = () => {
    const {baseUrl, endpoints, name, removeEndpoint, specification} = useApiConnectorWizardReviewStep();
    ...
    return (
        <div className="flex flex-col gap-4 pb-4">
            ...
            <div className="rounded-md border p-3">
                ...
                <p className="text-sm">
                    <span className="font-medium">Endpoints:</span> {endpoints.length}
                </p>
            </div>
