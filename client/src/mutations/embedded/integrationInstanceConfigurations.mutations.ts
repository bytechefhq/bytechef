import {
    CreateIntegrationInstanceConfigurationRequest,
...
interface CreateIntegrationInstanceMutationProps {
    onSuccess?: (
        ...
        variables: CreateIntegrationInstanceConfigurationRequest
    ) => void;
    onError?: (error: Error, variables: CreateIntegrationInstanceConfigurationRequest) => void;
}
...
export const useCreateIntegrationInstanceConfigurationMutation = (
    ...
    useMutation({
        mutationFn: ({integrationInstanceConfigurationModel}: CreateIntegrationInstanceConfigurationRequest) => {
