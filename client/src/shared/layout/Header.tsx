                ...
                <div className="flex flex-col">
                    ...
                    >
                        <div className="flex items-center gap-2">
                            {/* Renders nothing unless this page's LayoutContainer owns a sidebar — see
                                LeftSidebarToggle. Sidebar headers never carry it: the toggle belongs beside
                                the content, not inside the panel it hides. */}

                            {position === 'main' && <LeftSidebarToggle />}
