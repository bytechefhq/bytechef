...
describe('useHasWorkspaceScope', () => {
    beforeEach(() => {
        permissionStore.setState({workspaceScopeStates: {}, workspaceStates: {}});
    ...
    it('returns true when the user has the requested scope', () => {
        ...
        permissionStore.setState({
            workspaceScopeStates: {[WORKSPACE_ID]: {scopes: ['WORKFLOW_VIEW', 'WORKFLOW_EDIT'], status: 'loaded'}},
            workspaceStates: {},
        });
    ...
    it('returns false while permissions are loading even if scopes were previously cached', () => {
        ...
        setAccount(['ROLE_USER']);
        permissionStore.setState({
            workspaceScopeStates: {[WORKSPACE_ID]: {status: 'loading'}},
            workspaceStates: {},
        });
    ...
    it('returns false when permissions are in an error state', () => {
        setAccount(['ROLE_USER']);
        permissionStore.setState({
            workspaceScopeStates: {[WORKSPACE_ID]: {status: 'error'}},
            workspaceStates: {},
        });
