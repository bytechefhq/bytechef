...
export function WorkflowBasicToJSONTyped(value?: Omit<WorkflowBasic, 'createdBy'|'createdDate'|'id'|'label'|'lastModifiedBy'|'lastModifiedDate'|'projectWorkflowId'|'workflowUuid'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
