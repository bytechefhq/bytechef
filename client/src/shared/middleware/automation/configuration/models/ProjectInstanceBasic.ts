...
export function ProjectInstanceBasicToJSON(value?: Omit<ProjectInstanceBasic, 'createdBy'|'createdDate'|'id'|'lastExecutionDate'|'lastModifiedBy'|'lastModifiedDate'> | null): any {
    if (value == null) {
        return value;
    }
    return {
