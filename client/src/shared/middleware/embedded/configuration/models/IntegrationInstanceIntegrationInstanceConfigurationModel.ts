...
export function IntegrationInstanceIntegrationInstanceConfigurationModelToJSON(value?: Omit<IntegrationInstanceIntegrationInstanceConfigurationModel, 'createdBy'|'createdDate'|'id'|'lastExecutionDate'|'lastModifiedBy'|'lastModifiedDate'> | null): any {
    if (value == null) {
        return value;
    }
    return {
