...
export function WorkflowBasicToJSON(value?: Omit<WorkflowBasic, 'createdBy'|'createdDate'|'id'|'label'|'lastModifiedBy'|'lastModifiedDate'|'integrationWorkflowId'|'workflowReferenceCode'> | null): any {
    if (value == null) {
        return value;
    }
    return {
