...
export function WorkflowBasicModelToJSON(value?: Omit<WorkflowBasicModel, 'createdBy'|'createdDate'|'id'|'label'|'lastModifiedBy'|'lastModifiedDate'|'integrationWorkflowId'|'workflowReferenceCode'> | null): any {
    if (value == null) {
        return value;
    }
    return {
