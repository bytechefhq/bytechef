...
export function Workflow1ModelToJSON(value?: Omit<Workflow1Model, 'createdBy'|'createdDate'|'id'|'inputs'|'label'|'lastModifiedBy'|'lastModifiedDate'|'outputs'|'maxRetries'|'tasks'|'triggers'> | null): any {
    if (value == null) {
        return value;
    }
    return {
