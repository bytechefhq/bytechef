...
import {PageModelFromJSON, PageModelToJSON} from '../models';
...
export class ProjectExecutionsApi extends runtime.BaseAPI {
    ...
    async getProjectExecutionsRaw(
        ...
        if (requestParameters.jobStartTime !== undefined) {
            queryParameters['jobStartTime'] = (
                requestParameters.jobStartTime as any
            ).toISOString();
        }

        if (requestParameters.jobEndTime !== undefined) {
            queryParameters['jobEndTime'] = (
                requestParameters.jobEndTime as any
            ).toISOString();
        }
