...
export class WorkflowApi extends runtime.BaseAPI {
     ...
     * Get workflows for particular integration version.
     */
    async getIntegrationVersionWorkflowsRaw(requestParameters: GetIntegrationVersionWorkflowsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<WorkflowBasicModel>>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
        ...
        const response = await this.request({
            path: `/integrations/{id}/{integrationVersion}/workflows`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id']))).replace(`{${"integrationVersion"}}`, encodeURIComponent(String(requestParameters['integrationVersion']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Get workflows for particular integration version.
     */
    async getIntegrationVersionWorkflows(requestParameters: GetIntegrationVersionWorkflowsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<WorkflowBasicModel>> {
