...
export class IntegrationInstanceConfigurationApi extends runtime.BaseAPI {
    ...
    async createIntegrationInstanceConfigurationRaw(requestParameters: CreateIntegrationInstanceConfigurationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IntegrationInstanceConfigurationModel>> {
        if (requestParameters.integrationInstanceConfigurationModel === null || requestParameters.integrationInstanceConfigurationModel === undefined) {
            throw new runtime.RequiredError('integrationInstanceConfigurationModel','Required parameter requestParameters.integrationInstanceConfigurationModel was null or undefined when calling createIntegrationInstanceConfiguration.');
        }
    ...
    async createIntegrationInstanceConfigurationWorkflowJobRaw(requestParameters: CreateIntegrationInstanceConfigurationWorkflowJobRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateIntegrationInstanceConfigurationWorkflowJob200ResponseModel>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling createIntegrationInstanceConfigurationWorkflowJob.');
        }

        if (requestParameters.workflowId === null || requestParameters.workflowId === undefined) {
            throw new runtime.RequiredError('workflowId','Required parameter requestParameters.workflowId was null or undefined when calling createIntegrationInstanceConfigurationWorkflowJob.');
        }
    ...
    async deleteIntegrationInstanceConfigurationRaw(requestParameters: DeleteIntegrationInstanceConfigurationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling deleteIntegrationInstanceConfiguration.');
        }
    ...
    async enableIntegrationInstanceConfigurationRaw(requestParameters: EnableIntegrationInstanceConfigurationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling enableIntegrationInstanceConfiguration.');
        }

        if (requestParameters.enable === null || requestParameters.enable === undefined) {
            throw new runtime.RequiredError('enable','Required parameter requestParameters.enable was null or undefined when calling enableIntegrationInstanceConfiguration.');
        }
    ...
    async enableIntegrationInstanceConfigurationWorkflowRaw(requestParameters: EnableIntegrationInstanceConfigurationWorkflowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling enableIntegrationInstanceConfigurationWorkflow.');
        }

        if (requestParameters.workflowId === null || requestParameters.workflowId === undefined) {
            throw new runtime.RequiredError('workflowId','Required parameter requestParameters.workflowId was null or undefined when calling enableIntegrationInstanceConfigurationWorkflow.');
        }

        if (requestParameters.enable === null || requestParameters.enable === undefined) {
            throw new runtime.RequiredError('enable','Required parameter requestParameters.enable was null or undefined when calling enableIntegrationInstanceConfigurationWorkflow.');
        }
    ...
    async getIntegrationInstanceConfigurationRaw(requestParameters: GetIntegrationInstanceConfigurationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IntegrationInstanceConfigurationModel>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling getIntegrationInstanceConfiguration.');
        }
    ...
    async updateIntegrationInstanceConfigurationRaw(requestParameters: UpdateIntegrationInstanceConfigurationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IntegrationInstanceConfigurationModel>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling updateIntegrationInstanceConfiguration.');
        }

        if (requestParameters.integrationInstanceConfigurationModel === null || requestParameters.integrationInstanceConfigurationModel === undefined) {
            throw new runtime.RequiredError('integrationInstanceConfigurationModel','Required parameter requestParameters.integrationInstanceConfigurationModel was null or undefined when calling updateIntegrationInstanceConfiguration.');
        }
    ...
    async updateIntegrationInstanceConfigurationWorkflowRaw(requestParameters: UpdateIntegrationInstanceConfigurationWorkflowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IntegrationInstanceConfigurationWorkflowModel>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling updateIntegrationInstanceConfigurationWorkflow.');
        }

        if (requestParameters.integrationInstanceConfigurationWorkflowId === null || requestParameters.integrationInstanceConfigurationWorkflowId === undefined) {
            throw new runtime.RequiredError('integrationInstanceConfigurationWorkflowId','Required parameter requestParameters.integrationInstanceConfigurationWorkflowId was null or undefined when calling updateIntegrationInstanceConfigurationWorkflow.');
        }

        if (requestParameters.integrationInstanceConfigurationWorkflowModel === null || requestParameters.integrationInstanceConfigurationWorkflowModel === undefined) {
            throw new runtime.RequiredError('integrationInstanceConfigurationWorkflowModel','Required parameter requestParameters.integrationInstanceConfigurationWorkflowModel was null or undefined when calling updateIntegrationInstanceConfigurationWorkflow.');
        }
        ...
        const response = await this.request({
            path: `/integration-instance-configurations/{id}/project-instance-workflows/{integrationInstanceConfigurationWorkflowId}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))).replace(`{${"integrationInstanceConfigurationWorkflowId"}}`, encodeURIComponent(String(requestParameters.integrationInstanceConfigurationWorkflowId))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
