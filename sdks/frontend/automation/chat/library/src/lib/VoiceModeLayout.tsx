...
export function VoiceModeLayout({
    ...
    const [sessionSnapshot, setSessionSnapshot] = useState({isActive, sessionLimitSeconds});

    if (sessionSnapshot.isActive !== isActive || sessionSnapshot.sessionLimitSeconds !== sessionLimitSeconds) {
        setSessionSnapshot({isActive, sessionLimitSeconds});
