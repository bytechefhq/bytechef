...
public class ComponentDefinitionTest {
    ...
    public void testActionDefinition() throws JSONException, JsonProcessingException {
        ...
        jsonAssertEquals(
            """
                {"batch":null,"dynamicOutput":false,"deprecated":null,"description":"description","help":null,"metadata":null,"name":"name","outputResponse":null,"properties":null,"title":"title","workflowNodeDescription":null,"output":null,"perform":{},"processErrorResponse":null}
                """,
            action);
    }
    ...
    public void testStringProperty() throws JSONException, JsonProcessingException {
        ...
        jsonAssertEquals(
            """
                {"advancedOption":null,"description":"description","displayCondition":null,"expressionEnabled":null,"hidden":null,"label":"label","languageId":null,"metadata":{},"maxLength":null,"minLength":null,"placeholder":"placeholder","required":true,"name":"name","type":"STRING","defaultValue":"defaultValue","exampleValue":null,"controlType":"TEXT","options":null,"optionsDataSource":null}
                """,
            property);
    }
