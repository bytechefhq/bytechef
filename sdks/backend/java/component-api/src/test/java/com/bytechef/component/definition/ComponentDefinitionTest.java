...
public class ComponentDefinitionTest {
    ...
    public void testComponentDefinition() throws JSONException, JsonProcessingException {
        ...
        jsonAssertEquals(
            """
                {"categories":null,"customAction":null,"customActionHelp":null,"description":"description","icon":"icon","tags":null,"metadata":null,"name":"name","resources":null,"version":1,"title":"title","connection":null,"actions":null,"dataStream":null,"triggers":null}
                  """,
            componentDefinition);
    }
