...
public interface ExecutionContext extends Context {
    ...
    /**
     * Object representing a context for an {@link ItemStream}. It is a thin wrapper for a map that allows optionally
     * for type safety on reads. It also allows for dirty checking by setting a 'dirty' flag whenever any put is called.
     * <p>
    ...
    interface Data {
        ...
        /**
         * Indicates if context has been changed with a "put" operation since the dirty flag was last cleared. Note that
         * the last time the flag was cleared might correspond to creation of the context.
         *
