...
include("server:libs:modules:components:llm:minimax")
include("server:libs:modules:components:llm:mistral")
include("server:libs:modules:components:llm:moonshot")
