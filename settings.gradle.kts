...
include("server:libs:hermes:hermes-configuration:hermes-configuration-rest:hermes-configuration-rest-api")
include("server:libs:hermes:hermes-configuration:hermes-configuration-rest:hermes-configuration-rest-impl")
...
include("server:libs:hermes:hermes-execution:hermes-execution-rest:hermes-execution-rest-api")
include("server:libs:hermes:hermes-execution:hermes-execution-rest:hermes-execution-rest-impl")
...
include("server:libs:hermes:hermes-test:hermes-test-api")
include("server:libs:hermes:hermes-test:hermes-test-impl")
include("server:libs:hermes:hermes-test:hermes-test-rest")
