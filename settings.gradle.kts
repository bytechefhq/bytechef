...
include("server:libs:modules:components:ai:llm:openai")
include("server:libs:modules:components:ai:llm:stability")
include("server:libs:modules:components:ai:llm:vertex:gemini")
include("server:libs:modules:components:ai:llm:watsonx")
include("server:libs:modules:components:ai:vector-store:pinecone")
include("server:libs:modules:components:ai:vector-store:weaviate")
