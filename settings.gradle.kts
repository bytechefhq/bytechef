...
include("server:libs:atlas:atlas-execution:atlas-execution-converter")
...
include("server:libs:hermes:hermes-configuration:hermes-configuration-converter")
...
include("server:libs:hermes:hermes-data-storage:hermes-data-storage-converter")
...
include("server:libs:hermes:hermes-execution:hermes-execution-converter")
