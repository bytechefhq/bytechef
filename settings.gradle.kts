...
include("server:ee:apps:services:connection-app")
include("server:ee:apps:services:coordinator-app")
include("server:ee:apps:services:execution-app")
include("server:ee:apps:services:scheduler-app")
include("server:ee:apps:services:webhook-app")
include("server:ee:apps:services:worker-app")

include("server:ee:libs:athena:athena-configuration:athena-configuration-api")
include("server:ee:libs:athena:athena-configuration:athena-configuration-rest")
include("server:ee:libs:athena:athena-configuration:athena-configuration-service")
include("server:ee:libs:athena:athena-swagger")
