...
import com.bytechef.component.http.client.auth.resolver.AuthResolver;
import com.bytechef.component.http.client.auth.resolver.AuthResolverRegistry;
...
public class HttpClientHelper {
    ...
    public Object send(ExecutionParameters executionParameters, HttpClientConstants.RequestMethod requestMethod)
            throws Exception {
        ...
        HttpClient httpClient = createHTTPClient(executionParameters, headers, queryParams);

        HttpRequest httpRequest = createHTTPRequest(executionParameters, requestMethod, headers, queryParams);

        HttpResponse<?> httpResponse = httpClient.send(httpRequest, createBodyHandler(executionParameters));

        return handleResponse(executionParameters, httpResponse);
    }
    ...
    protected HttpRequest.BodyPublisher createBodyPublisher(ExecutionParameters executionParameters) {
    ...
    protected HttpRequest createHTTPRequest(
        ...
        HttpRequest.Builder httpRequestBuilder =
                HttpRequest.newBuilder().method(requestMethod.name(), createBodyPublisher(executionParameters));
    ...
    protected Object handleResponse(ExecutionParameters executionParameters, HttpResponse<?> httpResponse)
            throws Exception {
        Object body = null;
