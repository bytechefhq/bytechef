...
public class NumberPropertyModel implements ComponentActionInputsInnerModel, ConnectionDefinitionPropertiesInnerModel {
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(maxValue, minValue, numberPrecision, description, displayOption, label, name, placeholder, type);
  }
