...
public class QueryJdbcActionIntTest {
    ...
    public void testQuery() {
        ...
        List<Map<String, ?>> result = queryJdbcOperation.execute(new MockContext(), parameters);
    ...
    public static class InsertJdbcTaskHandlerIntTestConfiguration {
        ...
        @Bean
        QueryJdbcOperation queryJdbcOperation(PlatformTransactionManager transactionManager) {
