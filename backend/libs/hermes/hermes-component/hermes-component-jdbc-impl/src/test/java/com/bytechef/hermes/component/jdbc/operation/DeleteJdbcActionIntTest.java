...
public class DeleteJdbcActionIntTest {
    ...
    public void testDelete() {
        ...
        Map<String, Integer> result = deleteJdbcOperation.execute(new MockContext(), parameters);
    ...
    public static class DeleteJdbcTaskHandlerIntTestConfiguration {
        ...
        @Bean
        DeleteJdbcOperation deleteJdbcOperation(PlatformTransactionManager transactionManager) {
