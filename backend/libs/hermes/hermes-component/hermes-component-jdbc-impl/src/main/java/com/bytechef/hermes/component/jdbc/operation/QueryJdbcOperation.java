 ...
 * @author Ivica Cardic
 */
public class QueryJdbcOperation implements JdbcOperation<List<Map<String, ?>>> {
    ...
    @Override
    public List<Map<String, ?>> execute(Context context, ExecutionParameters executionParameters) {
