 ...
 */
function distributeBranches(tasks: WorkflowTaskType[]): {
    leftBranches: WorkflowTaskType[];
    middleBranch: WorkflowTaskType | null;
    rightBranches: WorkflowTaskType[];
} {
...
export default function createParallelEdges(parallelNode: Node): Edge[] {
    ...
    if (!hasSubtasks) {
        ...
        const parallelTasks: WorkflowTaskType[] = nodeData.parameters?.tasks;
