// Ported verbatim from client/src/pages/platform/workflow-editor/utils/postDagreConstraints.ts.
// Only the import header is adapted: constants come from ./constants and NodeDataType from ../types.
// All exported layout-constraint functions are preserved (getLayoutElements consumes ~20 of them).
