...
import {BranchCaseType, NodeDataType, WorkflowTaskType} from '../types';
 ...
 */
function distributeCases(allCases: Array<{key: string; tasks: WorkflowTaskType[]}>): {
