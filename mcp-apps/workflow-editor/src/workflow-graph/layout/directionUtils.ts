// Ported from client/src/pages/platform/workflow-editor/utils/directionUtils.ts.
// Trimmed to be self-contained (local LayoutDirectionType / NODE_WIDTH instead of @/shared/constants).

import {Position} from '@xyflow/react';

import {LayoutDirectionType, NODE_WIDTH} from './constants';
