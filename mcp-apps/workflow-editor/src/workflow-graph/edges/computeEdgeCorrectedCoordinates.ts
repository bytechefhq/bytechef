// Ported from client/src/pages/platform/workflow-editor/edges/computeEdgeCorrectedCoordinates.ts.
// Adaptation: ALIGNED_SIDE_CASE_THRESHOLD imported from local layout constants.

import {Position} from '@xyflow/react';

import {ALIGNED_SIDE_CASE_THRESHOLD} from '../layout/constants';
