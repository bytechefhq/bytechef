...
dependencies {
    ...
    implementation(project(":ee:server:libs:automation:automation-configuration:automation-configuration-remote-rest"))
    implementation(project(":ee:server:libs:core:discovery:discovery-redis"))
    implementation(project(":ee:server:libs:embedded:embedded-configuration:embedded-configuration-remote-rest"))
    ...
    implementation(project(":ee:server:libs:platform:platform-configuration:platform-configuration-remote-rest"))
    implementation(project(":ee:server:libs:platform:platform-connection:platform-connection-remote-client"))
    implementation(project(":ee:server:libs:platform:platform-workflow:platform-workflow-task-dispatcher:platform-workflow-task-dispatcher-registry:platform-workflow-task-dispatcher-registry-remote-client"))
