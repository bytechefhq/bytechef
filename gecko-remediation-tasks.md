...
- [ ] **T17. Build a central resource-authorization layer** _(enabler for T18–T25)_
...
- [ ] **T18. Connections & credentials** _(~20 findings)_ — enforce workspace/owner scope on get/update/delete/tag and connected-user connection endpoints; stop returning credentials cross-workspace.
...
- [ ] **T19. API keys & signing keys** _(~14 findings)_ — verify ownership/workspace on delete/update/get/rename across REST + GraphQL; gate `adminApiKeys`.
