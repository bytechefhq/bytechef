...
val generateClient by tasks.registering(org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    ...
    library.set("native")
    inputSpec.set("${rootDir}/server/ee/libs/embedded/embedded-configuration/embedded-configuration-admin-rest/openapi.yaml")
    outputDir.set("$projectDir/generated")
    apiPackage.set("com.bytechef.cli.client.embeddedconfigurationadmin.api")
    modelPackage.set("com.bytechef.cli.client.embeddedconfigurationadmin.model")
    invokerPackage.set("com.bytechef.cli.client.embeddedconfigurationadmin")
...
dependencies {
    ...
    // project-file upload (deployAutomationProjectCodeWorkflow); it is not otherwise on the classpath.
