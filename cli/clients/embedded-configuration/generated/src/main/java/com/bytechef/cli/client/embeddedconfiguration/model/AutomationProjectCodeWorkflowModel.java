 ...
 */
@JsonPropertyOrder({
  AutomationProjectCodeWorkflowModel.JSON_PROPERTY_NAME,
  AutomationProjectCodeWorkflowModel.JSON_PROPERTY_KIND,
  AutomationProjectCodeWorkflowModel.JSON_PROPERTY_WORKFLOW_TEMPLATES
})
...
public class AutomationProjectCodeWorkflowModel {
  ...
  @jakarta.annotation.Nullable
  private List<AutomationProjectCodeWorkflowTemplateModel> workflowTemplates = new ArrayList<>();

  public AutomationProjectCodeWorkflowModel() { 
  }

  public AutomationProjectCodeWorkflowModel name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AutomationProjectCodeWorkflowModel kind(@jakarta.annotation.Nullable KindEnum kind) {
    this.kind = kind;
    return this;
  }
  ...
  public AutomationProjectCodeWorkflowModel workflowTemplates(@jakarta.annotation.Nullable List<AutomationProjectCodeWorkflowTemplateModel> workflowTemplates) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<AutomationProjectCodeWorkflowTemplateModel> getWorkflowTemplates() {
    return workflowTemplates;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_WORKFLOW_TEMPLATES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setWorkflowTemplates(@jakarta.annotation.Nullable List<AutomationProjectCodeWorkflowTemplateModel> workflowTemplates) {
    this.workflowTemplates = workflowTemplates;
  }


  /**
   * Return true if this AutomationProjectCodeWorkflow object is equal to o.
   */
  @Override
