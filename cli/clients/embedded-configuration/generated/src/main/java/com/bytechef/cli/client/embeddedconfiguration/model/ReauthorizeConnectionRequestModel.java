 ...
 */
@JsonPropertyOrder({
  ReauthorizeConnectionRequestModel.JSON_PROPERTY_PARAMETERS
})
...
public class ReauthorizeConnectionRequestModel {
  ...
  public ReauthorizeConnectionRequestModel parameters(@jakarta.annotation.Nonnull Map<String, Object> parameters) {
  ...
  /**
   * Return true if this ReauthorizeConnectionRequest object is equal to o.
   */
  @Override
