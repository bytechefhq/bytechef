 ...
 */
@JsonPropertyOrder({
  WorkflowReferenceModel.JSON_PROPERTY_ID,
  WorkflowReferenceModel.JSON_PROPERTY_LABEL
})
...
public class WorkflowReferenceModel {
  ...
  public WorkflowReferenceModel id(@jakarta.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public WorkflowReferenceModel label(@jakarta.annotation.Nullable String label) {
    this.label = label;
    return this;
  }
  ...
  /**
   * Return true if this WorkflowReference object is equal to o.
   */
  @Override
