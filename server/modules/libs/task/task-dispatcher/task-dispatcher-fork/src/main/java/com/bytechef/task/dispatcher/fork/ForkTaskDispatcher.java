 ...
 *
 * <p>Fork/Join tasks are expected to have a "branches" property which contains a list of task list.
 *
 * <p>Each branch executes in isolation, in parallel to the other branches in the fork and has its
