...
public class XMLHelperTest {
    ...
    public void testReadList() {
        Assertions.assertThat(xmlHelper.read(
                        """
                    <Flowers>
                        <Flower id="45">
                            <name>Poppy</name>
    ...
    public void testWrite() {
        Assertions.assertThat(xmlHelper.read(xmlHelper.write(
                        Map.of(
                                "name",
                                "Poppy",
                                "color",
                        ...
                        xmlHelper.write(
                                List.of(
                                        Map.of(
                                                ...
                                                Map.of(
                                                        "Florist",
                                                        List.of(Map.of("name", "Joe"), Map.of("name", "Mark")))),
                                        Map.of("name", "Rose", "color", "YELLOW", "petals", "5", "id", "46")),
                                "Flowers"),
                        List.class))
                .isEqualTo(xmlHelper.read(
