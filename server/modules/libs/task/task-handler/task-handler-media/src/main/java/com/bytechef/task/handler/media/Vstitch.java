...
/**
 * a {@link TaskHandler} implementation which "stitches" together a collection of <code>chunks
 * </code> into a single file specified by the <code>output</code> property.
 *
 * @author Arik Cohen
 * @since Jun 4, 2017
 */
