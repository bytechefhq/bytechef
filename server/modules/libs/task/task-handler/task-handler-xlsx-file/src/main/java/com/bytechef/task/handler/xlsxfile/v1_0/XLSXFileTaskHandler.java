...
public class XLSXFileTaskHandler {
    ...
    @Component(XLSXFileTaskConstants.XLSX_FILE + "/" + XLSXFileTaskConstants.VERSION_1_0 + "/"
            + XLSXFileTaskConstants.READ)
    public static class XLSXFileReadTaskHandler implements TaskHandler<List<Map<String, ?>>> {
        ...
        private List<Map<String, ?>> read(
                FileFormat fileFormat, InputStream inputStream, ReadConfiguration configuration) throws IOException {
