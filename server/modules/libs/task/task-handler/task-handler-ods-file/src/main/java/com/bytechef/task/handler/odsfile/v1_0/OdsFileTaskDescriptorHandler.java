...
public class OdsFileTaskDescriptorHandler implements TaskDescriptorHandler {
    ...
    private static final TaskDescriptor TASK_DESCRIPTOR = DSL.createTaskDescriptor(ODS_FILE)
                                    ...
                                    OPTIONS()
                                            ...
                                            .options(
                                                    STRING_PROPERTY(FILE_NAME)
                                                            ...
                                                            .description(
                                                                    "File name to set for binary data. By default, \"file.ods\" will be used.")
                                                            .defaultValue(""),
                                                    STRING_PROPERTY(SHEET_NAME)
                                                            .displayName("Sheet Name")
                                                            .description(
