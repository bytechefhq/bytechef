...
import com.bytechef.task.handler.postgresql.PostgreSQLTaskConstants;
...
public class PostgreSQLTaskDescriptorHandler implements TaskDescriptorHandler {
    ...
    private static final TaskDescriptor TASK_DESCRIPTOR = DSL.createTaskDescriptor(PostgreSQLTaskConstants.POSTGRESQL)
            .displayName("PostgreSQL")
            .description("Query, insert nd update data from PostgreSQL.")
            .version(PostgreSQLTaskConstants.VERSION_1_0)
            .auth(option(PostgreSQLTaskConstants.POSTGRESQL))
