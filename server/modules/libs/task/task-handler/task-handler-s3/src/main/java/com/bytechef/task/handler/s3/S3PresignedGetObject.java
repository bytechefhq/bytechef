...
/**
 * Presign a GetObjectRequest so that it can be executed at a later time without requiring
...
class S3PresignedGetObject implements TaskHandler<Object> {
    ...
    public Object handle(TaskExecution aTask) throws Exception {
        ...
        PresignedGetObjectRequest presignedRequest = presigner.presignGetObject(
                z -> z.signatureDuration(Duration.parse("PT" + aTask.getRequiredString("signatureDuration")))
