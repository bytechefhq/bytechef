...
import static com.integri.atlas.task.handler.commons.jdbc.JdbcTaskConstants.PROPERTY_EXECUTE;
import static com.integri.atlas.task.handler.commons.jdbc.JdbcTaskConstants.PROPERTY_PARAMETERS;
...
public class ExecuteJdbcTaskHandler extends AbstractJdbcTaskHandler implements TaskHandler<Map<String, Integer>> {
    ...
    public Map<String, Integer> handle(TaskExecution taskExecution) throws Exception {
        String executeStatement = taskExecution.getRequiredString(PROPERTY_EXECUTE);
