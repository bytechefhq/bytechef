...
package com.integri.atlas.engine.task.execution.evaluator.spel;
...
/**
 * a {@link TaskEvaluator} implementation which is based on Spring Expression Language for resolving expressions.
 *
 * @author Arik Cohen
 * @since Mar 31, 2017
 */
