...
package com.integri.atlas.engine.counter.service;
...
public class CounterService {
    ...
    public void set(String counterName, long value) {
        counterRepository.set(counterName, value);
    }

    public long decrement(String counterName) {
        return counterRepository.decrement(counterName);
    }

    public void delete(String counterName) {
        counterRepository.delete(counterName);
    }
}
