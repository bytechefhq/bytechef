...
public class WorkflowController {
    ...
    public ResponseEntity<Workflow> create(
            @RequestBody String content, @RequestHeader("Content-Type") String contentType) {
    ...
    public ResponseEntity<Workflow> update(
            @PathVariable String id, @RequestBody String content, @RequestHeader("Content-Type") String contentType) {
        Workflow workflow =
                workflowService.update(id, content, contentType.substring(contentType.lastIndexOf('/') + 1));
