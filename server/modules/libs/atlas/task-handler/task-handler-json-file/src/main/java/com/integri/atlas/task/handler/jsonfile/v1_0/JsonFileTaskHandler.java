...
import static com.integri.atlas.task.handler.jsonfile.JsonFileTaskConstants.READ;
...
import static com.integri.atlas.task.handler.jsonfile.JsonFileTaskConstants.WRITE;
...
public class JsonFileTaskHandler {
    ...
    public static class JsonFileReadTaskHandler implements TaskHandler<Object> {
        ...
        public Object handle(TaskExecution taskExecution) throws Exception {
            ...
            JsonFileTaskConstants.FileType fileType = JsonFileTaskConstants.FileType.valueOf(
                StringUtils.upperCase(
                    taskExecution.get(FILE_TYPE, String.class, JsonFileTaskConstants.FileType.JSON.name())
                )
            );
    ...
    public static class JsonFileWriteTaskHandler implements TaskHandler<FileEntry> {
        ...
        public FileEntry handle(TaskExecution taskExecution) throws Exception {
            ...
            String fileName = taskExecution.get(FILE_NAME, String.class, getDefaultFileName(fileType));
