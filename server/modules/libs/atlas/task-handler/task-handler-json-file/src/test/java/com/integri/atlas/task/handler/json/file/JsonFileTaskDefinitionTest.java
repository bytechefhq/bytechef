...
public class JsonFileTaskDefinitionTest {
    ...
    @Test
    public void testJSONFileTaskDefinition() throws JsonProcessingException {
        JSONAssert.assertEquals(
            ...
            (JSONObject) JSONParser.parseJSON(
                objectMapper.writeValueAsString(new JsonFileTaskDefinitionHandler().getTaskDefinition())
            ),
            true
        );
    }
