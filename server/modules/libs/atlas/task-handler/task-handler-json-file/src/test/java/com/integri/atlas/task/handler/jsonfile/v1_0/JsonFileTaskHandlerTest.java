...
public class JsonFileTaskHandlerTest {
    ...
    private static final JsonFileTaskHandler.JsonFileReadTaskHandler jsonFileReadTaskHandler = new JsonFileTaskHandler.JsonFileReadTaskHandler(
        fileStorageService,
        jsonHelper
    );
    private static final JsonFileTaskHandler.JsonFileWriteTaskHandler jsonFileWriteTaskHandler = new JsonFileTaskHandler.JsonFileWriteTaskHandler(
        fileStorageService,
        jsonHelper
    );
