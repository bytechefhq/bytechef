...
import static com.integri.atlas.task.handler.objecthelpers.ObjectHelpersTaskConstants.OBJECT_HELPERS;
import static com.integri.atlas.task.handler.objecthelpers.ObjectHelpersTaskConstants.PARSE;
import static com.integri.atlas.task.handler.objecthelpers.ObjectHelpersTaskConstants.STRINGIFY;
import static com.integri.atlas.task.handler.objecthelpers.ObjectHelpersTaskConstants.VERSION_1_0;
...
public class ObjectHelpersTaskHandler {
    ...
    @Component(OBJECT_HELPERS + "/" + VERSION_1_0 + "/" + PARSE)
    ...
    @Component(OBJECT_HELPERS + "/" + VERSION_1_0 + "/" + STRINGIFY)
