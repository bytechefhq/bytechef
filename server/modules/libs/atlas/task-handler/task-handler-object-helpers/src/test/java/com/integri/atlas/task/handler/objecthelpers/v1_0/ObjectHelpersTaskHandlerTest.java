...
public class ObjectHelpersTaskHandlerTest {
    ...
    private static final ObjectHelpersTaskHandler.ObjectHelpersParseTaskHandler objectHelpersParseTaskHandler = new ObjectHelpersTaskHandler.ObjectHelpersParseTaskHandler(
        jsonHelper
    );
    private static final ObjectHelpersTaskHandler.ObjectHelpersStringifyTaskHandler ObjectHelpersStringifyTaskHandler = new ObjectHelpersTaskHandler.ObjectHelpersStringifyTaskHandler(
        jsonHelper
    );
