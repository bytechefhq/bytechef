 ...
 */
@Component
public class MySQLTaskAuthDescriptorHandler implements TaskAuthDescriptorHandler {

    private static final List<TaskAuthDescriptor> TASK_AUTH_DESCRIPTORS = List.of(
        DSL
            .createTaskAuthDescriptor(MYSQL)
            .displayName("MySQL")
            .properties(
    ...
    public TaskAuthDescriptors getTaskAuthDescriptors() {
        return DSL.createTaskAuthDescriptors(MYSQL, TASK_AUTH_DESCRIPTORS);
    }
}
