...
public class LocalFileTaskHandlerTest {
    ...
    private static final LocalFileTaskHandler.LocalFileReadTaskHandler localFileReadTaskHandler = new LocalFileTaskHandler.LocalFileReadTaskHandler(
        fileStorageService
    );
    private static final LocalFileTaskHandler.LocalFileWriteTaskHandler localFileWriteTaskHandler = new LocalFileTaskHandler.LocalFileWriteTaskHandler(
        fileStorageService
    );
