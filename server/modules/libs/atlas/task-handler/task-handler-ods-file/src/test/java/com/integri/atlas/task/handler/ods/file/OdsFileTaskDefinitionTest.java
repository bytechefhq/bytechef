 ...
 * @author Ivica Cardic
 */
public class OdsFileTaskDefinitionTest {
    ...
    @Test
    public void testOdsFileTaskDefinition() throws JsonProcessingException {
        JSONAssert.assertEquals(
            ...
            (JSONObject) JSONParser.parseJSON(
                objectMapper.writeValueAsString(new OdsFileTaskDefinitionHandler().getTaskDefinition())
            ),
            true
        );
    }
