 ...
 */
@Component
public class CsvFileTaskDefinition implements TaskDefinition {
    ...
    public static final TaskSpecification TASK_SPECIFICATION = TaskSpecification
        ...
        .properties(
            SELECT_PROPERTY(PROPERTY_OPERATION)
                ...
                .options(
                    option("Read from file", Operation.READ.name(), "Reads data from a csv file."),
                    option("Write to file", Operation.WRITE.name(), "Writes the data to a csv file.")
                )
