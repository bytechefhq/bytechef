...
import static com.integri.atlas.task.handler.xlsxfile.XlsxFileTaskConstants.FILE_ENTRY;
import static com.integri.atlas.task.handler.xlsxfile.XlsxFileTaskConstants.FILE_NAME;
import static com.integri.atlas.task.handler.xlsxfile.XlsxFileTaskConstants.INCLUDE_EMPTY_CELLS;
import static com.integri.atlas.task.handler.xlsxfile.XlsxFileTaskConstants.PAGE_NUMBER;
import static com.integri.atlas.task.handler.xlsxfile.XlsxFileTaskConstants.PAGE_SIZE;
import static com.integri.atlas.task.handler.xlsxfile.XlsxFileTaskConstants.PROPERTY_HEADER_ROW;
import static com.integri.atlas.task.handler.xlsxfile.XlsxFileTaskConstants.READ;
import static com.integri.atlas.task.handler.xlsxfile.XlsxFileTaskConstants.READ_AS_STRING;
import static com.integri.atlas.task.handler.xlsxfile.XlsxFileTaskConstants.ROWS;
import static com.integri.atlas.task.handler.xlsxfile.XlsxFileTaskConstants.SHEET_NAME;
import static com.integri.atlas.task.handler.xlsxfile.XlsxFileTaskConstants.VERSION_1_0;
import static com.integri.atlas.task.handler.xlsxfile.XlsxFileTaskConstants.WRITE;
import static com.integri.atlas.task.handler.xlsxfile.XlsxFileTaskConstants.XLSX_FILE;
 ...
 * @author Ivica Cardic
 */
public class XlsxFileTaskHandler {

    @Component(XLSX_FILE + "/" + VERSION_1_0 + "/" + READ)
    public static class XlsxFileReadTaskHandler implements TaskHandler<List<Map<String, ?>>> {
    ...
    @Component(XLSX_FILE + "/" + VERSION_1_0 + "/" + WRITE)
    public static class XlsxFileWriteTaskHandler implements TaskHandler<FileEntry> {
        ...
        public FileEntry handle(TaskExecution taskExecution) throws Exception {
            String fileName = taskExecution.get(FILE_NAME, String.class, getaDefaultFileName());
