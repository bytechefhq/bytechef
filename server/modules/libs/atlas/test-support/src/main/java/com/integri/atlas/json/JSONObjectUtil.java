...
public class JSONObjectUtil {
    ...
    public static <V> JSONObject of(
        ...
        return new JSONObject().put(k1, v1).put(k2, v2).put(k3, v3).put(k4, v4).put(k5, v5).put(k6, v6);
    }
    ...
    public static <V> JSONObject of(
        ...
        return new JSONObject().put(k1, v1).put(k2, v2).put(k3, v3).put(k4, v4).put(k5, v5).put(k6, v6).put(k7, v7);
    }
