...
public class IfTaskDefinitionTest {
    ...
    @Test
    public void testIfTaskDefinition() throws JsonProcessingException, JSONException {
  ...
  "version": 1
            ...
            (JSONObject) JSONParser.parseJSON(
                objectMapper.writeValueAsString(new IfTaskDefinitionHandler().getTaskDefinition())
            ),
            true
        );
    }
