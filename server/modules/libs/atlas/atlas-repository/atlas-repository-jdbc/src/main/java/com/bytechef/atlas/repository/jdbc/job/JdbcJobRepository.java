...
package com.bytechef.atlas.repository.jdbc.job;

import com.bytechef.atlas.Constants;
import com.bytechef.atlas.data.Page;
import com.bytechef.atlas.data.ResultPage;
...
public class JdbcJobRepository implements JobRepository {
    ...
    public Job findById(String aId) {
        List<Job> query = jdbcTemplate.query(
                "select * from job where id = :id", Collections.singletonMap("id", aId), this::jobRowMapper);
