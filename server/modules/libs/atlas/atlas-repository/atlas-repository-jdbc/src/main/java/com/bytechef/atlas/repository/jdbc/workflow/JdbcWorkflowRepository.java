...
package com.bytechef.atlas.repository.jdbc.workflow;
...
public class JdbcWorkflowRepository implements WorkflowRepository {
    ...
    public Workflow create(String content, String format) {
        ...
        jdbcTemplate.update(
                "insert into workflow (id, content, format) values (:id, :content, :format)", sqlParameterSource);
    ...
    public Workflow update(String id, String content, String format) {
        ...
        jdbcTemplate.update(
                "update workflow set content = :content, format = :format where id = :id", sqlParameterSource);
