...
import com.integri.atlas.workflow.core.ResultPage;
...
public class JdbcJobRepository implements JobRepository {
  ...
  public Page<JobSummary> getPage(int aPageNumber) {
    ...
    List<JobSummary> items = jdbc.query(String.format("select * from job order by create_time desc limit %s offset %s",limit,offset),this::jobSummaryRowMappper);
