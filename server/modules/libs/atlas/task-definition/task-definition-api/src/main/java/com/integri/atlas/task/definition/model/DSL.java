...
public class DSL {
    ...
    public static TaskAuthDefinition createTaskAuthDefinition(String name) {
        return new TaskAuthDefinition(name);
    }

    public static TaskDefinition createTaskDefinition(String name) {
