...
package com.bytechef.atlas.task.execution.domain;
...
public class SimpleTaskExecution extends SimpleWorkflowTask implements TaskExecution {
    ...
    public int getPriority() {
        return getInteger(Constants.PRIORITY, DEFAULT_PRIORITY);
    }
    ...
    /**
     * Creates a mutation {@link SimpleTaskExecution} instance which is a copy of a {@link
     * TaskExecution}.
     *
    ...
    /**
     * Creates a {@link SimpleTaskExecution} instance for the given Key-Value pair.
     *
     * @return The new {@link SimpleTaskExecution}.
     */
    ...
    /**
     * Creates a {@link SimpleTaskExecution} instance for the given Key-Value map.
     *
     * @return The new {@link SimpleTaskExecution}.
     */
