...
/**
 * Extends the {@link WorkflowTask} interface to add execution semantics to the task.
 *
 * <p>{@link TaskExecution} instances capture the life cycle of a single execution of a task. By
 * single execution is meant that the task goes through the following states:
 *
 * <ol>
