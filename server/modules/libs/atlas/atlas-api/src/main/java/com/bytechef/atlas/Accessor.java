...
public interface Accessor {
     ...
     * @return The value or <code>null</code> if no value is associated with the given key.
     */
    <T> T get(Object aKey);
     ...
     *
     * @param aKey The key associated with the desired value.
     * @param aReturnType The type to return the value as -- converting as neccessary.
     * @return The value associated with the given key.
     */
     ...
     * @param aKey The key associated with the desired value.
     * @param aReturnType The type to return the value as -- converting as neccessary.
     * @param aDefaultValue The value to return if a value was not found for the given key or if the
     *     value is null.
     ...
     *
     * @param aKey The key associated with the desired value.
     * @param aElementType The type of the list elements.
     ...
     * @param aKey The key associated with the desired value.
     * @param aElementType The type of the list elements.
     * @param aDefaultValue The list value to return none was not found for the given key or if the
     *     value is null.
     * @return The list of items
     */
