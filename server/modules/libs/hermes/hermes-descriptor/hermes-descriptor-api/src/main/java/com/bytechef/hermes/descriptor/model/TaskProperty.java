...
@JsonSubTypes({
    @JsonSubTypes.Type(value = TaskProperty.AnyTaskProperty.class, name = "ANY"),
    @JsonSubTypes.Type(value = TaskProperty.ArrayTaskProperty.class, name = "ARRAY"),
    @JsonSubTypes.Type(value = TaskProperty.BooleanTaskProperty.class, name = "BOOLEAN"),
    @JsonSubTypes.Type(value = TaskProperty.DateTimeTaskProperty.class, name = "DATE_TIME"),
    @JsonSubTypes.Type(value = TaskProperty.IntegerTaskProperty.class, name = "INTEGER"),
    @JsonSubTypes.Type(value = TaskProperty.NullTaskProperty.class, name = "NULL"),
    @JsonSubTypes.Type(value = TaskProperty.NumberTaskProperty.class, name = "NUMBER"),
    @JsonSubTypes.Type(value = TaskProperty.ObjectTaskProperty.class, name = "OBJECT"),
    @JsonSubTypes.Type(value = TaskProperty.OptionTaskProperty.class, name = "OPTION"),
    @JsonSubTypes.Type(value = TaskProperty.StringTaskProperty.class, name = "STRING"),
})
