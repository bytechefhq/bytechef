...
package com.bytechef.hermes.descriptor.repository;
 ...
 * @author Ivica Cardic
 */
public interface ExtAuthenticationDescriptorHandlerRepository {
    ...
    String findTypeByTaskName(String taskName);
}
