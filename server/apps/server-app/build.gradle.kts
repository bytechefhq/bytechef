...
dependencies {
    ...
    implementation(project(":server:libs:automation:automation-configuration:automation-configuration-code-workflow:automation-configuration-code-workflow-public-rest"))
