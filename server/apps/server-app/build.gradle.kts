...
dependencies {
    ...
    implementation(project(":server:libs:ai:ai-agent:ai-agent-eval:ai-agent-eval-file-storage:ai-agent-eval-file-storage-impl"))
    implementation(project(":server:libs:ai:ai-agent:ai-agent-eval:ai-agent-eval-graphql"))
    implementation(project(":server:libs:ai:ai-agent:ai-agent-eval:ai-agent-eval-service"))
    implementation(project(":server:libs:ai:ai-agent:ai-agent-skill:ai-agent-skill-file-storage:ai-agent-skill-file-storage-impl"))
    implementation(project(":server:libs:ai:ai-agent:ai-agent-skill:ai-agent-skill-graphql"))
    implementation(project(":server:libs:ai:ai-agent:ai-agent-skill:ai-agent-skill-rest"))
    implementation(project(":server:libs:ai:ai-agent:ai-agent-skill:ai-agent-skill-service"))
    ...
    implementation(project(":server:libs:automation:automation-workspace-file:automation-workspace-file-graphql"))
    implementation(project(":server:libs:automation:automation-workspace-file:automation-workspace-file-rest"))
