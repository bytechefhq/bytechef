...
dependencies {
    ...
    implementation("org.springframework.ai:spring-ai-starter-mcp-server-webmvc:${rootProject.libs.versions.spring.ai.get()}")
    ...
    implementation("org.springframework.ai:spring-ai-starter-model-anthropic:${rootProject.libs.versions.spring.ai.get()}")
    implementation("org.springframework.ai:spring-ai-starter-model-mistral-ai:${rootProject.libs.versions.spring.ai.get()}")
    implementation("org.springframework.ai:spring-ai-starter-model-ollama:${rootProject.libs.versions.spring.ai.get()}")
    implementation("org.springframework.ai:spring-ai-starter-model-openai:${rootProject.libs.versions.spring.ai.get()}")
    implementation("org.springframework.ai:spring-ai-starter-vector-store-pinecone:${rootProject.libs.versions.spring.ai.get()}")
    implementation("org.springframework.ai:spring-ai-starter-vector-store-pgvector:${rootProject.libs.versions.spring.ai.get()}")
    implementation("org.springframework.ai:spring-ai-starter-vector-store-qdrant:${rootProject.libs.versions.spring.ai.get()}")
...
implementation(project(":server:libs:modules:components:bolna"))
    ...
    implementation(project(":server:libs:modules:components:encryption-helper"))
