...
dependencies {
    ...
    implementation("org.springframework.ai:spring-ai-anthropic-spring-boot-starter:${rootProject.libs.versions.spring.ai.get()}")
    implementation("org.springframework.ai:spring-ai-mistral-ai-spring-boot-starter:${rootProject.libs.versions.spring.ai.get()}")
    implementation("org.springframework.ai:spring-ai-ollama-spring-boot-starter:${rootProject.libs.versions.spring.ai.get()}")
    implementation("org.springframework.ai:spring-ai-openai-spring-boot-starter:${rootProject.libs.versions.spring.ai.get()}")
    implementation("org.springframework.ai:spring-ai-pinecone-store-spring-boot-starter:${rootProject.libs.versions.spring.ai.get()}")
    ...
    implementation("org.springframework.ai:spring-ai-qdrant-store-spring-boot-starter:${rootProject.libs.versions.spring.ai.get()}")
