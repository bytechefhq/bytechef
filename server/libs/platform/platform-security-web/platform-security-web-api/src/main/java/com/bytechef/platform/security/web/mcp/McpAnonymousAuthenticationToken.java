 ...
 * intentionally does not extend {@link org.springframework.security.authentication.AnonymousAuthenticationToken}, which
 * Spring's {@code authenticated()} authorization manager rejects.
 *
 * @author Ivica Cardic
 */
