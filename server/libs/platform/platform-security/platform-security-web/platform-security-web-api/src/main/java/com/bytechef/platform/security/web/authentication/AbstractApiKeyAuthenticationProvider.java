 ...
 * @author Ivica Cardic
 */
public abstract class AbstractApiKeyAuthenticationProvider implements AuthenticationProvider {
    ...
    public AbstractApiKeyAuthenticationProvider(
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        Optional<ApiKey> apiKeyOptional = apiKeyService.fetchApiKey(
            apiKeyAuthenticationToken.getSecretKey(), apiKeyAuthenticationToken.getType());
