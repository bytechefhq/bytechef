...
public class DynamicPropertiesProperty extends Property {
    ...
    public DynamicPropertiesProperty(
        ...
        this.propertiesDataSource = OptionalUtils.mapOrElse(
            property.getDynamicPropertiesDataSource(), PropertiesDataSource::new, null);
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(header, that.header) && Objects.equals(propertiesDataSource, that.propertiesDataSource);
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), header, propertiesDataSource);
    }
