 ...
 */
@WritingConverter
public class TriggerStateValueToStringConverter implements Converter<TriggerState.TriggerStateValue, String> {
    ...
    @Override
    public String convert(TriggerState.TriggerStateValue workflowTask) {
