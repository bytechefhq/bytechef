...
public class UpdateWorkflowTestConfigurationInputsRequestModel {
  ...
  public UpdateWorkflowTestConfigurationInputsRequestModel inputs(Map<String, Object> inputs) {
    this.inputs = inputs;
    return this;
  }

  public UpdateWorkflowTestConfigurationInputsRequestModel putInputsItem(String key, Object inputsItem) {
    if (this.inputs == null) {
