package com.bytechef.platform.apikey.web.rest.model;
...
@JsonTypeName("ApiKey")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2025-08-18T15:44:25.311604+02:00[Europe/Zagreb]", comments = "Generator version: 7.13.0")
public class ApiKeyModel {
  ...
  public ApiKeyModel createdDate(OffsetDateTime createdDate) {
  ...
  public ApiKeyModel lastModifiedDate(OffsetDateTime lastModifiedDate) {
  ...
  public ApiKeyModel lastUsedDate(OffsetDateTime lastUsedDate) {
  ...
  public ApiKeyModel type(Integer type) {
    this.type = type;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdBy, createdDate, id, lastModifiedBy, lastModifiedDate, lastUsedDate, name, secretKey, type);
  }
