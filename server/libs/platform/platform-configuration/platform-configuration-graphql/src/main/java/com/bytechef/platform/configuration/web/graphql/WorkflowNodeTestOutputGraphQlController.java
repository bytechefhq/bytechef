...
class WorkflowNodeTestOutputGraphQlController {

    private final WorkflowNodeTestOutputFacade workflowNodeTestOutputFacade;

    WorkflowNodeTestOutputGraphQlController(WorkflowNodeTestOutputFacade workflowNodeTestOutputFacade) {
    ...
    public WorkflowNodeTestOutputDTO saveClusterElementTestOutput(
