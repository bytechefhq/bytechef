...
/**
 * Shared fallback chain for resolving the design-time output of the last task in a task list: a
 * {@link WorkflowNodeTestOutput} sample, then the static component/dispatcher output, then a live computation via
 * {@link WorkflowNodeOutputFacade}.
 *
 * @author Ivica Cardic
 */
@Component
class TaskListOutputDataSourceImpl implements TaskListOutputDataSource {
    ...
    @Override
    public @Nullable OutputResponse getLastTaskOutput(
