...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2024-01-26T08:16:06.276056+01:00[Europe/Zagreb]")
@Validated
@Tag(name = "workflow-step-output", description = "The Platform Workflow Step Output API")
public interface WorkflowStepOutputApi {
    ...
    /**
     * GET /workflows/{workflowId}/workflow-step-outputs/{workflowNodeName} : Get dynamic output schema of an action task or trigger used in a workflow
    ...
    @RequestMapping(
        ...
        value = "/workflows/{workflowId}/workflow-step-outputs/{workflowNodeName}",
    ...
    /**
     * GET /workflows/{workflowId}/workflow-step-outputs : Get all dynamic output schemas used in a workflow
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = "/workflows/{workflowId}/workflow-step-outputs",
        produces = { "application/json" }
    )
