...
public class TriggerExecutionModel {
  ...
  */
  ...
  public TriggerExecutionModel component(ComponentDefinitionBasicModel component) {
  ...
  */
  ...
  public ComponentDefinitionBasicModel getComponent() {
    return component;
  }

  public void setComponent(ComponentDefinitionBasicModel component) {
    this.component = component;
  }
