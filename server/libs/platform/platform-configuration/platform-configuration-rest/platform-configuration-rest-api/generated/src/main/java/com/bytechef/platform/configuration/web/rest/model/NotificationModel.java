...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2025-03-28T10:19:05.403014+01:00[Europe/Zagreb]", comments = "Generator version: 7.12.0")
public class NotificationModel {
   ...
   */
  public NotificationModel(String name, NotificationTypeEnum notificationType, Map<String, String> settings, List<EventsEnum> events) {
    this.name = name;
  ...
  public NotificationModel events(List<EventsEnum> events) {
    this.events = events;
    return this;
  }

  public NotificationModel addEventsItem(EventsEnum eventsItem) {
    if (this.events == null) {
