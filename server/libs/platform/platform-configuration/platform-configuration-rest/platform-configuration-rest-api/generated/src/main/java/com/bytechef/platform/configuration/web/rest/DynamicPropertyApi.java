...
@Validated
@Tag(name = "dynamic-property", description = "The Platform Dynamic Property API")
public interface DynamicPropertyApi {
    ...
    /**
     * GET /workflows/{workflowId}/{workflowNodeName}/properties/{propertyName}/dynamic-properties : Get dynamic properties for an action or trigger property shown in the editor
     ...
     */
    @Operation(
        operationId = "getWorkflowOperationPropertyDynamicProperties",
    ...
    @RequestMapping(
        ...
        value = "/workflows/{workflowId}/{workflowNodeName}/properties/{propertyName}/dynamic-properties",
        produces = { "application/json" }
    )
    
    default ResponseEntity<List<PropertyModel>> getWorkflowOperationPropertyDynamicProperties(
