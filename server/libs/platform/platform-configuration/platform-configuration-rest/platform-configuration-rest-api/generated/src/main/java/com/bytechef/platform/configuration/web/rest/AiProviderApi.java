...
public interface AiProviderApi {
     ...
     * @param environment The environment of an AI provider. (required)
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"supportsImage\" : true, \"apiKey\" : \"apiKey\", \"requiresApiKey\" : true, \"supportsEmbeddings\" : true, \"name\" : \"name\", \"icon\" : \"icon\", \"requiresEndpoint\" : true, \"copilotDocsProvider\" : true, \"id\" : 0, \"supportsText\" : true, \"url\" : \"url\", \"enabled\" : true }, { \"supportsImage\" : true, \"apiKey\" : \"apiKey\", \"requiresApiKey\" : true, \"supportsEmbeddings\" : true, \"name\" : \"name\", \"icon\" : \"icon\", \"requiresEndpoint\" : true, \"copilotDocsProvider\" : true, \"id\" : 0, \"supportsText\" : true, \"url\" : \"url\", \"enabled\" : true } ]";
