...
public interface ActionDefinitionApi {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"componentName\" : \"componentName\", \"componentVersion\" : 0, \"description\" : \"description\", \"help\" : { \"body\" : \"body\", \"learnMoreUrl\" : \"learnMoreUrl\" }, \"name\" : \"name\", \"outputDefined\" : true, \"outputFunctionDefined\" : true, \"outputSchemaDefined\" : true, \"properties\" : [ { \"advancedOption\" : false, \"description\" : \"description\", \"displayCondition\" : \"displayCondition\", \"expressionEnabled\" : true, \"hidden\" : false, \"metadata\" : { \"key\" : \"\" }, \"name\" : \"name\", \"required\" : false, \"type\" : \"ARRAY\" }, { \"advancedOption\" : false, \"description\" : \"description\", \"displayCondition\" : \"displayCondition\", \"expressionEnabled\" : true, \"hidden\" : false, \"metadata\" : { \"key\" : \"\" }, \"name\" : \"name\", \"required\" : false, \"type\" : \"ARRAY\" } ], \"resumePerformFunctionDefined\" : true, \"sseStreamResponse\" : true, \"title\" : \"title\", \"workflowNodeDescriptionDefined\" : true }";
    ...
    default ResponseEntity<List<ActionDefinitionBasicModel>> getComponentActionDefinitions(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"componentName\" : \"componentName\", \"componentVersion\" : 0, \"description\" : \"description\", \"help\" : { \"body\" : \"body\", \"learnMoreUrl\" : \"learnMoreUrl\" }, \"name\" : \"name\", \"outputDefined\" : true, \"outputFunctionDefined\" : true, \"outputSchemaDefined\" : true, \"resumePerformFunctionDefined\" : true, \"sseStreamResponse\" : true, \"title\" : \"title\" }, { \"componentName\" : \"componentName\", \"componentVersion\" : 0, \"description\" : \"description\", \"help\" : { \"body\" : \"body\", \"learnMoreUrl\" : \"learnMoreUrl\" }, \"name\" : \"name\", \"outputDefined\" : true, \"outputFunctionDefined\" : true, \"outputSchemaDefined\" : true, \"resumePerformFunctionDefined\" : true, \"sseStreamResponse\" : true, \"title\" : \"title\" } ]";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
