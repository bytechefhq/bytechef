...
public interface WorkflowTestConfigurationApi {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"connections\" : [ { \"connectionId\" : 0, \"workflowConnectionKey\" : \"workflowConnectionKey\", \"workflowNodeName\" : \"workflowNodeName\" }, { \"connectionId\" : 0, \"workflowConnectionKey\" : \"workflowConnectionKey\", \"workflowNodeName\" : \"workflowNodeName\" } ], \"createdBy\" : \"createdBy\", \"createdDate\" : \"2000-01-23T04:56:07.000+00:00\", \"environmentId\" : 6, \"inputs\" : { \"key\" : \"\" }, \"lastModifiedBy\" : \"lastModifiedBy\", \"lastModifiedDate\" : \"2000-01-23T04:56:07.000+00:00\", \"workflowId\" : \"workflowId\", \"__version\" : 1 }";
    ...
    default ResponseEntity<List<WorkflowTestConfigurationConnectionModel>> getWorkflowTestConfigurationConnections(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"connectionId\" : 0, \"workflowConnectionKey\" : \"workflowConnectionKey\", \"workflowNodeName\" : \"workflowNodeName\" }, { \"connectionId\" : 0, \"workflowConnectionKey\" : \"workflowConnectionKey\", \"workflowNodeName\" : \"workflowNodeName\" } ]";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
