...
public interface WorkflowTestConfigurationApi {
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = "/workflow-test-configurations/{workflowId}/workflow-nodes/{workflowNodeName}/connections",
        produces = { "application/json" }
    )
    ...
    @RequestMapping(
        method = RequestMethod.PUT,
        value = "/workflow-test-configurations/{workflowId}/workflow-nodes/{workflowNodeName}/{workflowConnectionKey}/connections",
        consumes = { "application/json" }
    )
