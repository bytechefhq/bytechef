...
public interface WorkflowNodeOptionApi {
    ...
    @RequestMapping(
        ...
        value = "/workflows/{id}/workflow-nodes/{workflowNodeName}/cluster-elements/{clusterElementType}/{clusterElementWorkflowNodeName}/options/{propertyName}",
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = "/workflows/{id}/workflow-nodes/{workflowNodeName}/options/{propertyName}",
        produces = { "application/json" }
    )
