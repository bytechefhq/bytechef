...
public interface ClusterElementDefinitionApi {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"componentName\" : \"componentName\", \"componentVersion\" : 0, \"description\" : \"description\", \"help\" : { \"body\" : \"body\", \"learnMoreUrl\" : \"learnMoreUrl\" }, \"name\" : \"name\", \"icon\" : \"icon\", \"outputDefined\" : true, \"outputFunctionDefined\" : true, \"outputSchemaDefined\" : true, \"title\" : \"title\", \"type\" : \"type\", \"properties\" : [ { \"advancedOption\" : false, \"description\" : \"description\", \"displayCondition\" : \"displayCondition\", \"expressionEnabled\" : true, \"hidden\" : false, \"metadata\" : { \"key\" : \"\" }, \"name\" : \"name\", \"required\" : false, \"type\" : \"ARRAY\" }, { \"advancedOption\" : false, \"description\" : \"description\", \"displayCondition\" : \"displayCondition\", \"expressionEnabled\" : true, \"hidden\" : false, \"metadata\" : { \"key\" : \"\" }, \"name\" : \"name\", \"required\" : false, \"type\" : \"ARRAY\" } ] }";
    ...
    default ResponseEntity<List<ClusterElementDefinitionBasicModel>> getRootComponentClusterElementDefinitions(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"componentName\" : \"componentName\", \"componentVersion\" : 1, \"description\" : \"description\", \"help\" : { \"body\" : \"body\", \"learnMoreUrl\" : \"learnMoreUrl\" }, \"name\" : \"name\", \"icon\" : \"icon\", \"outputDefined\" : true, \"outputFunctionDefined\" : true, \"outputSchemaDefined\" : true, \"title\" : \"title\", \"type\" : \"type\" }, { \"componentName\" : \"componentName\", \"componentVersion\" : 1, \"description\" : \"description\", \"help\" : { \"body\" : \"body\", \"learnMoreUrl\" : \"learnMoreUrl\" }, \"name\" : \"name\", \"icon\" : \"icon\", \"outputDefined\" : true, \"outputFunctionDefined\" : true, \"outputSchemaDefined\" : true, \"title\" : \"title\", \"type\" : \"type\" } ]";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
