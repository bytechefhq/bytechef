...
public interface WorkflowNodeParameterApi {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"metadata\" : { \"key\" : \"\" }, \"parameters\" : { \"key\" : \"\" }, \"displayConditions\" : { \"key\" : true }, \"missingRequiredProperties\" : [ \"missingRequiredProperties\", \"missingRequiredProperties\" ], \"version\" : 0 }";
    ...
    default ResponseEntity<GetClusterElementParameterDisplayConditions200ResponseModel> getClusterElementParameterDisplayConditions(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"displayConditions\" : { \"key\" : true }, \"missingRequiredProperties\" : [ \"missingRequiredProperties\", \"missingRequiredProperties\" ] }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
