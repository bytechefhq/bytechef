...
public interface WorkflowNodeDynamicPropertiesApi {
    ...
    @RequestMapping(
        ...
        value = "/workflows/{id}/workflow-nodes/{workflowNodeName}/cluster-elements/{clusterElementType}/{clusterElementWorkflowNodeName}/dynamic-properties/{propertyName}",
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = "/workflows/{id}/workflow-nodes/{workflowNodeName}/dynamic-properties/{propertyName}",
        produces = { "application/json" }
    )
