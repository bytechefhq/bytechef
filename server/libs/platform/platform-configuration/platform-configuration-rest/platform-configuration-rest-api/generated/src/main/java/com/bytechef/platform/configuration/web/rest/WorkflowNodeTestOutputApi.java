...
public interface WorkflowNodeTestOutputApi {
    ...
    @RequestMapping(
        ...
        value = "/workflows/{id}/workflow-nodes/{workflowNodeName}/test-outputs/exists",
    ...
    @RequestMapping(
        ...
        value = "/workflows/{id}/workflow-nodes/{workflowNodeName}/test-outputs"
    )
    ...
    @RequestMapping(
        method = RequestMethod.PUT,
        value = "/workflows/{id}/workflow-nodes/{workflowNodeName}/test-outputs/sample-output",
        produces = { "application/json" },
