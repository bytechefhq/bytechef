...
public interface WorkflowNodeOutputApi {
    ...
    @RequestMapping(
        ...
        value = "/workflows/{id}/workflow-nodes/{workflowNodeName}/cluster-elements/{clusterElementType}/{clusterElementWorkflowNodeName}/outputs",
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = "/workflows/{id}/workflow-nodes/{workflowNodeName}/outputs",
        produces = { "application/json" }
    )
