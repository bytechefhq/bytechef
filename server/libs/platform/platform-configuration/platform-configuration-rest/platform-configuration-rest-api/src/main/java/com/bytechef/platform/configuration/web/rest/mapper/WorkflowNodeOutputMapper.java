...
public interface WorkflowNodeOutputMapper extends Converter<WorkflowNodeOutputDTO, WorkflowNodeOutputModel> {

    @Override
    WorkflowNodeOutputModel convert(WorkflowNodeOutputDTO workflowNodeOutputDTO);
}
