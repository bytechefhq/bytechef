...
public interface ScriptExecutionMapper extends Converter<ScriptTestExecutionDTO, ScriptTestExecutionModel> {

    @Override
    ScriptTestExecutionModel convert(ScriptTestExecutionDTO scriptTestExecutionDTO);
}
