...
public enum ConnectionStatus {
     ...
     * transitions return false — callers that want an idempotent no-op should check for equality first. The
     * reassignment facade relies on this method to classify rows as skipped-vs-failed.
     */
