...
public class ModifiableParametersImpl implements Parameters {
    private final Map<String, Object> map;

    @SuppressFBWarnings("EI")
    public ModifiableParametersImpl(Map<String, ?> map) {
    ...
    public Duration getDuration(String key, Duration defaultDuration) {
        return MapUtils.getDuration(map, key, defaultDuration);
    }
    ...
    public <T> List<T> getList(String key, TypeReference<T> elementTypeReference) {
        return MapUtils.getList(map, key, new com.fasterxml.jackson.core.type.TypeReference<>() {
    ...
    public <T> List<T> getList(String rows, TypeReference<T> typeReference, List<T> defaultValue) {
        return MapUtils.getList(map, rows, new com.fasterxml.jackson.core.type.TypeReference<>() {
    ...
    public <V> Map<String, V> getMap(String key, TypeReference<V> valueTypeReference) {
        return MapUtils.getMap(map, key, new com.fasterxml.jackson.core.type.TypeReference<>() {
    ...
    public <T> List<T> getRequiredList(String key, TypeReference<T> elementTypeReference) {
        return MapUtils.getRequiredList(map, key, new com.fasterxml.jackson.core.type.TypeReference<>() {
    ...
    public <V> Map<String, V> getRequiredMap(String key, TypeReference<V> valueTypeReference) {
        return MapUtils.getRequiredMap(map, key, new com.fasterxml.jackson.core.type.TypeReference<>() {
