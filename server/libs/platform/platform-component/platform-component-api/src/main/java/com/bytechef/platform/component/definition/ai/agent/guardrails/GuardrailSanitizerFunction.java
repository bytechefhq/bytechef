...
/**
 * Functional contract implemented by each guardrail used under a SanitizeText cluster.
 *
 * @author Ivica Cardic
 */
@FunctionalInterface
public interface GuardrailSanitizerFunction extends StagedGuardrail {
     ...
     * @return the sanitized text. MUST NOT return {@code null}; implementations with nothing to redact must return
     *         {@code text} unchanged.
     */
