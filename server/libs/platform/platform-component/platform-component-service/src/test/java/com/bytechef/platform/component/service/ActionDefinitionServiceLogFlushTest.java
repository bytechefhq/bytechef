...
/**
 * Covers the flush of buffered component log entries once a perform has run, whether it returned or threw.
 *
 * @author Ivica Cardic
 */
class ActionDefinitionServiceLogFlushTest {
    ...
    @Test
    void testBufferedLogEntriesAreFlushedAfterASuccessfulPerform() {
    ...
    @Test
    void testBufferedLogEntriesAreFlushedWhenThePerformThrows() {
        MultipleConnectionsPerformFunction performFunction =
