...
/**
 * Runs {@link DataTableExternalIdColumnMigrator} as a Liquibase {@code customChange}.
 *
 * <p>
 ...
 * @author Ivica Cardic
 */
public class DataTableExternalIdColumnChange implements CustomTaskChange {
    ...
    public void execute(Database database) throws CustomChangeException {
        ...
        DataTableExternalIdColumnMigrator dataTableExternalIdColumnMigrator = new DataTableExternalIdColumnMigrator(
            new JdbcTemplate(dataSource));

        alteredTableCount = dataTableExternalIdColumnMigrator.migrate(database.getDefaultSchemaName());
    }

    @Override
    public String getConfirmationMessage() {
        return "Added external_id to " + alteredTableCount + " data tables";
    }
