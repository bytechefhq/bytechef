...
public class KnowledgeBaseReferenceResolver implements ResourceReferenceResolver {
    ...
    public String findProblem(String reference, long environmentId) {
        ...
        boolean exists = knowledgeBaseService.getKnowledgeBases()
            .stream()
            .anyMatch(knowledgeBase -> Objects.equals(knowledgeBase.getId(), knowledgeBaseId) &&
                knowledgeBase.getEnvironmentId() == environmentId);
