...
val generateOpenAPISpring by tasks.registering(org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    apiPackage.set("com.bytechef.platform.codeworkflow.configuration.automation.public_.web.rest")
    configOptions.set(
        mapOf(
    ...
    modelPackage.set("com.bytechef.platform.codeworkflow.configuration.automation.web.rest.model")
