...
public final class TwilioSignatureValidator {
    ...
    static boolean isValid(
        String authToken, String url, @Nullable Map<String, String> params, @Nullable String signature) {

        if (authToken == null || authToken.isBlank() || signature == null || signature.isBlank()) {
            return false;
        }
    ...
    static String computeSignature(String authToken, String url, @Nullable Map<String, String> params) {
