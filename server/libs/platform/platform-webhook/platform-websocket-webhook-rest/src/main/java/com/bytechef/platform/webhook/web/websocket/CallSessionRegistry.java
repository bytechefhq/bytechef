...
public class CallSessionRegistry {
    ...
    public static class CallSession {
        ...
        private boolean signalCompletionOnClose;
        ...
        public boolean isSignalCompletionOnClose() {
            return signalCompletionOnClose;
        }

        /**
         * When set to true, the WebSocket handler will signal completion directly when the connection closes, without
         * waiting for an external callback (e.g., Twilio status callback). Use this for WebSocket-only integrations
         * (ElevenLabs, Deepgram, etc.) where no external after-call endpoint is involved.
         */
        public void setSignalCompletionOnClose(boolean signalCompletionOnClose) {
            this.signalCompletionOnClose = signalCompletionOnClose;
        }
