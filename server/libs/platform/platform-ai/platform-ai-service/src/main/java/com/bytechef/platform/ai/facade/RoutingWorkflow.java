...
public class RoutingWorkflow {
    ...
    private String determineRoute(String input, Iterable<String> availableRoutes) {
        ...
        String selectorPrompt = String.format("""
                Analyze the input content and determine the most appropriate route based on content classification. The classification process considers key terms, context and patterns in the input to select the optimal route: %s
