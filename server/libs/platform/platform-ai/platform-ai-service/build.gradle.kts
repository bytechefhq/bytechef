dependencies {
    ...
    implementation("org.springframework.ai:spring-ai-commons:${rootProject.libs.versions.spring.ai.get()}")
    implementation("org.springframework.boot:spring-boot-autoconfigure")
    implementation("org.springframework.ai:spring-ai-advisors-vector-store:${rootProject.libs.versions.spring.ai.get()}")
