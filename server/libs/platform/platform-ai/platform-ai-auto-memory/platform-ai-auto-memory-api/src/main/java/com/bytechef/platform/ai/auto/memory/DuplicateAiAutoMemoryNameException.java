...
public class DuplicateAiAutoMemoryNameException extends RuntimeException {
    ...
    public DuplicateAiAutoMemoryNameException(String name) {
        super("A memory named '" + name + "' already exists for this owner in this workspace and environment");

        this.name = name;
    }

    public DuplicateAiAutoMemoryNameException(String name, Throwable cause) {
        super("A memory named '" + name + "' already exists for this owner in this workspace and environment", cause);
