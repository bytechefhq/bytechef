 ...
 * <code>bytechef.endpoint.enabled</code> containing the value <code>true</code>
 *
 * @author Ivica Cardic
 */
@Documented
...
@ConditionalOnProperty(prefix = "bytechef", name = "endpoint.enabled", matchIfMissing = true)
