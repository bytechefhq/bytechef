...
/**
 * Shapes the JSON payload for WEBHOOK-channel escalations sent when a run has been awaiting approval past the
 * escalation window and is still unresolved. Transport, headers, and HMAC signing are owned by the shared delivery
 * client behind {@code WebhookNotificationSender}.
 *
 * @author Ivica Cardic
 */
@Component
...
public class ApprovalEscalationWebhookNotificationHandler implements WebhookNotificationHandler {
