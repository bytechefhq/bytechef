...
/**
 * Shapes the EMAIL-channel reminder sent while a run is paused on an approval that is about to expire.
 *
 * @author Ivica Cardic
 */
@Component
...
public class ApprovalReminderEmailNotificationHandler implements EmailNotificationHandler {

    private final MessageSource messageSource;

    public ApprovalReminderEmailNotificationHandler(MessageSource messageSource) {
