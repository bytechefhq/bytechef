...
/**
 * Shapes the JSON payload for WEBHOOK-channel job-status notifications. Transport, headers, and HMAC signing are owned
 * by the shared delivery client behind {@code WebhookNotificationSender}.
 *
 * @author Ivica Cardic
 */
@Component
