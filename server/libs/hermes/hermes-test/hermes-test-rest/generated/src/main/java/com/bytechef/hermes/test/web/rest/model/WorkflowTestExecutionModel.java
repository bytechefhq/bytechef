...
public class WorkflowTestExecutionModel {
  ...
  public WorkflowTestExecutionModel job(com.bytechef.hermes.execution.web.rest.model.JobModel job) {
    this.job = job;
    return this;
  }
  ...
  */
  ...
  public WorkflowTestExecutionModel triggerExecution(com.bytechef.hermes.execution.web.rest.model.TriggerExecutionModel triggerExecution) {
