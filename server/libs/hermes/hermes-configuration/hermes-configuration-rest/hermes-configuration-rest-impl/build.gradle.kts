...
val generateOpenAPISpring by tasks.registering(org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    ...
    outputDir.set("$projectDir/../hermes-configuration-rest-api/generated")
}
...
dependencies {
    ...
    implementation(project(":server:libs:hermes:hermes-configuration:hermes-configuration-rest:hermes-configuration-rest-api"))
