...
@Schema(
    name = "getOAuth2AuthorizationParameters_request",
...
public class GetOAuth2AuthorizationParametersRequestModel {
    ...
    @Schema(
        name = "connectionVersion", description = "The version of a connection.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    public boolean equals(Object o) {
        ...
        GetOAuth2AuthorizationParametersRequestModel getOAuth2AuthorizationParametersRequest =
            (GetOAuth2AuthorizationParametersRequestModel) o;
