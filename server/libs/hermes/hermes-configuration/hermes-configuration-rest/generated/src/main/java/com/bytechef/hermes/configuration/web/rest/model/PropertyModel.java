...
public class PropertyModel {
    ...
    @Schema(
        name = "advancedOption", description = "If the property should be grouped under advanced options.",
    ...
    @Schema(
        name = "description", description = "The property description.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(
        name = "expressionEnabled",
        description = "Defines if the property can contain expressions or only constant values. Defaults to true.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(
        name = "hidden", description = "If the property should be visible or not.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("hidden")
    ...
    @Schema(
        name = "placeholder", description = "The property placeholder.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(
        name = "required", description = "If the property is required or not.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(advancedOption, description, displayCondition, expressionEnabled, hidden, label, name,
    ...
    public String toString() {
        ...
        sb.append("    advancedOption: ")
            .append(toIndentedString(advancedOption))
            .append("\n");
        ...
        sb.append("    displayCondition: ")
            ...
            .append("\n");
        sb.append("    expressionEnabled: ")
            .append(toIndentedString(expressionEnabled))
            .append("\n");
        sb.append("    hidden: ")
            .append(toIndentedString(hidden))
            .append("\n");
        sb.append("    label: ")
