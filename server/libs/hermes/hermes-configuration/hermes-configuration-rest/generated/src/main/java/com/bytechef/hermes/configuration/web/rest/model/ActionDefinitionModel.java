...
/**
 * An action is a portion of reusable code that accomplish a specific task. When building a workflow, each action is
 * represented as a task inside the workflow. The task &#39;type&#39; property is defined as [component
 * name]/v[component version]/[action name]. Action properties are used to set properties of the task inside the
 * workflow.
 */
...
public class ActionDefinitionModel {
    ...
    @Schema(
        name = "componentName", description = "The component name.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(
        name = "componentVersion", description = "The component version.",
    ...
    @Schema(
        name = "sampleOutput", description = "The sample value of the action's output.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Valid
    @Schema(
        name = "properties", description = "The list of action properties.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(componentName, componentVersion, description, sampleOutput, help, name, outputSchema,
            properties, title);
    }
    ...
    public String toString() {
        ...
        sb.append("    sampleOutput: ")
            .append(toIndentedString(sampleOutput))
            .append("\n");
        sb.append("    help: ")
        ...
        sb.append("    outputSchema: ")
            .append(toIndentedString(outputSchema))
            .append("\n");
