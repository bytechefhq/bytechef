...
public class TaskDispatcherDefinitionModel {
    ...
    @Valid
    @Schema(
        name = "properties", description = "The list of task dispatcher properties.",
    ...
    @NotNull
    @Schema(
        name = "version", description = "The version of a task dispatcher.",
    ...
    @Valid
    @Schema(
        name = "taskProperties", description = "Properties used to define tasks to be dispatched.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(description, icon, name, outputSchema, properties, resources, version, taskProperties,
            title);
    }
    ...
    public String toString() {
        ...
        sb.append("    taskProperties: ")
            .append(toIndentedString(taskProperties))
            .append("\n");
        sb.append("    title: ")
