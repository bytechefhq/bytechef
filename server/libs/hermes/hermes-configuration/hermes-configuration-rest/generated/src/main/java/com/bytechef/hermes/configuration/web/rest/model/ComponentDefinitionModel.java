...
/**
 * A component contains a set of reusable code(actions) that accomplish specific tasks, triggers and connections if
 * there is a need for a connection to an outside service.
 */
...
public class ComponentDefinitionModel {
    ...
    @Valid
    @Schema(
        name = "actions", description = "The list of all available actions the component can perform.",
    ...
    @Valid
    @Schema(
        name = "triggers", description = "The list of all available triggers the component can perform.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(actions, category, connection, description, icon, name, resources, tags, title, triggers,
            version);
    }
