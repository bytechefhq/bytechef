...
public class OptionModel {
    ...
    @Schema(
        name = "description", description = "Description of the option.",
    ...
    @Schema(
        name = "displayCondition", description = "Defines rules when a property should be shown or hidden.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(
        name = "value", description = "Can be anything: string, number, array, object, etc. (except `null`)",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("value")
    ...
    private static <T> int hashCodeNullable(JsonNullable<T> a) {
        ...
        return a.isPresent() ? Arrays.deepHashCode(new Object[] {
            a.get()
        }) : 31;
    }
    ...
    public String toString() {
        ...
        sb.append("    displayCondition: ")
            .append(toIndentedString(displayCondition))
            .append("\n");
        sb.append("    name: ")
