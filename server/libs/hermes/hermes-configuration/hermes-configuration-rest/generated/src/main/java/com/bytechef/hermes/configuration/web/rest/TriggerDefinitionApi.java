...
public interface TriggerDefinitionApi {
    ...
    /**
     * GET /component-definitions/{componentName}/{componentVersion}/trigger-definitions/{triggerName} : Get a trigger
     * definition of a component Get a trigger definition of a component.
     *
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Successful operation.", content = {
                @Content(
                    mediaType = "application/json", schema = @Schema(implementation = TriggerDefinitionModel.class))
            })
        })
    @RequestMapping(
    ...
    default ResponseEntity<TriggerDefinitionModel> getComponentTriggerDefinition(
        @Parameter(
            name = "componentName", description = "The name of the component.", required = true,
        ...
        @Parameter(
            name = "triggerName", description = "The name of a trigger to get.", required = true,
            in = ParameterIn.PATH) @PathVariable("triggerName") String triggerName) {
    ...
    /**
     * GET /component-definitions/{componentName}/{componentVersion}/trigger-definitions : Get a list of trigger
     * definitionss for a component Get a list of trigger definitionss for a component.
     *
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Successful operation.", content = {
                @Content(
                    ...
                    array = @ArraySchema(schema = @Schema(implementation = TriggerDefinitionBasicModel.class)))
            })
        })
    @RequestMapping(
        method = RequestMethod.GET,
     ...
     * Get an trigger description shown in the editor Get an trigger description shown in the editor.
     *
     * @param componentName                  The name of the component. (required)
     * @param componentVersion               The version of a component. (required)
    ...
    default ResponseEntity<String> getComponentTriggerEditorDescription(
        ...
        @Parameter(
            ...
            in = ParameterIn.PATH) @PathVariable("componentVersion") Integer componentVersion,
        @Parameter(
            name = "triggerName", description = "The name of a trigger.", required = true,
            in = ParameterIn.PATH) @PathVariable("triggerName") String triggerName,
    ...
    /**
     * POST /component-definitions/{componentName}/{componentVersion}/trigger-definitions/{triggerName}/output-schema :
     * Get a trigger output schema shown in the editor Get a trigger output schema shown in the editor.
     *
     * @param componentName                  The name of the component. (required)
     * @param componentVersion               The version of a component. (required)
     * @param triggerName                    The name of a trigger. (required)
     ...
     * : Get dynamic properties for a trigger property shown in the editor Get dynamic properties for a trigger property
     * shown in the editor.
     *
     * @param componentName                  The name of a component. (required)
     * @param componentVersion               The version of a component. (required)
     ...
     * : Get a trigger property options shown in the editor Get a trigger property options shown in the editor.
     *
     * @param componentName                  The name of the component. (required)
     * @param componentVersion               The version of a component. (required)
     * @param triggerName                    The name of a trigger. (required)
    ...
    /**
     * POST /component-definitions/{componentName}/{componentVersion}/trigger-definitions/{triggerName}/sample-output :
     * Get a trigger sample output shown in the editor Get a trigger sample output shown in the editor.
     *
     * @param componentName                  The name of the component. (required)
     * @param componentVersion               The version of a component. (required)
     * @param triggerName                    The name of a trigger. (required)
    ...
    /**
     * GET /trigger-definitions : Get all trigger definitions Get all trigger definitions.
     *
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Successful operation.", content = {
                @Content(
                    mediaType = "application/json",
                    array = @ArraySchema(schema = @Schema(implementation = TriggerDefinitionModel.class)))
            })
        })
    @RequestMapping(
        method = RequestMethod.GET,
    ...
    default ResponseEntity<List<TriggerDefinitionModel>> getTriggerDefinitions(
        @Parameter(
            ...
            in = ParameterIn.QUERY) @Valid @RequestParam(
                value = "triggerTypes", required = false) List<String> triggerTypes) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType : MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString =
