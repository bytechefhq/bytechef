...
public class ValuePropertyModel extends PropertyModel {
    ...
    @Schema(
        name = "defaultValue", description = "The property default value.",
    ...
    @Schema(
        name = "exampleValue", description = "The property sample value.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    public String toString() {
        ...
        sb.append("    controlType: ")
            .append(toIndentedString(controlType))
            .append("\n");
        sb.append("    defaultValue: ")
            .append(toIndentedString(defaultValue))
            .append("\n");
        sb.append("    exampleValue: ")
            .append(toIndentedString(exampleValue))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
