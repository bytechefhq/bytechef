...
public interface SampleOutputResponseMapper extends Converter<SampleOutputResponse, SampleOutputResponseModel> {

    @Override
    SampleOutputResponseModel convert(SampleOutputResponse sampleOutputResponse);
}
