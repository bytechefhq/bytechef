...
public interface EditorDescriptionResponseMapper
    extends Converter<EditorDescriptionResponse, EditorDescriptionResponseModel> {

    @Override
    EditorDescriptionResponseModel convert(EditorDescriptionResponse editorDescriptionResponse);
}
