...
public interface OutputSchemaResponseMapper extends Converter<OutputSchemaResponse, OutputSchemaResponseModel> {

    @Override
    OutputSchemaResponseModel convert(OutputSchemaResponse outputSchemaResponse);
}
