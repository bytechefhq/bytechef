 ...
 */
@Component
public class InstanceConnectionFetcherAccessorImpl implements InstanceConnectionFetcherAccessor {

    private final Map<String, InstanceConnectionFetcher> instanceConnectionFetcherMap;

    public InstanceConnectionFetcherAccessorImpl(List<InstanceConnectionFetcher> instanceConnectionFetchers) {
