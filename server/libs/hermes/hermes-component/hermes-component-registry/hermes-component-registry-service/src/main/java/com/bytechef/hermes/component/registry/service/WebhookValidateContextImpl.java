...
public record WebhookValidateContextImpl(
    Map<String, ?> inputParameters, TriggerDefinition.HttpHeaders headers,
    ...
    implements TriggerDefinition.WebhookValidateContext {
}
