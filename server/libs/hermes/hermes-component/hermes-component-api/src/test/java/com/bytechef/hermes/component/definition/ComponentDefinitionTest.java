...
public class ComponentDefinitionTest {
    ...
    public void testComponentDefinition() throws JSONException, JsonProcessingException {
        ...
        jsonAssertEquals(
            """
                {"actions":null,"category":null,"connection":null,"customAction":null,"customActionHelp":null,"description":"description","icon":"icon","tags":null,"compatibleConnections":null,"metadata":null,"name":"name","resources":null,"version":1,"title":"title","triggers":null}
                  """,
            componentDefinition);
    }
