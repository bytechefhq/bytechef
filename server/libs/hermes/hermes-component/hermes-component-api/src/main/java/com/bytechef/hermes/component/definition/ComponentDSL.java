...
public final class ComponentDSL {
    ...
    public static final class ModifiableActionDefinition implements ActionDefinition {
        ...
        private ActionSampleOutputFunction sampleOutputFunction;
        ...
        public <P extends OutputProperty<?>> ModifiableActionDefinition outputSchema(P outputSchema) {
        ...
        public ModifiableActionDefinition sampleOutput(ActionSampleOutputFunction sampleOutput) {
    ...
    public static final class ModifiableArrayProperty
        ...
        public ModifiableArrayProperty defaultValue(String... defaultValue) {
            this.defaultValue = defaultValue == null ? List.of() : List.of((String[]) defaultValue);
        ...
        public final ModifiableArrayProperty defaultValue(Map<String, ?>... defaultValue) {
            this.defaultValue = defaultValue == null ? List.of() : List.of((Map<String, ?>[]) defaultValue);
        ...
        public ModifiableArrayProperty exampleValue(String... exampleValue) {
            this.exampleValue = exampleValue == null ? List.of() : List.of((String[]) exampleValue);
        ...
        public final ModifiableArrayProperty exampleValue(Map<String, ?>... exampleValue) {
            this.exampleValue = exampleValue == null ? List.of() : List.of((Map<String, ?>[]) exampleValue);
    ...
    public static final class ModifiableStringProperty
        ...
        protected ModifiableStringProperty(String name) {
    ...
    public static final class ModifiableTriggerDefinition implements TriggerDefinition {
        ...
        private List<? extends InputProperty> properties;
        private Object sampleOutput;
        private TriggerSampleOutputFunction sampleOutputFunction;
        ...
        public <P extends OutputProperty<?>> ModifiableTriggerDefinition outputSchema(P outputSchema) {
            this.outputSchemaProperty = outputSchema;
