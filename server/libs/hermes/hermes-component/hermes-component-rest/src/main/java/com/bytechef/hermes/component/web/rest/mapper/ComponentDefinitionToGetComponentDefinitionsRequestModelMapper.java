...
public interface ComponentDefinitionToGetComponentDefinitionsRequestModelMapper
    extends Converter<ComponentDefinition, GetComponentDefinitionsRequestModel> {

    GetComponentDefinitionsRequestModel convert(ComponentDefinition componentDefinition);
}
