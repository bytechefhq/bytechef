...
public enum EditorTypeModel {
  
  CODE("CODE");

  private String value;

  EditorTypeModel(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static EditorTypeModel fromValue(String value) {
    for (EditorTypeModel b : EditorTypeModel.values()) {
