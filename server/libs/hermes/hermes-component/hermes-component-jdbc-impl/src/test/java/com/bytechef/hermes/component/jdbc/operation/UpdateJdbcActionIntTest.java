...
public class UpdateJdbcActionIntTest {
    ...
    public void testUpdate() {
        ...
        Map<String, Integer> result = updateJdbcOperation.execute(new MockContext(), parameters);
    ...
    public static class UpdateJdbcTaskHandlerIntTestConfiguration {
        ...
        @Bean
        UpdateJdbcOperation updateJdbcOperation(PlatformTransactionManager transactionManager) {
