 ...
 * @author Ivica Cardic
 */
public class DefaultComponentTaskHandlerBeanDefinitionLoader
    extends AbstractComponentTaskHandlerBeanDefinitionLoader<ComponentHandler> {

    public DefaultComponentTaskHandlerBeanDefinitionLoader() {
