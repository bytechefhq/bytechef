...
@WebFluxTest(
    value = LocalTaskDispatcherDefinitionController.class,
    properties = {
        "spring.application.name=coordinator-service-app"
    })
public class LocalTaskDispatcherDefinitionControllerIntTest {
