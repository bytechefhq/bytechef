...
public class LocalTaskDispatcherDefinitionController implements TaskDispatcherDefinitionsApi {

    private final ConversionService conversionService;
    private final TaskDispatcherDefinitionService taskDispatcherDefinitionService;

    public LocalTaskDispatcherDefinitionController(
        ...
        return Mono.just(
            ResponseEntity.ok(
                taskDispatcherDefinitionService.getTaskDispatcherDefinitions()
                    .mapNotNull(taskDispatcherDefinition -> conversionService.convert(taskDispatcherDefinition,
