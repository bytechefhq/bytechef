...
package com.bytechef.hermes.definition.registry.component.trigger;
    ...
    public static class WebhookRequestConverter implements Converter<Map<String, Object>, WebhookRequest> {
        ...
        public WebhookRequest convert(Map<String, Object> source) {
            ...
            if (MapUtils.containsKey(source,
                ...
                webhookBody = new WebhookBody(content, contentType, MapUtils.getString(bodyMap, "mimeType"));
            }
        ...
        private static Map<String, Object> checkContent(Map<String, ?> bodyMap) {
            return MapUtils.toMap(
                MapUtils.getRequiredMap(bodyMap, CONTENT),
                Map.Entry::getKey,
                entry -> {
