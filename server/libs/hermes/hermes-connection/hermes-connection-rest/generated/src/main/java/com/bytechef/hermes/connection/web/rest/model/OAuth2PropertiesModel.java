...
public class OAuth2PropertiesModel {
  ...
  @Valid
  private List<String> predefinedApps = null;
  ...
  */
  ...
  @Schema(name = "predefinedApps", accessMode = Schema.AccessMode.READ_ONLY, description = "A list of predefined OAuth2 apps.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
