...
class AgentJudgeFactoryTest {
    ...
    private final AgentJudgeFactory agentJudgeFactory = new AgentJudgeFactory();

    @Test
    void testCreateLlmRuleJudge() {
        Map<String, Object> configuration = Map.of("rule", "The response must be polite");

        Judge judge = agentJudgeFactory.createJudge("politeness", AgentJudgeType.LLM_RULE, configuration, null);
    ...
    void testCreateContainsTextJudge() {
        ...
        Judge judge = agentJudgeFactory.createJudge(
            "containsHello", AgentJudgeType.CONTAINS_TEXT, configuration, null);
    ...
    void testCreateContainsTextJudgeFails() {
        ...
        Judge judge = agentJudgeFactory.createJudge(
            "containsGoodbye", AgentJudgeType.CONTAINS_TEXT, configuration, null);
    ...
    void testCreateRegexMatchJudge() {
        ...
        Judge judge = agentJudgeFactory.createJudge("phonePattern", AgentJudgeType.REGEX_MATCH, configuration, null);
    ...
    void testCreateResponseLengthJudge() {
        ...
        Judge judge = agentJudgeFactory.createJudge(
            "lengthCheck", AgentJudgeType.RESPONSE_LENGTH, configuration, null);
    ...
    void testCreateJsonSchemaJudge() {
        ...
        Judge judge = agentJudgeFactory.createJudge("jsonCheck", AgentJudgeType.JSON_SCHEMA, configuration, null);
    ...
    void testCreateSimilarityJudge() {
        ...
        Judge judge = agentJudgeFactory.createJudge(
            "similarityCheck", AgentJudgeType.SIMILARITY, configuration, null);
