 ...
 * @author Ivica Cardic
 */
@Table("agent_eval_run")
public final class AgentEvalRun {
    ...
    public AgentEvalRunStatus getStatus() {
        return AgentEvalRunStatus.values()[status];
    }

    public void setStatus(AgentEvalRunStatus status) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AgentEvalRun agentEvalRun)) {
            return false;
        }

        return Objects.equals(id, agentEvalRun.id);
    }
