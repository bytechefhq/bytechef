 ...
 * @author Ivica Cardic
 */
@Table("agent_judge_verdict")
public final class AgentJudgeVerdict {
    ...
    public AgentJudgeType getJudgeType() {
        return AgentJudgeType.values()[judgeType];
    }

    public void setJudgeType(AgentJudgeType judgeType) {
        this.judgeType = judgeType.ordinal();
    }

    public AgentJudgeScope getJudgeScope() {
        return AgentJudgeScope.values()[judgeScope];
    }

    public void setJudgeScope(AgentJudgeScope judgeScope) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AgentJudgeVerdict agentJudgeVerdict)) {
            return false;
        }
