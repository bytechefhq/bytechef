...
import com.bytechef.ai.agent.eval.file.storage.AgentEvalFileStorageImpl;
 ...
 */
@Configuration
class AgentEvalFileStorageConfiguration {

    @Bean
    AgentEvalFileStorage agentEvalFileStorage(
        ...
        return new AgentEvalFileStorageImpl(fileStorageServiceRegistry.getFileStorageService(provider.name()));
    }
}
