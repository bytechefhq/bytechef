...
class DataTableAgentToolCallbackTest {

    @Test
    void toolDefinitionExposesDataTableAgent() {
        DataTableAgentToolCallback toolCallback =
            new DataTableAgentToolCallback(Mockito.mock(ChatClient.class));
