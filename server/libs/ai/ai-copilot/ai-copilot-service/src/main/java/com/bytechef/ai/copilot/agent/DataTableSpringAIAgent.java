 ...
 * @author Ivica Cardic
 */
public class DataTableSpringAIAgent extends CopilotSpringAIAgent {
    ...
    protected DataTableSpringAIAgent(final Builder builder) throws AGUIException {
    ...
    public static class Builder extends SpringAIAgent.Builder {
        ...
        public DataTableSpringAIAgent build() throws AGUIException {

            return new DataTableSpringAIAgent(this);
        }
    }
}
