 ...
 * @author Ivica Cardic
 */
public class AiAgentSpringAIAgent extends CopilotSpringAIAgent {
    ...
    protected AiAgentSpringAIAgent(final Builder builder) throws AGUIException {
    ...
    public static class Builder extends SpringAIAgent.Builder {
        ...
        public AiAgentSpringAIAgent build() throws AGUIException {

            return new AiAgentSpringAIAgent(this);
        }
    }
}
