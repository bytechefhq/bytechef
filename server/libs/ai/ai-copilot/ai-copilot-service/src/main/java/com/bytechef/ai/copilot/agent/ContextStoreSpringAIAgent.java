 ...
 * @author Ivica Cardic
 */
public class ContextStoreSpringAIAgent extends CopilotSpringAIAgent {
    ...
    protected ContextStoreSpringAIAgent(final Builder builder) throws AGUIException {
    ...
    public static class Builder extends SpringAIAgent.Builder {
        ...
        public ContextStoreSpringAIAgent build() throws AGUIException {

            return new ContextStoreSpringAIAgent(this);
        }
    }
}
