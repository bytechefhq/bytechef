...
public class JsonSchemaBuilderSpringAIAgent extends CopilotSpringAIAgent {
    ...
    protected JsonSchemaBuilderSpringAIAgent(final Builder builder) throws AGUIException {
    ...
    protected SystemMessage createSystemMessage(State state, List<Context> contexts) {
        Object currentSchema = state.get("currentJsonSchema");
    ...
    public static class Builder extends SpringAIAgent.Builder {
        ...
        public JsonSchemaBuilderSpringAIAgent build() throws AGUIException {

            return new JsonSchemaBuilderSpringAIAgent(this);
        }
    }
}
