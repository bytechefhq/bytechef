 ...
 * @author Ivica Cardic
 */
public class KnowledgeBaseSpringAIAgent extends CopilotSpringAIAgent {
    ...
    protected KnowledgeBaseSpringAIAgent(final Builder builder) throws AGUIException {
    ...
    public static class Builder extends SpringAIAgent.Builder {
        ...
        public KnowledgeBaseSpringAIAgent build() throws AGUIException {

            return new KnowledgeBaseSpringAIAgent(this);
        }
    }
}
