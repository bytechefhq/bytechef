...
/**
 * Implementation of {@link ManagementMcpServerService}. The tenant-admin gate lives here (not on the GraphQL
 * controller) so every caller of the secret-exposing operations is checked.
 *
 * @author Ivica Cardic
 */
@Service
public class ManagementMcpServerServiceImpl implements ManagementMcpServerService {
    ...
    public ManagementMcpServerServiceImpl(
