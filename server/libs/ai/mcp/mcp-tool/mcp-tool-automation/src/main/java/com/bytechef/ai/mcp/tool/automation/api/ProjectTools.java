...
public interface ProjectTools extends ChatProjectTools {
    ProjectToolsImpl.ProjectInfo
        createProject(String name, String description, Long categoryId, Long workspaceId, List<Long> tagIds);

    String deleteProject(long projectId);

    ProjectToolsImpl.ProjectInfo
        updateProject(long projectId, String name, String description, Long categoryId, List<Long> tagIds);
