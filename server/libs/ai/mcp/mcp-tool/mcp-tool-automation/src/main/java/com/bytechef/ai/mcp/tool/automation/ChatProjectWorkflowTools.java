 ...
 */
@Component
public class ChatProjectWorkflowTools {

    private static final Logger logger = LoggerFactory.getLogger(ChatProjectWorkflowTools.class);

    protected final ProjectWorkflowFacade projectWorkflowFacade;
    protected final TaskTools taskTools;

    protected static final String DEFAULT_DEFINITION = """
        {
            "label": "workflowName",
    ...
    public ChatProjectWorkflowTools(ProjectWorkflowFacade projectWorkflowFacade, TaskTools taskTools) {
