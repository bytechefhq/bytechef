...
import com.bytechef.ai.mcp.tool.automation.exception.ProjectToolErrorType;
import com.bytechef.ai.mcp.tool.automation.model.ProjectDeploymentStatusInfo;
import com.bytechef.ai.mcp.tool.automation.model.ProjectDetailInfo;
import com.bytechef.ai.mcp.tool.automation.model.ProjectInfo;
import com.bytechef.ai.mcp.tool.automation.model.ProjectPublishInfo;
import com.bytechef.ai.mcp.tool.automation.model.ProjectStatusInfo;
import com.bytechef.ai.mcp.tool.automation.model.ProjectVersionInfo;
...
public class ProjectTools {
    ...
    public List<ProjectInfo> listProjects() {
        try {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("listProjects(): Found {} projects", projectInfos.size());
            }

            return projectInfos;
        } catch (Exception e) {
            logger.error("listProjects(): Failed to list projects", e);
    ...
    public ProjectDetailInfo getProject(
        ...
        try {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("getProject({}): Retrieved project {} with {} versions", projectId, projectId,
            ...
            logger.error("getProject({}): Failed to get project {}", projectId, projectId, e);
    ...
    public String deleteProject(
        ...
        try {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("deleteProject({}): Deleted project {} with name '{}'", projectId, projectId, projectName);
            }
