 ...
 * <code>bytechef.coordinator.enabled</code> containing the value <code>true</code>.
 *
 * @author Arik Cohen
 * @author Ivica Cardic
 * @since Apr 4, 2017
...
@ConditionalOnProperty(
    prefix = "bytechef", name = "coordinator.enabled", havingValue = "true", matchIfMissing = true)
