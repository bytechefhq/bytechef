...
public interface WorkflowApi {
    ...
    /**
     * DELETE /projects/{id}/workflows/{workflowId} : Delete a workflow Delete a workflow.
     *
    ...
    /**
     * POST /projects/{id}/workflows/{workflowId}/duplicate : Duplicates existing workflow. Duplicates existing
     * workflow.
     *
     * @param id         The id of a project. (required)
    ...
    default ResponseEntity<WorkflowModel> duplicateWorkflow(
        @Parameter(
            ...
            in = ParameterIn.PATH) @PathVariable("id") Long id,
        @Parameter(
            name = "workflowId", description = "The id of a workflow.", required = true,
            in = ParameterIn.PATH) @PathVariable("workflowId") String workflowId) {
    ...
    /**
     * GET /projects/{id}/workflows : Get workflows for particular project. Get workflows for particular project.
     *
     * @param id The id of a project. (required)
    ...
    /**
     * GET /workflows : Get workflow definitions Get workflow definitions.
     *
