...
public interface ProjectInstanceApi {
    ...
    /**
     * POST /project-instances : Create a new project instance Create a new project instance.
     *
    ...
    default ResponseEntity<ProjectInstanceModel> createProjectInstance(
        @Parameter(
            name = "ProjectInstanceModel", description = "",
            required = true) @Valid @RequestBody ProjectInstanceModel projectInstanceModel) {
    ...
    /**
     * POST /project-instances/{id}/workflows/{workflowId}/jobs : Create a request for running a new job Create a
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "The id of a created job.", content = {
                @Content(
                    ...
                    schema = @Schema(implementation = CreateProjectInstanceWorkflowJob200ResponseModel.class))
            })
        })
    @RequestMapping(
        method = RequestMethod.POST,
    ...
    default ResponseEntity<CreateProjectInstanceWorkflowJob200ResponseModel> createProjectInstanceWorkflowJob(
        ...
        @Parameter(
            name = "workflowId", description = "The id of the workflow to execute.", required = true,
    ...
    /**
     * DELETE /project-instances/{id} : Delete a project instance Delete a project instance.
     *
     * @param id The id of a project instance. (required)
    ...
    /**
     * POST /project-instances/{id}/enable/{enable} : Enable/disable a project instance Enable/disable a project
     * instance.
     *
     * @param id     The id of a project instance. (required)
    ...
    default ResponseEntity<Void> enableProjectInstance(
        @Parameter(
            ...
            in = ParameterIn.PATH) @PathVariable("id") Long id,
        @Parameter(
            name = "enable", description = "Enable/disable the project instance.", required = true,
            in = ParameterIn.PATH) @PathVariable("enable") Boolean enable) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);

    }

    /**
     * POST /project-instances/{id}/workflows/{workflowId}/enable/{enable} : Enable/disable a workflow of a project
     * instance Enable/disable a workflow of a project instance.
     *
     * @param id         The id of a project instance. (required)
    ...
    default ResponseEntity<Void> enableProjectInstanceWorkflow(
        @Parameter(
            ...
            in = ParameterIn.PATH) @PathVariable("id") Long id,
        @Parameter(
            name = "workflowId", description = "The id of a project workflow.", required = true,
            in = ParameterIn.PATH) @PathVariable("workflowId") String workflowId,
        @Parameter(
            name = "enable", description = "Enable/disable the workflow of a project instance.", required = true,
            in = ParameterIn.PATH) @PathVariable("enable") Boolean enable) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    /**
     * GET /project-instances/{id} : Get a project instance by id Get a project instance by id.
     *
     * @param id The id of a project instance. (required)
    ...
    /**
     * GET /project-instances : Get project instances Get project instances.
     *
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "A list of project instances.", content = {
                @Content(
                    mediaType = "application/json",
                    array = @ArraySchema(schema = @Schema(implementation = ProjectInstanceModel.class)))
            })
        })
    @RequestMapping(
        method = RequestMethod.GET,
    ...
    default ResponseEntity<List<ProjectInstanceModel>> getProjectInstances(
        @Parameter(
            name = "projectId", description = "The project ids used for filtering project instances.",
            in = ParameterIn.QUERY) @Valid @RequestParam(value = "projectId", required = false) Long projectId,
        @Parameter(
            name = "tagId", description = "The tag id of used for filtering project instances.",
    ...
    /**
     * PUT /project-instances/{id} : Update an existing project instance Update an existing project instance.
     *
     * @param id                   The id of a project instance. (required)
     * @param projectInstanceModel (required)
    ...
    /**
     * PUT /project-instances/{id}/project-instance-workflows/{projectInstanceWorkflowId} : Update an existing project
     * instance workflow Update an existing project instance workflow.
     *
     * @param id                           The id of a project instance. (required)
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(
                responseCode = "200", description = "The updated project instance workflow object.", content = {
                    @Content(
                        mediaType = "application/json",
                        schema = @Schema(implementation = ProjectInstanceWorkflowModel.class))
                })
        })
    @RequestMapping(
        method = RequestMethod.PUT,
    ...
    default ResponseEntity<ProjectInstanceWorkflowModel> updateProjectInstanceWorkflow(
        @Parameter(
            ...
            in = ParameterIn.PATH) @PathVariable("id") Long id,
        @Parameter(
            name = "projectInstanceWorkflowId", description = "The id of a project instance workflow.", required = true,
            in = ParameterIn.PATH) @PathVariable("projectInstanceWorkflowId") Long projectInstanceWorkflowId,
        @Parameter(
            name = "ProjectInstanceWorkflowModel", description = "",
            required = true) @Valid @RequestBody ProjectInstanceWorkflowModel projectInstanceWorkflowModel) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType : MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString =
                        "{ \"projectInstanceId\" : 5, \"__version\" : 2, \"inputs\" : { \"key\" : \"{}\" }, \"id\" : 5, \"lastExecutionDate\" : \"2000-01-23T04:56:07.000+00:00\", \"connections\" : [ { \"connectionId\" : 1, \"operationName\" : \"operationName\", \"key\" : \"key\" }, { \"connectionId\" : 1, \"operationName\" : \"operationName\", \"key\" : \"key\" } ], \"enabled\" : true, \"workflowId\" : \"workflowId\" }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
