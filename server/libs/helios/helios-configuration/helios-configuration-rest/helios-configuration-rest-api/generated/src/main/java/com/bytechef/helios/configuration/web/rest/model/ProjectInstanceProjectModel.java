...
public class ProjectInstanceProjectModel {
    ...
    public ProjectInstanceProjectModel status(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(createdBy, createdDate, description, id, lastModifiedBy, lastModifiedDate, name,
            publishedDate, projectVersion, status);
    }
