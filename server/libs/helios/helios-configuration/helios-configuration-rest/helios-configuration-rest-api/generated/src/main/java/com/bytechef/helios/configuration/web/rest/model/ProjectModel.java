...
public class ProjectModel {
    ...
    @Schema(
        name = "description", description = "The description of a project.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(
        name = "id", accessMode = Schema.AccessMode.READ_ONLY, description = "The id of a project.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("id")
    public Long getId() {
        return id;
    ...
    @Schema(
        name = "projectVersion", description = "The version of a project.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(
        name = "workflowIds", description = "The workflow ids belonging to this project.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(category, createdBy, createdDate, description, id, lastModifiedBy, lastModifiedDate, name,
            publishedDate, projectVersion, status, tags, workflowIds, version);
    }
    ...
    public String toString() {
        ...
        sb.append("    projectVersion: ")
            .append(toIndentedString(projectVersion))
            .append("\n");
        sb.append("    status: ")
