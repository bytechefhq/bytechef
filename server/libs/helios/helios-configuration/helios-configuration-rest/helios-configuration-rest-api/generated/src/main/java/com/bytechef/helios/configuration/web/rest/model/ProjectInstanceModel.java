...
@Schema(
    ...
    description = "Contains configurations and connections required for the execution of project workflows.")
...
public class ProjectInstanceModel {
    ...
    @Schema(
        name = "description", description = "The description of a project instance.",
    ...
    @Valid
    @Schema(
        name = "lastExecutionDate", accessMode = Schema.AccessMode.READ_ONLY, description = "The last execution date.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    public ProjectInstanceModel
        projectInstanceWorkflows(List<@Valid ProjectInstanceWorkflowModel> projectInstanceWorkflows) {
        this.projectInstanceWorkflows = projectInstanceWorkflows;
        return this;
    }

    public ProjectInstanceModel
        addProjectInstanceWorkflowsItem(ProjectInstanceWorkflowModel projectInstanceWorkflowsItem) {
    ...
    @Schema(
        name = "enabled", description = "If a workflow is enabled or not in the project instance.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(description, createdBy, createdDate, id, lastExecutionDate, lastModifiedBy,
            lastModifiedDate, name, project, projectId, projectInstanceWorkflows, enabled, tags, version);
    }
    ...
    public String toString() {
        ...
        sb.append("    projectId: ")
            ...
            .append("\n");
        sb.append("    projectInstanceWorkflows: ")
            .append(toIndentedString(projectInstanceWorkflows))
            .append("\n");
        sb.append("    enabled: ")
