...
public class WorkflowTaskModel {
    ...
    /**
     * The (optional) list of tasks that are to be executed after execution of a task -- regardless of whether it had
     * failed or not.
     * 
     * @return finalize
     */
    ...
    @Schema(
        name = "finalize",
        description = "The (optional) list of tasks that are to be executed after execution of a task -- regardless of whether it had failed or not.",
    ...
    @Schema(
        name = "label", description = "The human-readable description of the task.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("label")
    ...
    /**
     * The identifier name of the task. Task names are used for assigning the output of one task so it can be later used
     * by subsequent tasks.
     * 
     * @return name
     */
    ...
    @Schema(
        name = "parameters", description = "Key-value map of task parameters.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(
        name = "post",
        description = "The (optional) list of tasks that are to be executed after the successful execution of a task.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("post")
    ...
    @Valid
    @Schema(
        name = "pre", description = "The (optional) list of tasks that are to be executed prior to a task.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("pre")
    ...
    @Schema(
        name = "timeout",
        description = "The timeout expression which describes when a task should be deemed as timed-out.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    public String toString() {
        ...
        sb.append("    connections: ")
            ...
            .append("\n");
        sb.append("    finalize: ")
            .append(toIndentedString(finalize))
            .append("\n");
        sb.append("    label: ")
        ...
        sb.append("    parameters: ")
            ...
            .append("\n");
        sb.append("    post: ")
            .append(toIndentedString(post))
            .append("\n");
        sb.append("    pre: ")
            .append(toIndentedString(pre))
            .append("\n");
        sb.append("    timeout: ")
