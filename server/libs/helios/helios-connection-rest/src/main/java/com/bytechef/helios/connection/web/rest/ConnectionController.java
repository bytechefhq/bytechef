...
import com.bytechef.helios.connection.web.rest.model.OAuth2AuthorizationParametersModel;
...
public class ConnectionController implements ConnectionsApi {
    ...
    public Mono<ResponseEntity<OAuth2AuthorizationParametersModel>> getConnectionOAuth2AuthorizationParameters(
        ...
        return connectionModelMono
            ...
            .map(
                connection -> connectionDefinitionService.getOAuth2Parameters(
            ...
            .map(
                oAuth2AuthorizationParametersDTO -> conversionService.convert(
