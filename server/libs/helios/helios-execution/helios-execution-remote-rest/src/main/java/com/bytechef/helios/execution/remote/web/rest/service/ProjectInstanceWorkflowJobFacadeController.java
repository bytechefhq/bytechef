...
package com.bytechef.helios.execution.remote.web.rest.service;
...
public class ProjectInstanceWorkflowJobFacadeController {

    private final ProjectInstanceWorkflowJobFacade projectInstanceWorkflowJobFacade;

    public ProjectInstanceWorkflowJobFacadeController(
    ...
    @RequestMapping(
        ...
        value = "/project-instance-workflow-job-facade/create-job/{instanceId}/{workflowId}",
        produces = {
            "application/json"
        })
    public ResponseEntity<Long> createJob(
        ...
        return ResponseEntity.ok(projectInstanceWorkflowJobFacade.createJob(instanceId, workflowId));
    }
}
