...
@Schema(
    name = "WorkflowExecutionBasic", description = "Contains basic information about execution of a project workflow.")
...
public class WorkflowExecutionBasicModel {
    ...
    public WorkflowExecutionBasicModel
        instance(com.bytechef.helios.configuration.web.rest.model.ProjectInstanceBasicModel instance) {
    ...
    public WorkflowExecutionBasicModel
        project(com.bytechef.helios.configuration.web.rest.model.ProjectBasicModel project) {
