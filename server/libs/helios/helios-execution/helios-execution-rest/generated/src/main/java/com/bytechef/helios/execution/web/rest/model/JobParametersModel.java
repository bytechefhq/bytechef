...
public class JobParametersModel {
    ...
    @Schema(
        name = "label", description = "The job's human-readable name", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("label")
    ...
    @Schema(
        name = "priority", description = "The priority value used during execution of individual tasks.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
