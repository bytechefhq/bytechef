...
@Validated
@Tag(name = "project-instance-workflow-jobs", description = "the project-instance-workflow-jobs API")
public interface ProjectInstanceWorkflowJobsApi {
    ...
    @Operation(
        ...
        tags = { "project-instance-workflow-jobs" },
        responses = {
