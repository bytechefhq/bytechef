...
public class TaskExecutionModel {
    ...
    @Valid
    @Schema(
        name = "endDate", accessMode = Schema.AccessMode.READ_ONLY,
    ...
    /**
     * The total time in ms for a task to execute (excluding wait time of the task in transit). i.e. actual execution
     * time on a worker node.
     * 
     * @return executionTime
     */

    @Schema(
        name = "executionTime", accessMode = Schema.AccessMode.READ_ONLY,
        description = "The total time in ms for a task to execute (excluding wait time of the task in transit). i.e. actual execution time on a worker node.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(
        name = "id", accessMode = Schema.AccessMode.READ_ONLY, description = "The id of a task execution.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("id")
    public String getId() {
        return id;
    ...
    @Schema(
        name = "input", accessMode = Schema.AccessMode.READ_ONLY, description = "The input parameters for a task.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("input")
    ...
    @Schema(
        name = "jobId", accessMode = Schema.AccessMode.READ_ONLY,
        description = "The id of a job for which a task belongs to.", requiredMode = Schema.RequiredMode.REQUIRED)
    @JsonProperty("jobId")
    ...
    @Schema(
        name = "output", accessMode = Schema.AccessMode.READ_ONLY,
        description = "The result output generated by the task handler which executed a task.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("output")
    ...
    @Schema(
        name = "parentId", accessMode = Schema.AccessMode.READ_ONLY,
    ...
    @Schema(
        name = "priority", accessMode = Schema.AccessMode.READ_ONLY, description = "The priority value.",
    ...
    @Schema(
        name = "progress", accessMode = Schema.AccessMode.READ_ONLY,
    ...
    @Schema(
        name = "maxRetries", accessMode = Schema.AccessMode.READ_ONLY,
    ...
    @Schema(
        name = "retryAttempts", accessMode = Schema.AccessMode.READ_ONLY,
    ...
    /**
     * The delay to introduce between each retry. Values are to be specified using the ISO-8601 format (excluding the PT
     * prefix). e.g. 10s (ten seconds), 1m (one minute) etc.
     * 
     * @return retryDelay
     */

    @Schema(
        name = "retryDelay", accessMode = Schema.AccessMode.READ_ONLY,
    ...
    /**
     * The factor to use in order to calculate the actual delay time between each successive retry -- multiplying by the
     * value of the retryDelay.
     * 
     * @return retryDelayFactor
     */

    @Schema(
        name = "retryDelayFactor", accessMode = Schema.AccessMode.READ_ONLY,
    ...
    @Valid
    @Schema(
        name = "startDate", accessMode = Schema.AccessMode.READ_ONLY,
        description = "The time when a task instance was started.", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(
        name = "status", accessMode = Schema.AccessMode.READ_ONLY, description = "The current status of a task.",
        requiredMode = Schema.RequiredMode.REQUIRED)
    @JsonProperty("status")
    ...
    @Schema(
        name = "taskNumber", accessMode = Schema.AccessMode.READ_ONLY,
        description = "The numeric order of the task in the workflow.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(
        name = "retryDelayMillis", accessMode = Schema.AccessMode.READ_ONLY,
    ...
    public TaskExecutionModel
        workflowTask(com.bytechef.helios.configuration.web.rest.model.WorkflowTaskModel workflowTask) {
    ...
    @Schema(
        name = "type", accessMode = Schema.AccessMode.READ_ONLY, description = "The type of the task.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("type")
    ...
    @Override
    public int hashCode() {
        return Objects.hash(componentDefinition, createdBy, createdDate, endDate, error, executionTime, id, input,
            jobId, lastModifiedBy, lastModifiedDate, output, parentId, priority, progress, maxRetries, retryAttempts,
            retryDelay, retryDelayFactor, startDate, status, taskNumber, retryDelayMillis, workflowTask, type);
    }
    ...
    public String toString() {
        ...
        sb.append("    componentDefinition: ")
            .append(toIndentedString(componentDefinition))
            .append("\n");
        sb.append("    createdBy: ")
        ...
        sb.append("    executionTime: ")
            .append(toIndentedString(executionTime))
            .append("\n");
        sb.append("    id: ")
            .append(toIndentedString(id))
            .append("\n");
        sb.append("    input: ")
            .append(toIndentedString(input))
            .append("\n");
        sb.append("    jobId: ")
        ...
        sb.append("    lastModifiedDate: ")
            ...
            .append("\n");
        sb.append("    output: ")
            .append(toIndentedString(output))
            .append("\n");
        sb.append("    parentId: ")
        ...
        sb.append("    maxRetries: ")
            .append(toIndentedString(maxRetries))
            .append("\n");
        sb.append("    retryAttempts: ")
            .append(toIndentedString(retryAttempts))
            .append("\n");
        sb.append("    retryDelay: ")
            .append(toIndentedString(retryDelay))
            .append("\n");
        sb.append("    retryDelayFactor: ")
            .append(toIndentedString(retryDelayFactor))
            .append("\n");
        sb.append("    startDate: ")
        ...
        sb.append("    taskNumber: ")
            .append(toIndentedString(taskNumber))
            .append("\n");
        sb.append("    retryDelayMillis: ")
            .append(toIndentedString(retryDelayMillis))
            .append("\n");
        sb.append("    workflowTask: ")
            .append(toIndentedString(workflowTask))
            .append("\n");
        sb.append("    type: ")
