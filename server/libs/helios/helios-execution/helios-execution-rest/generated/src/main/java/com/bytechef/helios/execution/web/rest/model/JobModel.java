...
public class JobModel {
    ...
    @Schema(
        name = "currentTask", accessMode = Schema.AccessMode.READ_ONLY,
    ...
    @Valid
    @Schema(
        name = "endDate", description = "The time execution entered end status COMPLETED, STOPPED, FAILED",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(
        name = "id", accessMode = Schema.AccessMode.READ_ONLY, description = "The id of a job.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("id")
    public String getId() {
        return id;
    ...
    @Schema(
        name = "inputs", accessMode = Schema.AccessMode.READ_ONLY,
    ...
    @Schema(
        name = "label", accessMode = Schema.AccessMode.READ_ONLY, description = "The job's human-readable name.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("label")
    ...
    @Schema(
        name = "outputs", accessMode = Schema.AccessMode.READ_ONLY,
        description = "The key-value map of the outputs returned.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(
        name = "parentTaskExecutionId", accessMode = Schema.AccessMode.READ_ONLY,
    ...
    @Valid
    @Schema(
        name = "startDate", accessMode = Schema.AccessMode.READ_ONLY, description = "The time of when the job began.",
        requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(
        name = "status", accessMode = Schema.AccessMode.READ_ONLY, description = "The job's status.",
        requiredMode = Schema.RequiredMode.REQUIRED)
    @JsonProperty("status")
    ...
    @Valid
    @Schema(
        name = "webhooks", accessMode = Schema.AccessMode.READ_ONLY,
        description = "The list of the webhooks configured.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(
        name = "workflowId", accessMode = Schema.AccessMode.READ_ONLY, requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(createdBy, createdDate, currentTask, endDate, error, id, inputs, label, lastModifiedBy,
            lastModifiedDate, outputs, parentTaskExecutionId, priority, startDate, status, webhooks, workflowId,
            taskExecutions);
    }
    ...
    public String toString() {
        ...
        sb.append("    currentTask: ")
            .append(toIndentedString(currentTask))
            .append("\n");
        sb.append("    endDate: ")
        ...
        sb.append("    lastModifiedDate: ")
            ...
            .append("\n");
        sb.append("    outputs: ")
            .append(toIndentedString(outputs))
            .append("\n");
        sb.append("    parentTaskExecutionId: ")
            .append(toIndentedString(parentTaskExecutionId))
            .append("\n");
        sb.append("    priority: ")
        ...
        sb.append("    workflowId: ")
            ...
            .append("\n");
        sb.append("    taskExecutions: ")
            .append(toIndentedString(taskExecutions))
            .append("\n");
        sb.append("}");
        return sb.toString();
    }
