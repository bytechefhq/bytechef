...
public interface ConnectionApi {
    ...
    /**
     * POST /connections : Create a new connection Create a new connection.
     *
    ...
    /**
     * DELETE /connections/{id} : Delete a connection Delete a connection.
     *
    ...
    default ResponseEntity<Void> deleteConnection(
        @Parameter(
            name = "id", description = "The id of a connection.", required = true,
    ...
    /**
     * GET /connections/{id} : Get a connection by id Get a connection by id.
     *
     * @param id The id of a connection. (required)
     * @return The connection object. (status code 200)
     */
    ...
    /**
     * GET /connections : Get all connections Get all connections.
     *
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "A list of connections.", content = {
                @Content(
                    ...
                    array = @ArraySchema(schema = @Schema(implementation = ConnectionModel.class)))
            })
        })
    @RequestMapping(
        method = RequestMethod.GET,
    ...
    default ResponseEntity<List<ConnectionModel>> getConnections(
        @Parameter(
            name = "componentName", description = "The component name used for filtering connections.",
            in = ParameterIn.QUERY) @Valid @RequestParam(
                value = "componentName", required = false) String componentName,
        @Parameter(
            name = "connectionVersion", description = "The connection version.",
            in = ParameterIn.QUERY) @Valid @RequestParam(
                value = "connectionVersion", required = false) Integer connectionVersion,
        @Parameter(
            name = "tagId", description = "The tag id of used for filtering connections.",
    ...
    /**
     * PUT /connections/{id} : Update an existing connection Update an existing connection.
     *
     * @param id              The id of a connection. (required)
     * @param connectionModel (required)
