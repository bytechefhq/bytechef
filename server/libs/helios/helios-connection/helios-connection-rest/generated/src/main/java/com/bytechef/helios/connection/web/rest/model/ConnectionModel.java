...
public class ConnectionModel {
    ...
    @Schema(
        name = "active", accessMode = Schema.AccessMode.READ_ONLY,
    ...
    @Schema(
        ...
        description = "The name of an authorization used by this connection. Used for HTTP based services.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @NotNull
    @Schema(
        name = "componentName", description = "The name of a component that uses this connection.",
    ...
    @Schema(
        name = "connectionVersion", description = "The version of a component that uses this connection.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(
        name = "id", accessMode = Schema.AccessMode.READ_ONLY, description = "The id of a connection.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("id")
    public Long getId() {
        return id;
    ...
    @NotNull
    @Schema(
        name = "parameters", description = "The parameters of a connection.",
        requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(active, authorizationName, componentName, connectionVersion, createdBy, createdDate, name,
            id, lastModifiedBy, lastModifiedDate, parameters, tags, version);
    }
    ...
    public String toString() {
        ...
        sb.append("    active: ")
            ...
            .append("\n");
        sb.append("    authorizationName: ")
            .append(toIndentedString(authorizationName))
            .append("\n");
        sb.append("    componentName: ")
            .append(toIndentedString(componentName))
            .append("\n");
        sb.append("    connectionVersion: ")
            .append(toIndentedString(connectionVersion))
            .append("\n");
        sb.append("    createdBy: ")
