...
public interface ProjectExecutionsApi {
     ...
     * @param jobStartTime The start time of a job. (optional)
     * @param jobEndTime The end time of a job. (optional)
     * @param projectId The id of aproject. (optional)
    ...
    default Mono<ResponseEntity<org.springframework.data.domain.Page>> getProjectExecutions(
        ...
        @Parameter(name = "jobStartTime", description = "The start time of a job.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "jobStartTime", required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime jobStartTime,
