...
public interface ProjectExecutionMapper extends Converter<ProjectFacade.ProjectExecution, ProjectExecutionModel> {

    @Override
    ProjectExecutionModel convert(ProjectFacade.ProjectExecution projectExecution);
}
