 ...
 * @author Ivica Cardic
 */
@Table("project_instance_tag")
public final class ProjectInstanceTag implements Persistable<Long> {
    ...
    public ProjectInstanceTag(Tag tag) {
    ...
    public boolean equals(Object o) {
        ...
        ProjectInstanceTag that = (ProjectInstanceTag) o;
