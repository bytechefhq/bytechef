...
package com.bytechef.automation.data.table.execution.web.graphql.config;
 ...
 */
@Configuration
public class DataTableRowGraphQlTestConfiguration {

    @Bean
    @Primary
    public DataTableRowService dataTableRowService() {
        return Mockito.mock(DataTableRowService.class);
    }
