...
package com.bytechef.automation.data.table.execution.config;
...
@ComponentScan(
    basePackages = {
        "com.bytechef.automation.data.table.execution.web.listener"
    })
@Configuration
@EnableAsync
...
public class DataTableWebhookEventListenerIntTestConfiguration {
