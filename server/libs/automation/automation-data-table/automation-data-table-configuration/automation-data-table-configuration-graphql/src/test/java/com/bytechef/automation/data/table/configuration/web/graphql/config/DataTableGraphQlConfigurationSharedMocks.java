...
@MockitoBean(types = {
    DataTableService.class, DataTableTagService.class, DataTableWebhookService.class, EnvironmentService.class
})
public @interface DataTableGraphQlConfigurationSharedMocks {
}
