...
/**
 * Evaluates the real {@code @PreAuthorize} expressions on {@link WorkspaceKnowledgeBaseFacadeImpl} through the real
...
class WorkspaceKnowledgeBaseFacadeAuthorizationTest {
    ...
    private static Stream<GuardCase> guardCaseStream() {
        ...
        return Stream.of(
            ...
            new GuardCase(
                "createWorkspaceKnowledgeBase", workspaceArguments,
                permissionService -> permissionService.hasWorkspaceScope(
