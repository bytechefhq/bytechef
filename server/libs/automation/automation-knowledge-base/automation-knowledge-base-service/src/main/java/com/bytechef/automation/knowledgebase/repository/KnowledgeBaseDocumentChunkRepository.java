...
@Repository
public interface KnowledgeBaseDocumentChunkRepository extends
    PagingAndSortingRepository<KnowledgeBaseDocumentChunk, Long>, ListCrudRepository<KnowledgeBaseDocumentChunk, Long> {
