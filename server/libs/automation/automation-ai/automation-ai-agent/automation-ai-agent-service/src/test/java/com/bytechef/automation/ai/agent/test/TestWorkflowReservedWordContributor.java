 ...
 * validator accepts {@code triggers} / {@code clusterElements} / etc. (both emitted by
 * {@link com.bytechef.automation.ai.agent.util.AiAgentWorkflowGenerator}) without dragging the full
 * platform-configuration-service module into the automation-ai-agent test classpath. Same precedent as
 * automation-knowledge-base-service's own {@code TestWorkflowReservedWordContributor}.
 *
 * <p>
