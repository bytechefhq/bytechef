...
class McpProjectOwnershipResolverTest {
    ...
    private final McpProjectOwnershipResolver resolver =
        new McpProjectOwnershipResolver(mcpProjectRepository, workspaceMcpServerService);
    ...
    void testResolvesWorkspaceViaServer() {
        ...
        when(mcpProjectRepository.findById(1L)).thenReturn(Optional.of(mcpProject));
    ...
    @Test
    void testUnknownProjectIsUnknown() {
        when(mcpProjectRepository.findById(99L)).thenReturn(Optional.empty());
