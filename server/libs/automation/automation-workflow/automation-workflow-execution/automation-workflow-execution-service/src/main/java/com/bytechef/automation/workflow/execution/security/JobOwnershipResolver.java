...
public class JobOwnershipResolver implements ResourceOwnershipResolver {
    ...
    /**
     * Kept as its own method rather than inlined: any other reader of "which project owns this job" must agree with
     * this one on which jobs are reachable, so there is one place to change when that answer moves.
     */
