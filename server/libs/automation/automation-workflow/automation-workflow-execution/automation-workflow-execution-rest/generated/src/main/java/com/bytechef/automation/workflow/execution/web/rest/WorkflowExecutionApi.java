...
public interface WorkflowExecutionApi {
    ...
    default ResponseEntity<org.springframework.data.domain.Page> getWorkflowExecutionsPage(
        ...
        @Parameter(name = "environment", description = "The environment.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "environment", required = false) @Nullable com.bytechef.automation.configuration.web.rest.model.EnvironmentModel environment,
