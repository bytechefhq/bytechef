...
public class ConnectionApiControllerIntTest {
    ...
    public void testGetConnectionTags() {
        when(connectionFacade.getConnectionTags(Type.AUTOMATION))
    ...
    public void testGetConnections() {
        ...
        when(connectionFacade.getConnections((String) null, null, Type.AUTOMATION))
        ...
        when(connectionFacade.getConnections("component1", null, Type.AUTOMATION))
            .thenReturn(List.of(connectionDTO));
        ...
        when(connectionFacade.getConnections(null, 1, Type.AUTOMATION))
            .thenReturn(List.of(connectionDTO));
        ...
        when(connectionFacade.getConnections("component1", 1, Type.AUTOMATION))
            .thenReturn(List.of(connectionDTO));
    ...
    public void testPostConnection() {
        ...
        when(connectionFacade.create(any(), Type.AUTOMATION))
        ...
        verify(connectionFacade).create(connectionArgumentCaptor.capture(), Type.AUTOMATION);
