...
package com.bytechef.automation.assetfile.file.storage.config;
 ...
 */
@Configuration
public class AssetFileFileStorageConfiguration {

    @Bean
    AssetFileFileStorage assetFileFileStorage(
        ...
        return new AssetFileFileStorageImpl(fileStorageServiceRegistry.getFileStorageService(provider.name()));
    }
}
