 ...
 * @author Ivica Cardic
 */
public class AssetFileFileStorageImpl implements AssetFileFileStorage {

    static final String DIRECTORY = "asset_files";

    private final FileStorageService fileStorageService;

    @SuppressFBWarnings("EI")
    public AssetFileFileStorageImpl(FileStorageService fileStorageService) {
