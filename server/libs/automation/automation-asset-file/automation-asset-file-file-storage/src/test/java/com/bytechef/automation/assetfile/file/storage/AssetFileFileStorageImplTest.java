...
class AssetFileFileStorageImplTest {
    ...
    @BeforeEach
    void setUp() {
        fileStorage = new AssetFileFileStorageImpl(fileStorageService);
    }
    ...
    void testStoreFileString() {
        ...
        when(fileStorageService.storeFileContent("asset_files", "spec.md", "hello", true))
            .thenReturn(expected);
    ...
    void testStoreFileStream() {
        ...
        when(
            fileStorageService.storeFileContent(eq("asset_files"), eq("spec.md"), any(InputStream.class), eq(true)))
                .thenReturn(expected);
