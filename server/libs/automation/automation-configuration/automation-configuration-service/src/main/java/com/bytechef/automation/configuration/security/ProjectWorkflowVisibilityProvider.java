...
/**
 * A project-workflow row has no visibility of its own: it is exactly as visible as the project that owns it, so the
 * record returned here is the PROJECT's and its grants are looked up under {@code "Project"}.
 *
 * @author Ivica Cardic
 */
@Component
