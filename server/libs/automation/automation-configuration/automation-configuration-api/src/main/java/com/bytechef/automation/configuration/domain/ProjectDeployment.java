...
public class ProjectDeployment {
    ...
    public boolean equals(Object o) {
        ...
        ProjectDeployment project = (ProjectDeployment) o;
    ...
    public List<Long> getTagIds() {
        return projectDeploymentTags
            .stream()
            .map(ProjectDeploymentTag::getTagId)
            .toList();
    }
    ...
    public void setTagIds(List<Long> tagIds) {
        this.projectDeploymentTags = new HashSet<>();

        if (!CollectionUtils.isEmpty(tagIds)) {
            for (Long tagId : tagIds) {
                projectDeploymentTags.add(new ProjectDeploymentTag(tagId));
            }
        }
    }
