...
@MockitoBean(types = {
    AiWorkflowGeneratorFacade.class, ComponentDefinitionService.class, ConnectionFacade.class, JobService.class,
    ProjectWorkflowService.class, WebhookTriggerTestApiFacade.class, WebhookTriggerTestFacade.class,
