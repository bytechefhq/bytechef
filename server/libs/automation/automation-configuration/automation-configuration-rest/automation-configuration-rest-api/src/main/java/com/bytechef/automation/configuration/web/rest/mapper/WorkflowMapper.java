...
public abstract class WorkflowMapper {
    ...
    @Mapper(config = AutomationConfigurationMapperSpringConfig.class, implementationName = "Automation<CLASS_NAME>Impl")
    ...
    @Mapper(config = AutomationConfigurationMapperSpringConfig.class, implementationName = "Automation<CLASS_NAME>Impl")
    public abstract static class WorkflowModelToWorkflowBasicModel
