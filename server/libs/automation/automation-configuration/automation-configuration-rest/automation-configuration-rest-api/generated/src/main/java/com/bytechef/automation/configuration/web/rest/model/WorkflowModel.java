...
public class WorkflowModel {
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdBy, createdDate, definition, description, format, id, inputs, label, lastModifiedBy, lastModifiedDate, outputs, sourceType, maxRetries, tasks, triggers, version, projectWorkflowId);
  }
