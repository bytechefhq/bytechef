...
public interface WorkflowApi {
    ...
    default ResponseEntity<com.bytechef.platform.configuration.web.rest.model.WorkflowModel> duplicateWorkflow(
        @Parameter(name = "id", description = "The id of a project.", required = true, in = ParameterIn.PATH) @PathVariable("id") Long id,
    ...
    default ResponseEntity<List<com.bytechef.platform.configuration.web.rest.model.WorkflowModel>> getProjectWorkflows(
        @Parameter(name = "id", description = "The id of a project.", required = true, in = ParameterIn.PATH) @PathVariable("id") Long id
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    default ResponseEntity<List<com.bytechef.platform.configuration.web.rest.model.WorkflowModel>> getWorkflows(
