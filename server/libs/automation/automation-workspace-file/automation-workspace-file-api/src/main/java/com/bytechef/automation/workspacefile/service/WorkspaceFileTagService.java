 ...
 * @author Ivica Cardic
 */
public interface WorkspaceFileTagService {
     ...
     *
     * @param workspaceFileId the unique identifier of the workspace file whose tags are to be updated
     * @param tags            a list of Tag objects representing the new set of tags to associate with the workspace
     *                        file
     */
    void updateTags(long workspaceFileId, List<Tag> tags);
}
