 ...
 * @author Ivica Cardic
 */
@Table("workspace_file_tag")
public final class WorkspaceFileTag {

    @Column("tag_id")
    private AggregateReference<Tag, Long> tagId;

    public WorkspaceFileTag() {
    }

    public WorkspaceFileTag(Long tagId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WorkspaceFileTag that)) {
            return false;
        }
