 ...
 */
@Controller
public class CounterRSocketController {

    private final CounterService counterService;

    @SuppressFBWarnings("EI2")
    public CounterRSocketController(CounterService counterService) {
        this.counterService = counterService;
    }

    @MessageMapping("deleteCounter")
    public Mono<Void> deleteCounter(String id) {
    ...
    public Mono<Long> decrementCounter(String id) {
    ...
    public Mono<Void> setCounter(Map<String, Object> map) {
        counterService.set((String) map.get("id"), (Long) map.get("value"));
