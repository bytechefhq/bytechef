...
public class TaskExecutionModel {
  ...
  */
  @Valid 
  @Schema(name = "endTime", description = "The time when this task instance ended (CANCELLED, FAILED, COMPLETED).", required = false)
  ...
  */
  ...
  @Schema(name = "executionTime", description = "The total time in ms for this task to execute (excluding wait time of the task in transit). i.e. actual execution time on a worker node.", required = false)
  ...
  */
  ...
  @Schema(name = "output", description = "The result output generated by the task handler which executed this task.", required = false)
  ...
  */
  ...
  @Schema(name = "parentId", description = "The id of the parent task, if this is a sub-task.", required = false)
  ...
  */
  ...
  @Schema(name = "progress", description = "The current progress value, a number between 0 and 100.", required = false)
  ...
  */
  ...
  @Schema(name = "retry", description = "The maximum number of times that this task may retry.", required = false)
  ...
  */
  ...
  @Schema(name = "retryAttempts", description = "The number of times that this task has been retried.", required = false)
  ...
  */
  ...
  @Schema(name = "retryDelay", description = "The delay to introduce between each retry. Values are to be specified using the ISO-8601 format (excluding the PT prefix). e.g. 10s (ten seconds), 1m (one minute) etc.", required = false)
  ...
  */
  ...
  @Schema(name = "retryDelayFactor", description = "The factor to use in order to calculate the actual delay time between each successive retry -- multiplying by the value of the retryDelay.", required = false)
  ...
  */
  ...
  @Schema(name = "taskNumber", description = "The numeric order of the task in the workflow.", required = false)
  ...
  */
  ...
  @Schema(name = "retryDelayMillis", description = "The calculated retry delay. i.e. delay * retryAttempts * retryDelayFactor.", required = false)
