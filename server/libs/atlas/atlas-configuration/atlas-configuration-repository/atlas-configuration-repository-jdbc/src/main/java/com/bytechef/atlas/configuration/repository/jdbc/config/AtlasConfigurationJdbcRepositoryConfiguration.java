...
import com.bytechef.atlas.configuration.repository.jdbc.callback.WorkflowCallback;
...
@Import(WorkflowCallback.class)
class AtlasConfigurationJdbcRepositoryConfiguration {
}
