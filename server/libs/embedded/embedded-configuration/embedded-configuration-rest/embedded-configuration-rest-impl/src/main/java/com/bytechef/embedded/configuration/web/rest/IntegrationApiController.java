...
public class IntegrationApiController implements IntegrationApi {
    ...
    public ResponseEntity<List<IntegrationModel>> getIntegrations(
        Long categoryId, Boolean integrationInstances, Long tagId, IntegrationStatusModel status) {

        return ResponseEntity.ok(
            integrationFacade
                .getIntegrations(
                    categoryId, integrationInstances != null, tagId,
    ...
    public ResponseEntity<Void> publishIntegration(
        ...
        integrationService.publishIntegration(
