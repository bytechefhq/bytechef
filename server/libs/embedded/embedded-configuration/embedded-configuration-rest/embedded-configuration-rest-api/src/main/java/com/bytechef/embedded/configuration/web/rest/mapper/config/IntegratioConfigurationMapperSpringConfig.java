...
@MapperConfig(componentModel = "spring", uses = {
    PlatformConfigurationConversionServiceAdapter.class, IntegrationConfigurationConversionServiceAdapter.class
})
@SpringMapperConfig(
...
public interface IntegratioConfigurationMapperSpringConfig {
}
