...
public interface IntegrationInstanceModelMapper extends Converter<IntegrationInstanceModel, IntegrationInstance> {

    @Override
    IntegrationInstance convert(IntegrationInstanceModel integrationInstanceModel);
}
