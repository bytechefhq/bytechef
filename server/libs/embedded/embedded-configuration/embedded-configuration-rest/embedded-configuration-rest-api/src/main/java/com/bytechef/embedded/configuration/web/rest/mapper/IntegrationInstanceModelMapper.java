...
public interface IntegrationInstanceModelMapper extends Converter<IntegrationInstanceModel, IntegrationInstanceDTO> {

    @Override
    @Mapping(target = "integration", ignore = true)
    IntegrationInstanceDTO convert(IntegrationInstanceModel integrationInstanceModel);
}
