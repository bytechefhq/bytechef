...
public interface IntegrationInstanceWorkflowConnectionModelMapper
    extends Converter<IntegrationInstanceWorkflowConnectionModel, IntegrationInstanceWorkflowConnection> {

    @Override
    IntegrationInstanceWorkflowConnection convert(
        IntegrationInstanceWorkflowConnectionModel projectInstanceWorkflowConnectionModel);
}
