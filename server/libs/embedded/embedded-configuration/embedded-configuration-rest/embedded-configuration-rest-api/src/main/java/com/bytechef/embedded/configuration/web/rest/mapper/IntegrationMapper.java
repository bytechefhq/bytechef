...
public class IntegrationMapper {
    ...
    @Mapper(config = EmbeddedConfigurationMapperSpringConfig.class)
    public interface IntegrationToIntegrationModelMapper extends Converter<Integration, IntegrationModel> {

        @Mapping(target = "category", ignore = true)
        @Mapping(target = "tags", ignore = true)
        @Override
        IntegrationModel convert(Integration project);
    }
    ...
    public interface IntegrationDTOToIntegrationModelMapper extends Converter<IntegrationDTO, IntegrationModel> {
        ...
        @Override
        IntegrationModel convert(IntegrationDTO projectDTO);
    }
}
