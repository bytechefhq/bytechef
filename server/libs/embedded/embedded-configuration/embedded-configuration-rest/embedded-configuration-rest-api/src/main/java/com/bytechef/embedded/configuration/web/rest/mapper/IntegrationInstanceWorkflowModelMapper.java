...
public interface IntegrationInstanceWorkflowModelMapper
    extends Converter<IntegrationInstanceWorkflowModel, IntegrationInstanceWorkflow> {

    @Override
    IntegrationInstanceWorkflow convert(IntegrationInstanceWorkflowModel integrationInstanceWorkflowModel);
}
