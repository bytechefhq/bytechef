...
public class IntegrationInstanceConfigurationModel {
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdBy, createdDate, description, enabled, environment, id, integration, integrationId, integrationInstanceConfigurationWorkflows, integrationVersion, lastExecutionDate, lastModifiedBy, lastModifiedDate, tags, version);
  }
