...
public class IntegrationInstanceBasicModel {
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(connectionId, createdBy, createdDate, id, lastExecutionDate, lastModifiedBy, lastModifiedDate, integrationInstanceConfigurationId, enabled);
  }
