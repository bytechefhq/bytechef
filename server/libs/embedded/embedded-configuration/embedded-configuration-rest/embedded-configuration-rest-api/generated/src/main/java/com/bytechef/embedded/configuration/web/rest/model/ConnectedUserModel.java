...
public class ConnectedUserModel {
  ...
  @Valid
  private List<@Valid ConnectedUserIntegrationInstanceModel> integrationInstances;
   ...
   */
  public ConnectedUserModel(String externalReferenceCode) {
  ...
  */
  ...
  public ConnectedUserModel externalReferenceCode(String externalReferenceCode) {
    this.externalReferenceCode = externalReferenceCode;
    return this;
  }
  ...
  */
  ...
  @Schema(name = "externalReferenceCode", accessMode = Schema.AccessMode.READ_ONLY, description = "The external reference code.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdBy, connectedUser.createdBy) &&
        ...
        Objects.equals(this.externalReferenceCode, connectedUser.externalReferenceCode) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdBy, createdDate, email, enabled, externalReferenceCode, id, integrationInstances, metadata, name, lastModifiedBy, lastModifiedDate, version);
  }
