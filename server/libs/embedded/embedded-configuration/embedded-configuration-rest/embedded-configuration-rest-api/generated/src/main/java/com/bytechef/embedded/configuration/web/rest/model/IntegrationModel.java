...
public class IntegrationModel {
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowMultipleInstances, componentName, componentVersion, createdBy, createdDate, description, id, lastModifiedBy, lastModifiedDate, publishedDate, integrationVersion, status, category, tags, workflowIds, version);
  }
