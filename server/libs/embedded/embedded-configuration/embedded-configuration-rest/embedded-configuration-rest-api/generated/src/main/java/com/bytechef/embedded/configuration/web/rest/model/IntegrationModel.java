...
public class IntegrationModel {
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowMultipleInstances, category, componentName, componentVersion, createdBy, createdDate, description, id, integrationVersion, lastModifiedBy, lastModifiedDate, publishedDate, status, tags, workflowIds, version);
  }
