...
import com.bytechef.embedded.configuration.web.rest.model.DataStreamComponentModel;
...
@Schema(name = "workflow_task", description = "Represents a definition of a workflow task.")
@JsonTypeName("workflow_task")
