...
@Schema(name = "IntegrationInstanceConfigurationWorkflow", description = "Contains configuration and connections required for the execution of a particular project workflow.")
...
public class IntegrationInstanceConfigurationWorkflowModel {
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdBy, createdDate, inputs, connections, enabled, id, lastExecutionDate, lastModifiedBy, lastModifiedDate, integrationInstanceConfigurationId, workflowId, version);
  }
