...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2024-10-11T12:35:07.912715+02:00[Europe/Zagreb]", comments = "Generator version: 7.8.0")
@Validated
...
public interface IntegrationApi {
    ...
    default ResponseEntity<List<com.bytechef.embedded.configuration.public_.web.rest.model.IntegrationModel>> getIntegrations(
        @NotNull @Parameter(name = "connectedUserId", description = "The id of a connected user.", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "connectedUserId", required = true) Long connectedUserId,
