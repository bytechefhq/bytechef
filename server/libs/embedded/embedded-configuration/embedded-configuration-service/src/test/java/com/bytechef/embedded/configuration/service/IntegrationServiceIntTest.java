...
public class IntegrationServiceIntTest {
    ...
    public void testGetIntegrations() {
        ...
        assertThat(integrationService.getIntegrations(null, List.of(), tag.getId(), Status.UNPUBLISHED)).hasSize(1);
        assertThat(integrationService.getIntegrations(null, List.of(), Long.MAX_VALUE, Status.UNPUBLISHED)).hasSize(0);
        assertThat(integrationService.getIntegrations(Long.MAX_VALUE, List.of(), Long.MAX_VALUE, Status.UNPUBLISHED))
            .hasSize(0);
    }
