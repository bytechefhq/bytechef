...
public class IntegrationInstanceConfigurationWorkflowServiceImpl
    ...
    @Override
    public List<IntegrationInstanceConfigurationWorkflow>
        getIntegrationInstanceConfigurationWorkflows(long integrationInstanceConfigurationId) {
    ...
    @Override
    public List<IntegrationInstanceConfigurationWorkflow>
        getIntegrationInstanceConfigurationWorkflows(List<Long> integrationInstanceConfigurationIds) {
