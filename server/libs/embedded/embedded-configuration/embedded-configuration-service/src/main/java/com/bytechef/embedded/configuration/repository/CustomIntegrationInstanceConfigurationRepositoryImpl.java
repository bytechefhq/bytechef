...
public class CustomIntegrationInstanceConfigurationRepositoryImpl
    ...
    public List<IntegrationInstanceConfiguration> findAllIntegrationInstanceConfigurations(
        ...
        String query = "SELECT integration_instance_configuration.* FROM integration_instance_configuration ";
        ...
        query += "ORDER BY integration_instance_configuration.enabled DESC";
