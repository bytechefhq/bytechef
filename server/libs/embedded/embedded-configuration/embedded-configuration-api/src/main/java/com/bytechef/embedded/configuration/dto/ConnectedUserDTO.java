...
public record ConnectedUserDTO(
    ...
    String email, boolean enabled, String externalReferenceCode, Long id,
    ...
    public ConnectedUserDTO(ConnectedUser connectedUser, List<IntegrationInstance> integrationInstances) {
        this(
            ...
            connectedUser.isEnabled(), connectedUser.getExternalReferenceCode(), connectedUser.getId(),
            integrationInstances, connectedUser.getMetadata(), connectedUser.getLastModifiedBy(),
            connectedUser.getLastModifiedDate(), connectedUser.getName(), connectedUser.getVersion());
    }
