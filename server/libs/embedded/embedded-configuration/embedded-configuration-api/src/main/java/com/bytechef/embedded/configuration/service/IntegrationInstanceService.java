...
public interface IntegrationInstanceService {
    ...
    boolean isIntegrationInstanceEnabled(long integrationInstanceId);
    ...
    List<IntegrationInstance> getIntegrationInstances(Long integrationId, Long tagId);

    IntegrationInstance update(long id, List<Long> tagIds);

    IntegrationInstance update(IntegrationInstance integrationInstance);
