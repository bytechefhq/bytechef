 ...
 * @author Ivica Cardic
 */
@Table("integration_instance_tag")
public final class IntegrationInstanceTag implements Persistable<Long> {
    ...
    public IntegrationInstanceTag() {
    }

    public IntegrationInstanceTag(Long tagId) {
    ...
    public boolean equals(Object o) {
        ...
        IntegrationInstanceTag that = (IntegrationInstanceTag) o;
