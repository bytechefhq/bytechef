...
public class IntegrationInstanceConfigurationWorkflowConnection implements Persistable<Long> {
    ...
    @Default
    public IntegrationInstanceConfigurationWorkflowConnection(Long connectionId, String key, String workflowNodeName) {
    ...
    public boolean equals(Object o) {
        ...
        IntegrationInstanceConfigurationWorkflowConnection that =
            (IntegrationInstanceConfigurationWorkflowConnection) o;
