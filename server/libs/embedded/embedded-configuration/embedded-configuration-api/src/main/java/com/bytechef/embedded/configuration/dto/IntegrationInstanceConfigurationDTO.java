...
public record IntegrationInstanceConfigurationDTO(
    ...
    Long integrationId, List<IntegrationInstanceConfigurationWorkflowDTO> integrationInstanceConfigurationWorkflows,
    ...
    public IntegrationInstanceConfigurationDTO(
        ...
        this(
            ...
            integrationInstanceConfiguration.getIntegrationId(), CollectionUtils.sort(integrationInstanceWorkflows),
            tags, integrationInstanceConfiguration.getVersion());
    }
    ...
    public static final class Builder {
        ...
        public IntegrationInstanceConfigurationDTO build() {
            return new IntegrationInstanceConfigurationDTO(
                ...
                lastModifiedDate, integration, integrationId, integrationInstanceConfigurationWorkflows, tags, version);
        }
    }
}
