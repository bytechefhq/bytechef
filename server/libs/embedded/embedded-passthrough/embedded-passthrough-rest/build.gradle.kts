...
val generateOpenAPISpring by tasks.registering(org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    apiPackage.set("com.bytechef.embedded.passthrough.web.rest")
    configOptions.set(
        mapOf(
    ...
    modelPackage.set("com.bytechef.embedded.passthrough.web.rest.model")
...
//    inputSpec.set("$projectDir/openapi.yaml")
//    modelNameSuffix.set("Model")
//    outputDir.set("$rootDir/client/src/middleware/embedded/passthrough")
//    typeMappings.set(
//        mapOf(
//            "DateTime" to "Date"
//        )
