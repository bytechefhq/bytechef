...
import com.bytechef.embedded.workflow.execution.web.rest.mapper.config.IntegrationWorkflowExecutionMapperSpringConfig;
 ...
 * @author Ivica Cardic
 */
public class IntegrationWorkflowExecutionMapper {

    @Mapper(config = IntegrationWorkflowExecutionMapperSpringConfig.class)
    public interface IntegrationWorkflowExecutionDTOToWorkflowExecutionModelMapper
    ...
    @Mapper(config = IntegrationWorkflowExecutionMapperSpringConfig.class)
    public interface IntegrationWorkflowExecutionDTOToWorkflowExecutionBasicModelMapper
