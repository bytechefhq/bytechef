...
public class WorkflowExecutionFacadeImpl implements WorkflowExecutionFacade {
    ...
    public WorkflowExecutionFacadeImpl(
        ...
        IntegrationService integrationService, JobService jobService, TaskExecutionService taskExecutionService,
    ...
    public WorkflowExecution getWorkflowExecution(long id) {
        ...
        Optional<Long> integrationInstanceIdOptional = instanceJobService.fetchJobInstanceId(
        ...
        return new WorkflowExecution(
            ...
            OptionalUtils.map(integrationInstanceIdOptional, integrationInstanceService::getIntegrationInstance),
            jobDTO, workflowService.getWorkflow(jobDTO.workflowId()),
            getTriggerExecutionDTO(
                OptionalUtils.orElse(integrationInstanceIdOptional, null),
    ...
    public Page<WorkflowExecution> getWorkflowExecutions(
        ...
        if (workflowId != null) {
            ...
            workflowIds.addAll(
                CollectionUtils.map(workflowService.getWorkflows(Type.EMBEDDED.ordinal()), Workflow::getId));
        }
