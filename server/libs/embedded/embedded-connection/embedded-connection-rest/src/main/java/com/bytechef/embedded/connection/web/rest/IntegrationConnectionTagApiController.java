...
public class IntegrationConnectionTagApiController implements ConnectionTagApi {

    private final ConnectionFacade connectionFacade;
    private final ConversionService conversionService;

    @SuppressFBWarnings("EI")
    public IntegrationConnectionTagApiController(ConnectionFacade connectionFacade,
