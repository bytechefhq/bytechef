...
class NocoDbCreateRecordsTest {
    ...
    void testPerform() {
        try (MockedStatic<NocoDbUtils> nocoDbUtilsMockedStatic = mockStatic(NocoDbUtils.class)) {
            ...
            Object result = NocoDbCreateRecords.perform(mockedParameters, null, mockedContext);
            ...
            assertEquals(Http.Body.of(records, Http.BodyContentType.JSON), bodyArgumentCaptor.getValue());
        }
    }
}
