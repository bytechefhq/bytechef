...
class XDeletePostActionTest {
    ...
    private final Parameters mockedParameters = MockParametersFactory.create(Map.of(ID, "abc"));
    ...
    void testPerform() throws Exception {
        ...
        assertEquals("/tweets/abc", stringArgumentCaptor.getValue());
    }
}
