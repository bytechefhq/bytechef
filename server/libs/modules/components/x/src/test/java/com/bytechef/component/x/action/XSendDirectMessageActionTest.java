 ...
 */
class XSendDirectMessageActionTest {
    ...
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(USERNAME, "test", TEXT, "some text"));
    ...
    void testPerformWithTextOnly() throws Exception {
        try (MockedStatic<XUtils> xUtilsMockedStatic = mockStatic(XUtils.class)) {
            ...
            assertEquals(List.of("test", "/dm_conversations/with/abc/messages"), stringArgumentCaptor.getAllValues());
            assertEquals(Http.Body.of(Map.of(TEXT, "some text"), Http.BodyContentType.JSON),
