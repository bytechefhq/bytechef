 ...
 */
public class TextHelperGetTextAfterAction {

    public static final ModifiableActionDefinition ACTION_DEFINITION = action("getTextAfter")
        .title("Get Text After")
        .description(
            "Given a string and a pattern, this operation will return the substring between where the pattern was " +
                "found depending on the match number and ending of the string.")
        .properties(
            string(TEXT)
                .label("Text")
        ...
        .help("", "https://docs.bytechef.io/reference/components/text-helper_v1#get-text-after")
        .perform(TextHelperGetTextAfterAction::perform);

    private TextHelperGetTextAfterAction() {
    }
    ...
    public static String perform(Parameters inputParameters, Parameters connectionParameters, Context context) {
        ...
        return text.substring(patternIndex);
    }
}
