 ...
 */
public class TextHelperExtractRegExAction {

    public static final ModifiableActionDefinition ACTION_DEFINITION = action("extractRegEx")
        .title("Extract by Regular Expression")
