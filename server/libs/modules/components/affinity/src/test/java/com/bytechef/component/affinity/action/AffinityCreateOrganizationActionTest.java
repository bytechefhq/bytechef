 ...
 */
class AffinityCreateOrganizationActionTest extends AbstractAffinityActionTest {
    ...
    void testPerform() {
        ...
        when(mockedParameters.getString(DOMAIN))
            .thenReturn(propertyStubsMap.get(DOMAIN));
    ...
    private static Map<String, String> createPropertyStubsMap() {
        ...
        propertyStubsMap.put(DOMAIN, "domain");
