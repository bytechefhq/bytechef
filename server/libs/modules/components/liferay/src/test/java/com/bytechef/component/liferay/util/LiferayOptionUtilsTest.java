...
class LiferayOptionUtilsTest {
    ...
    void testGetApplicationsOptions(
        ...
        when(mockedResponse.getBody(any(TypeReference.class)))
            .thenReturn(Map.of(
                "/abc-test", List.of("http://localhost:8080/o/abc-test/v1.0/openapi.yaml"),
                "/123-test", List.of("http://localhost:8080/o/123-test/v1.0/openapi.yaml")));
        ...
        assertTrue(result.containsAll(List.of(
            option("123-test v1.0", "123-test/v1.0"),
            option("abc-test v1.0", "abc-test/v1.0"))));
        ...
        assertEquals("/o/openapi", stringArgumentCaptor.getValue());
    }
