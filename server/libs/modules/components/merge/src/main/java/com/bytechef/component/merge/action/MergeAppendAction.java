 ...
 * @author Ivona Pavela
 */
public class MergeAppendAction {
    ...
    public static final ModifiableActionDefinition ACTION_DEFINITION = action("append")
        ...
        .properties(
            array(INPUTS)
                ...
                .required(true))
        .output()
        .help("", "https://docs.bytechef.io/reference/components/merge_v1#merge-append")
        .perform(MergeAppendAction::perform);

    private MergeAppendAction() {
    }
