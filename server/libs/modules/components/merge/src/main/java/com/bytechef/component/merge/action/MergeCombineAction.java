 ...
 * @author Ivona Pavela
 */
public class MergeCombineAction {
    ...
    public static final ModifiableActionDefinition ACTION_DEFINITION = action("combine")
        ...
        .properties(
            ...
            array(INPUT_2)
                ...
                .required(true))
        .output()
        .help("", "https://docs.bytechef.io/reference/components/merge_v1#merge-combine")
        .perform(MergeCombineAction::perform);
        ...
        for (Map<String, Object> item1 : list1) {
            ...
            for (Map<String, Object> item2 : list2) {
                ...
                if (value1 != null && value1.equals(value2)) {
                    Map<String, Object> merged = new HashMap<>(item1);
                    merged.putAll(item2);
                    result.add(merged);
                    matched = true;
                }
