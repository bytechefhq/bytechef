...
class FirecrawlDeleteBrowserSessionActionTest {

    private final Parameters mockedParameters = MockParametersFactory.create(Map.of(SESSION_ID, "session-123"));
    ...
    void testPerform(
        ...
        Object result = FirecrawlDeleteBrowserSessionAction.perform(mockedParameters, null, mockedContext);

        assertEquals(Map.of("success", true, "creditsBilled", 7), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/interact/session-123", stringArgumentCaptor.getValue());
