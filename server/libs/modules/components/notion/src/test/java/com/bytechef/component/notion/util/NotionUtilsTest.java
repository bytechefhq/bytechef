...
class NotionUtilsTest {
    ...
    @Test
    void gePageOrDatabaseIdOptions() throws Exception {
        ...
        when(mockedResponse.getBody(any(TypeReference.class)))
            .thenReturn(Map.of("results", List.of(Map.of(ID, "123", "properties",
                Map.of("title", Map.of("title", List.of(Map.of(TEXT, Map.of(CONTENT, "abc")))))))));
        ...
        assertEquals(List.of(option("abc", "123")), options);

        Http.Body body = bodyArgumentCaptor.getValue();

        assertEquals(Map.of("filter", Map.of("property", "object", "value", "page")), body.getContent());
    }
}
