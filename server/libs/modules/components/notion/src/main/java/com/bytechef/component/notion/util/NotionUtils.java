...
import static com.bytechef.component.notion.constant.NotionPropertyType.CHECKBOX;
import static com.bytechef.component.notion.constant.NotionPropertyType.DATE;
import static com.bytechef.component.notion.constant.NotionPropertyType.EMAIL;
import static com.bytechef.component.notion.constant.NotionPropertyType.MULTI_SELECT;
import static com.bytechef.component.notion.constant.NotionPropertyType.NUMBER;
import static com.bytechef.component.notion.constant.NotionPropertyType.PHONE_NUMBER;
import static com.bytechef.component.notion.constant.NotionPropertyType.RICH_TEXT;
import static com.bytechef.component.notion.constant.NotionPropertyType.SELECT;
import static com.bytechef.component.notion.constant.NotionPropertyType.STATUS;
import static com.bytechef.component.notion.constant.NotionPropertyType.URL;
import static com.bytechef.component.notion.constant.NotionPropertyType.getPropertyTypeByName;
...
import com.bytechef.component.notion.constant.NotionConstants;
import com.bytechef.component.notion.constant.NotionPropertyType;
        ...
        if (body.get("properties") instanceof Map<?, ?> propertyMap) {
            for (Map.Entry<?, ?> property : propertyMap.entrySet()) {
                ...
                if (value instanceof Map<?, ?> map) {
                    columnIdTypeMap.put(propertyName, (String) map.get(NotionConstants.TYPE));
                }
            }
        }
