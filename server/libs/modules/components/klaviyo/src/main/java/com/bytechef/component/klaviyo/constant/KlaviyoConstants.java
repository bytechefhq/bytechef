...
public class KlaviyoConstants {
    ...
    public static final ModifiableObjectProperty LISTS_OUTPUT_PROPERTY =
        object()
            .properties(
                array("data")
                    .items(
                        ...
                        object("attributes")
                            .properties(
                                ...
                                string("last_event_date")
                                    .description(
                                        "Date and time of the most recent event the triggered an update to the profile, in ISO 8601 format."),
                                object("location")
                                    .properties(
                                        string("address1")
                                                ...
                                                object("marketing")
                                                    ...
                                                    .properties(
                                                        ...
                                                        dateTime("consent_timestamp")
                                                            .description(
                                                                "The timestamp when consent was recorded or updated for email marketing, in ISO 8601 format."),
                                                        ...
                                                        string("method_detail")
                                                            .description(
                                                                "Additional details about the method by which the profile was subscribed to email marketing."),
                                                        string("custom_method_detail")
                                                            .description(
                                                                "Additional detail provided by the caller when the profile was subscribed."),
                                                        bool("double_optin")
                                                            .description(
                                                        ...
                                                        array("suppression")
                                                            ...
                                                            .items(
                                                                ...
                                                                dateTime("timestamp")
                                                                    .description(
                                                                        "The timestamp when the profile was suppressed, in ISO 8601 format.")),
                                                        array("list_suppressions")
                                                            ...
                                                            .items(
                                                                ...
                                                                dateTime("timestamp")
                                                                    .description(
                                                                        "The timestamp when the profile was suppressed from the list, in ISO 8601 format.")))),
                                        object("sms")
                                                ...
                                                object("marketing")
                                                    ...
                                                    .properties(
                                                        bool("can_receive_sms_marketing")
                                                            .description(
                                                                "Whether or not this profile has implicit consent to receive SMS marketing."),
                                                        string("consent")
                                                            .description("The consent status for SMS marketing."),
                                                        dateTime("consent_timestamp")
                                                            .description(
                                                                "The timestamp when consent was recorded or updated for SMS marketing, in ISO 8601 format."),
                                                        string("method")
                                                            .description(
                                                                "The method by which the profile was subscribed to SMS marketing."),
                                                        string("method_detail")
                                                            .description(
                                                                "Additional details about the method by which the profile was subscribed to SMS marketing."),
                                                        dateTime("last_updated")
                                                            .description(
                                                                "The timestamp when the SMS consent record was last modified, in ISO 8601 format.")),
                                                object("transactional")
                                                    .description("The SMS transactional subscription.")
                                                    .properties(
                                                        bool("can_receive_sms_transactional")
                                                            .description(
                                                                "Whether or not this profile has implicit consent to receive transactional SMS."),
                                                        string("consent")
                                                            .description("The consent status for SMS Transactional."),
                                                        dateTime("consent_timestamp")
                                                            .description(
                                                                "The timestamp when consent was recorded or updated for Transactional SMS messaging, in ISO 8601 format."),
                                                        string("method")
                                                            .description(
                                                                "The method by which the profile was subscribed to Transactional SMS messaging."),
                                                        string("method_detail")
                                                            .description(
                                                                "Additional details about the method by which the profile was subscribed to Transactional SMS messaging."),
                                                        dateTime("last_updated")
                                                            .description(
                                                                "The timestamp when the SMS consent record was last modified, in ISO 8601 format."))),
                                        object("mobile_push")
                                                ...
                                                object("marketing")
                                                    ...
                                                    .properties(
                                                        bool("can_receive_push_marketing")
                                                            .description(
                                                                "Whether or not this profile has implicit consent to receive mobile push."),
                                                        string("consent")
                                                            .description(
                                                                "The consent status for mobile push marketing."),
                                                        dateTime("consent_timestamp")
                                                            .description(
                                                                "The timestamp when the consent was last changed, in ISO 8601 format.")))),
