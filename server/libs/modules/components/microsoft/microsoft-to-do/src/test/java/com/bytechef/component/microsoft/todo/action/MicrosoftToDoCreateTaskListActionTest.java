...
class MicrosoftToDoCreateTaskListActionTest {
    ...
    void testPerform(
        ...
        Map<String, Object> map = Map.of(DISPLAY_NAME, "name");
        ...
        Object result = MicrosoftToDoCreateTaskListAction.perform(
        ...
        assertEquals(Body.of(map, BodyContentType.JSON), bodyArgumentCaptor.getValue());
    }
}
