...
class MicrosoftSharePointReplaceFileActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final FileEntry mockedFileEntry = mock(FileEntry.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(SITE_ID, "siteId", FILE_ID, "fileId", FILE, mockedFileEntry));
    ...
    void testPerform(
        ...
        Map<String, Object> result = MicrosoftSharePointReplaceFileAction.perform(
            mockedParameters, mockedParameters, mockedContext);

        assertEquals(Map.of(), result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/sites/siteId/drive/items/fileId/content", stringArgumentCaptor.getValue());
