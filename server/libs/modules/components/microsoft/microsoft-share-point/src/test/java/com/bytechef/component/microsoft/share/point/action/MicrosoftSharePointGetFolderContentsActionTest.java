...
class MicrosoftSharePointGetFolderContentsActionTest {

    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(SITE_ID, "siteId", PARENT_FOLDER, "parent"));
    ...
    void testPerform(
        ...
        Object result = MicrosoftSharePointGetFolderContentsAction.perform(
        ...
        assertEquals("/sites/siteId/drive/items/parent/children", stringArgumentCaptor.getValue());
    }
}
