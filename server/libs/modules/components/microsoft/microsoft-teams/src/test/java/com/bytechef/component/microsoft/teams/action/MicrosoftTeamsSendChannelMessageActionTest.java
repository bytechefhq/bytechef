 ...
 */
class MicrosoftTeamsSendChannelMessageActionTest extends AbstractMicrosoftTeamsActionTest {
    ...
    void testPerform() {
        ...
        assertEquals(Map.of(BODY, Map.of(CONTENT_TYPE, "text", CONTENT, "message")), body.getContent());
    }
