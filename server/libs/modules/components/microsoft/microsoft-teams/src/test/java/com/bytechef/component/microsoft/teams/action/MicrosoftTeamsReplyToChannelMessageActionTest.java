...
class MicrosoftTeamsReplyToChannelMessageActionTest {
    ...
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(ATTACHMENTS, List.of("fileId"), TEAM_ID, "teamId", CHANNEL_ID, "channelId",
            CONTENT, "content", MESSAGE_ID, "messageId", CONTENT_TYPE, "contentType"));
    ...
    void testPerform(
        ...
        try (
            ...
            Map<String, Object> expectedBody = Map.of(
                BODY, Map.of(CONTENT_TYPE, "contentType", CONTENT, "content"), ATTACHMENTS, List.of());
            ...
            assertEquals(
                "/teams/teamId/channels/channelId/messages/messageId/replies", stringArgumentCaptor.getValue());
        }
    }
}
