...
class MicrosoftDynamicsCrmUpdateRecordActionTest {

    private final ArgumentCaptor<Http.Body> bodyArgumentCaptor = forClass(Http.Body.class);
    private final Object mockedObject = mock(Object.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(ENTITY_TYPE, "account", RECORD_ID, "xy", FIELDS, Map.of("name", "test")));
    ...
    void testPerform(
        ...
        Object result = MicrosoftDynamicsCrmUpdateRecordAction.perform(mockedParameters, null, mockedContext);
        ...
        assertEquals(List.of("/account(xy)", "Prefer", "return=representation"), stringArgumentCaptor.getAllValues());
        assertEquals(
            Http.Body.of(Map.of("name", "test"), Http.BodyContentType.JSON), bodyArgumentCaptor.getValue());
    }
}
