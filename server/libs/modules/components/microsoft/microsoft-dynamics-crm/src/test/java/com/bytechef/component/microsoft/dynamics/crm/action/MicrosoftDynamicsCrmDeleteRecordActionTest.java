...
class MicrosoftDynamicsCrmDeleteRecordActionTest {

    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(ENTITY_TYPE, "account", RECORD_ID, "xy"));
    ...
    void testPerform(
        ...
        Object result = MicrosoftDynamicsCrmDeleteRecordAction.perform(mockedParameters, null, mockedContext);
        ...
        assertEquals("/account(xy)", stringArgumentCaptor.getValue());
    }
}
