 ...
 */
class MicrosoftDynamicsCrmNewAccountTriggerTest {
    ...
    void testPool() {
        try (MockedStatic<MicrosoftDynamicsCrmUtils> microsoftDynamicsCrmUtilsMockedStatic =
            ...
            PollOutput pollOutput = MicrosoftDynamicsCrmNewAccountTrigger.poll(
            ...
            assertEquals("createdon", stringArgumentCaptor.getValue());
        }
    }
}
