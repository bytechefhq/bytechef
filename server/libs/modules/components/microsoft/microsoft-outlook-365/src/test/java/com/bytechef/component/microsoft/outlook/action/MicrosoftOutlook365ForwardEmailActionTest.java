...
class MicrosoftOutlook365ForwardEmailActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Body.class);
    @SuppressWarnings("rawtypes")
    private final ArgumentCaptor<List> listArgumentCaptor = forClass(List.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(ID, "xy", CONTENT_TYPE, ContentType.TEXT.name(), CONTENT, "test", TO_RECIPIENTS, List.of("address1")));
    ...
    void testPerform(
        ...
        try (MockedStatic<MicrosoftOutlook365Utils> microsoftOutlook365UtilsMockedStatic =
            ...
            microsoftOutlook365UtilsMockedStatic.when(
                ...
                .thenReturn(List.of(Map.of(EMAIL_ADDRESS, Map.of(ADDRESS, "address1"))));
            ...
            Object result = MicrosoftOutlook365ForwardEmailAction.perform(mockedParameters, null, mockedContext);

            assertNull(result);
            assertNotNull(httpFunctionArgumentCaptor.getValue());
            assertEquals("/me/messages/xy/forward", stringArgumentCaptor.getValue());
            assertEquals(List.of("address1"), listArgumentCaptor.getValue());

            Map<String, Object> expectedBody = Map.of(
                TO_RECIPIENTS, List.of(Map.of(EMAIL_ADDRESS, Map.of(ADDRESS, "address1"))), COMMENT, "test");
