...
public class MicrosoftExcelRowDiffUtils {

    private static final int MAX_DIFFED_ROWS = 500;

    private MicrosoftExcelRowDiffUtils() {
    }
    ...
    public static List<Integer> getInsertedRowIndexes(List<String> knownRowHashes, List<String> currentRowHashes) {
        ...
        return excludeReorderedExistingRows(knownRowHashes, currentRowHashes, insertedRowIndexes);
    }
