...
import com.bytechef.component.microsoft.excel.trigger.MicrosoftExcelNewRowTriggerV2;
...
public class MicrosoftExcelComponentHandlerV2 implements ComponentHandler {
    ...
    private static final ComponentDefinition COMPONENT_DEFINITION = component("microsoftExcel")
        ...
        .triggers(MicrosoftExcelNewRowTriggerV2.TRIGGER_DEFINITION)
        .version(2);
