 ...
 */
class AttioTaskCreatedTriggerTest extends AbstractAttioTriggerTest {
    ...
    void webhookEnable() {
        ...
        WebhookEnableOutput webhookEnableOutput = AttioTaskCreatedTrigger.webhookEnable(
        ...
        assertEquals(List.of("task.created", webhhookUrl), stringArgumentCaptor.getAllValues());
    ...
    void webhookDisable() {
        ...
        AttioTaskCreatedTrigger.webhookDisable(
