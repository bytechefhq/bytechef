...
public class AttioConstants {
    ...
    public static final ModifiableObjectProperty PERSON_RECORD = object(VALUE)
        .required(true)
        .properties(
            array("name")
                .label("Name")
                    ...
                    object()
                        .properties(
                            ...
                            string(TARGET_RECORD_ID)
                                ...
                                .options((ActionOptionsFunction<String>) AttioUtils::getTargetRecordCompanyOptions)
                                .required(true))),
            array("job_title")
                .label("Job Title")
                .items(
                    ...
                    object("")
                        .properties(
                            ...
                            string(TARGET_RECORD_ID)
                                .label("Target Record ID")
                                .optionsLookupDependsOn(TARGET_OBJECT)
                                .options((ActionOptionsFunction<String>) AttioUtils::getTargetRecordDealOptions)
                                .required(true))),
    ...
    public static final ModifiableObjectProperty COMPANY_RECORD = object(VALUE)
        .required(true)
        .properties(
            array("domains")
                .label("Domains")
                    ...
                    object()
                        .properties(
                            string("option")
                                .label("Option")
                                .optionsLookupDependsOn(TARGET_OBJECT)
                                .options((ActionOptionsFunction<String>) AttioUtils::getCompanyCategoriesIdOptions))),
            array("primary_location")
                .label("Primary Location")
                .items(
                    object()
                ...
                .items(
                    object()
                        .properties(
                            string("option")
                                .label("Option")
                                .options((ActionOptionsFunction<String>) AttioUtils::getCompanyArrIdOptions)
                                .required(true))),
                ...
                .items(
                    object()
                        .properties(
                            string("option")
                                .label("Option")
                                .options((ActionOptionsFunction<String>) AttioUtils::getCompanyEmployeeRangeIdOptions)
                                .required(true))),
            array("associated_deals")
                .label("Associated Deals")
                .items(
                    ...
                    object("")
                        .properties(
                            ...
                            string(TARGET_RECORD_ID)
                                .label("Target Record ID")
                                .optionsLookupDependsOn(TARGET_OBJECT)
                                .options((ActionOptionsFunction<String>) AttioUtils::getTargetRecordWorkspaceOptions)
                                .required(true))));

    public static final ModifiableObjectProperty USER_RECORD = object(VALUE)
        .required(true)
        .properties(
            array("person")
                .label("Person")
                    ...
                    object()
                        .properties(
                            ...
                            string(TARGET_RECORD_ID)
                                .label("Target Record ID")
                                .optionsLookupDependsOn(TARGET_OBJECT)
                                .options((ActionOptionsFunction<String>) AttioUtils::getTargetRecordPersonOptions)
                                .required(true))),
    ...
    public static final ModifiableObjectProperty DEAL_RECORD = object(VALUE)
        .required(true)
        .properties(
            array("name")
                .label("Deal Name")
    ...
    public static final ModifiableObjectProperty WORKSPACE_RECORD = object(VALUE)
        .required(true)
        .properties(
            array("workspace_id")
                .label("Workspace ID")
