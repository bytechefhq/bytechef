 ...
 */
public class AttioRecordCreatedTrigger {

    public static final ModifiableTriggerDefinition TRIGGER_DEFINITION = trigger("recordCreated")
    ...
    private AttioRecordCreatedTrigger() {
    }
