 ...
 */
public class SalesforceUpdatedRecordTrigger {

    protected static final String LAST_TIME_CHECKED = "lastTimeChecked";

    public static final ModifiableTriggerDefinition TRIGGER_DEFINITION = trigger("updatedRecord")
        .title("Updated Record")
        .description("Triggers when record is updated.")
    ...
    protected static PollOutput poll(
        ...
        return getPollOutput(inputParameters, closureParameters, triggerContext, "LastModifiedDate");
    }
}
