 ...
 */
class SalesforceUpdatedRecordTriggerTest {
    ...
    void testPoll() {
        try (MockedStatic<SalesforceUtils> salesforceUtilsMockedStatic = mockStatic(SalesforceUtils.class)) {
            ...
            PollOutput pollOutput = SalesforceUpdatedRecordTrigger.poll(
            ...
            assertEquals("LastModifiedDate", stringArgumentCaptor.getValue());
        }
    }
}
