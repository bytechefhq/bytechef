 ...
 * @author Ivica Cardic
 */
public class SetValueInListAction {

    public final ActionDefinition actionDefinition = action("setValueInList")
        .display(display("Set Value in List").description("Set value under a specified index in a list."))
        .properties(
            string(KEY)
                .label("Key")
                .description(
    ...
    public SetValueInListAction(DataStorageService dataStorageService) {
