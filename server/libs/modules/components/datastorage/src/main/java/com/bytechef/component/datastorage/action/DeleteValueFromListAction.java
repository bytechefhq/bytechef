 ...
 * @author Ivica Cardic
 */
public class DeleteValueFromListAction {

    public final ActionDefinition actionDefinition = action("deleteValueFromlist")
        .display(display("Delete Value from List").description("Delete a value from the given index in a list."))
        .properties(
            string(KEY)
                .label("Key")
    ...
    public DeleteValueFromListAction(DataStorageService dataStorageService) {
