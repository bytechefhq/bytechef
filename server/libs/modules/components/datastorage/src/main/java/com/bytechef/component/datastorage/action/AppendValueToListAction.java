 ...
 * @author Ivica Cardic
 */
public class AppendValueToListAction {

    public final ActionDefinition actionDefinition = action("appendValueToList")
        .display(display("Append Value to List").description(""))
        .properties(
    ...
    public AppendValueToListAction(DataStorageService dataStorageService) {
