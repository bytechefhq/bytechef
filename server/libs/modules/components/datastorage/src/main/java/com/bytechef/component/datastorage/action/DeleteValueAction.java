 ...
 * @author Ivica Cardic
 */
public class DeleteValueAction {

    public final ActionDefinition actionDefinition = action("deleteValue")
        .display(display("Delete Value").description("Remove a value associated with a key in the specified scope."))
        .properties(
            string(KEY)
                .label("Key")
    ...
    public DeleteValueAction(DataStorageService dataStorageService) {
