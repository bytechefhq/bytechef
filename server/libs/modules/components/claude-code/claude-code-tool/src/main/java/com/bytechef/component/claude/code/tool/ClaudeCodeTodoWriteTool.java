...
/**
 * Provides structured task management with state tracking for the Claude Code agent.
 *
 * @author Ivica Cardic
 */
public class ClaudeCodeTodoWriteTool {
    ...
    public static final ClusterElementDefinition<ClaudeCodeToolFunction> CLUSTER_ELEMENT_DEFINITION =
        ComponentDsl.<ClaudeCodeToolFunction>clusterElement("todoWriteTool")
            ...
            .object(() -> ClaudeCodeTodoWriteTool::apply);
    ...
    private static List<ToolCallback> apply(
        ...
        return List.of(ToolCallbacks.from(todoWriteTool));
    }
}
