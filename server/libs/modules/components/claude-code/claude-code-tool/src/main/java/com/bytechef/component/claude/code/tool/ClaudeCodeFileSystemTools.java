...
/**
 * Provides file system tools (Read, Write, Edit) for the Claude Code agent.
 *
 * @author Ivica Cardic
 */
public class ClaudeCodeFileSystemTools {
    ...
    public static final ClusterElementDefinition<ClaudeCodeToolFunction> CLUSTER_ELEMENT_DEFINITION =
        ComponentDsl.<ClaudeCodeToolFunction>clusterElement("fileSystemTools")
            ...
            .object(() -> ClaudeCodeFileSystemTools::apply);
    ...
    private static List<ToolCallback> apply(
        ...
        return List.of(ToolCallbacks.from(fileSystemTools));
    }
}
