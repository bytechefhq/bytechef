 ...
 * @author Ivica Cardic
 */
public class NewMessageTrigger {
    ...
    public static final TriggerDefinition TRIGGER_DEFINITION = trigger("newMessage")
        .display(display("New Message").description("Triggers on new RabbitMQ messages."))
        ...
        .properties(
            string(QUEUE)
                ...
                .required(true))
        .outputSchema(object())
        .listenerEnable(NewMessageTrigger::listenerEnable)
    ...
    protected static void listenerEnable(
        ...
        try {
            ...
            channel.queueDeclare(inputParameters.getRequired(QUEUE), true, false, false, null);
