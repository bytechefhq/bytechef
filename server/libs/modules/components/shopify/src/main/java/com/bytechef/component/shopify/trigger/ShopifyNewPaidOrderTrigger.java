...
public class ShopifyNewPaidOrderTrigger {
    ...
    public static final ModifiableTriggerDefinition TRIGGER_DEFINITION = trigger(NEW_PAID_ORDER)
        ...
        .dynamicWebhookEnable(ShopifyNewPaidOrderTrigger::dynamicWebhookEnable)
        .dynamicWebhookDisable(ShopifyNewPaidOrderTrigger::dynamicWebhookDisable)
        .dynamicWebhookRequest(ShopifyNewPaidOrderTrigger::dynamicWebhookRequest);
