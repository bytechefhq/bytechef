...
public class ProductsActions {
    public static final List<ComponentDSL.ModifiableActionDefinition> ACTIONS = List.of(
        action("get_smart_collections")
            ...
            .metadata(Map.of("requestMethod", "GET", "path", "/admin/api/2020-10/smart_collections.json"))
            .properties(
                object("limit")
                    .label("Limit")
        ...
        action("get_smart_collections_count")
            ...
            .metadata(Map.of("requestMethod", "GET", "path", "/admin/api/2020-10/smart_collections/count.json"))
            .properties(
                object("title")
                    .label("Title")
                    .description("Show smart collections with the specified title.")
