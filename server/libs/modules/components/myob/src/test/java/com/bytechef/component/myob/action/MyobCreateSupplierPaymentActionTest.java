 ...
 */
class MyobCreateSupplierPaymentActionTest {
    ...
    void testPerform() {
        ...
        Object result = MyobCreateSupplierPaymentAction.perform(parameters, parameters, mockedContext);

        assertNull(result);

        Http.Body body = bodyArgumentCaptor.getValue();

        assertEquals(Map.of(PAY_FROM, ACCOUNT, ACCOUNT, Map.of(UID, "123"), SUPPLIER, Map.of(UID, "abc")),
            body.getContent());
    }
}
