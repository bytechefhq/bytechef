 ...
 */
public class MyobCreateCustomerAction {
    ...
    public static final ModifiableActionDefinition ACTION_DEFINITION = action("createCustomer")
        ...
        .properties(
            ...
            bool(IS_INDIVIDUAL)
                .label("Is Individual?")
                .description("Does customer contact represent an individual or a company?")
                .required(true),
            FIRST_NAME_PROPERTY,
            LAST_NAME_PROPERTY,
            string(COMPANY_NAME)
                .label("Company Name")
                .description("Company name of the customer contact.")
                .maxLength(50)
                .displayCondition("%s == false".formatted(IS_INDIVIDUAL))
                .required(true),
            bool(IS_ACTIVE)
                .label("Is Active?")
                .description("Is customer contact active?")
                .defaultValue(true)
                .required(true),
            ADDRESSES_PROPERTY)
    ...
    public static Object perform(
        ...
        actionContext
            .http(http -> http.post(inputParameters.getRequiredString(COMPANY_FILE) + "/Contact/Customer"))
            .body(
                Http.Body.of(
                    ...
                    IS_ACTIVE, inputParameters.getRequiredBoolean(IS_ACTIVE),
