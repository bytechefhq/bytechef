...
class StripeUpdateSubscriptionActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Body.class);
    private final Parameters mockedParameters =
        MockParametersFactory.create(
            Map.of(CUSTOMER_ID, "xy", SUBSCRIPTION_ID, "ab", ITEMS,
                List.of(Map.of(PRICE_ID, "1", COUPON_ID, "2", QUANTITY, 3)),
    ...
    void testPerform(
        ...
        Object result = StripeUpdateSubscriptionAction.perform(mockedParameters, null, mockedContext);
        ...
        assertEquals("/subscriptions/ab", stringArgumentCaptor.getValue());

        assertEquals(
            Body.of(
                Map.of(COLLECTION_METHOD, "send_invoice", DAYS_UNTIL_DUE, 2,
