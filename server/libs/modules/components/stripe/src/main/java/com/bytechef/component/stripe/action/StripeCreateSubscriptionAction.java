 ...
 */
public class StripeCreateSubscriptionAction {

    public static final ModifiableActionDefinition ACTION_DEFINITION = action("createSubscription")
        .title("Create Subscription")
        .description("Creates a new subscription.")
        .help("", "https://docs.bytechef.io/reference/components/stripe_v1#create-subscription")
        .properties(
            string(CUSTOMER_ID)
                .label("Customer ID")
        ...
        .perform(StripeCreateSubscriptionAction::perform);

    private StripeCreateSubscriptionAction() {
    }
    ...
    public static Object perform(Parameters inputParameters, Parameters connectionParameters, Context context) {
        ...
        body.put(CUSTOMER_ID, inputParameters.getRequiredString(CUSTOMER_ID));
        ...
        return context.http(http -> http.post("/subscriptions"))
