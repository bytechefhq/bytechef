 ...
 * @author Ivica Cardic
 */
public class ValidateAndRespondTrigger {

    public static final TriggerDefinition TRIGGER_DEFINITION = trigger("validateAndRespond")
        .display(display("Validate and respond").description(
        ...
        .staticWebhookRequest(ValidateAndRespondTrigger::staticWebhookRequest)
        .webhookValidate(ValidateAndRespondTrigger::webhookValidate);
