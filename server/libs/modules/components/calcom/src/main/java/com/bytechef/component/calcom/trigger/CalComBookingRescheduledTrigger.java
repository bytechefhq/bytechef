 ...
 */
public class CalComBookingRescheduledTrigger {
            ...
            outputSchema(
                object()
                    .properties(
                        ...
                        object("videoCallData")
                            .description("Video call data of the booking.")
                            .properties(
                                string("type")
                                ...
                                string("password")
                                    .description("Password of the video call."),
                                string("uri")
                                    .description("URI of the video call.")),
                        string("rescheduledBy")
                            .description("Booking rescheduled by user."),
                        ...
                        integer("rescheduleId")
                            .description("ID of the rescheduled booking."),
                        string("rescheduleUid")
                            .description("UID of the rescheduled booking."),
                        string("rescheduleStartTime")
                            .description("Rescheduled start time of the booking."),
                        string("rescheduleEndTime")
                            .description("Rescheduled end time of the booking."),
                        object("metadata")
                            .description("Metadata of the booking."),
                        string("status")
                            .description("Status of the booking"))))
        .webhookEnable(CalComBookingRescheduledTrigger::webhookEnable)
        .webhookDisable(CalComBookingRescheduledTrigger::webhookDisable)
        .webhookRequest(CalComBookingRescheduledTrigger::webhookRequest);

    private CalComBookingRescheduledTrigger() {
    }
