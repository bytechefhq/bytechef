 ...
 */
class CalComBookingEndedTriggerTest extends AbstractCalComTriggerTest {
    ...
    void testWebhookEnable() {
        ...
        WebhookEnableOutput webhookEnableOutput = CalComBookingEndedTrigger.webhookEnable(
        ...
        assertEquals(List.of("MEETING_ENDED", webhookUrl), stringArgumentCaptor.getAllValues());
    ...
    void webhookDisable() {
        ...
        CalComBookingEndedTrigger.webhookDisable(
    ...
    void webhookRequest() {
        ...
        Object result = CalComBookingEndedTrigger.webhookRequest(
