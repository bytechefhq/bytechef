 ...
 */
class CalComBookingCreatedTriggerTest extends AbstractCalComTriggerTest {
    ...
    void testWebhookEnable() {
        ...
        WebhookEnableOutput webhookEnableOutput = CalComBookingCreatedTrigger.webhookEnable(
        ...
        assertEquals(List.of("BOOKING_CREATED", webhookUrl), stringArgumentCaptor.getAllValues());
    ...
    void webhookDisable() {
        ...
        CalComBookingCreatedTrigger.webhookDisable(
    ...
    void webhookRequest() {
        ...
        Object result = CalComBookingCreatedTrigger.webhookRequest(
