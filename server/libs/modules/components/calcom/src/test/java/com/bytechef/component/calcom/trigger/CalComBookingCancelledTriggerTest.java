 ...
 */
class CalComBookingCancelledTriggerTest extends AbstractCalComTriggerTest {
    ...
    void testWebhookEnable() {
        ...
        WebhookEnableOutput webhookEnableOutput = CalComBookingCancelledTrigger.webhookEnable(
        ...
        assertEquals(List.of("BOOKING_CANCELLED", webhookUrl), stringArgumentCaptor.getAllValues());
    ...
    void webhookDisable() {
        ...
        CalComBookingCancelledTrigger.webhookDisable(
    ...
    void webhookRequest() {
        ...
        Object result = CalComBookingCancelledTrigger.webhookRequest(
