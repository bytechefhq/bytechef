    ...
    public static final ModifiableActionDefinition ACTION_DEFINITION = action(RESPONSE_TO_AI_MODEL_CALL)
        ...
        .properties(
            ...
            dynamicProperties(RESPONSE)
                ...
                .properties(WorkflowResponseToAiModelCallAction::responseProperties)
                .required(true))
        .output(WorkflowResponseToAiModelCallAction::output)
        .perform(WorkflowResponseToAiModelCallAction::perform);
