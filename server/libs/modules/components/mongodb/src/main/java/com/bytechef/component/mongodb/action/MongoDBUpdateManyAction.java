...
public class MongoDBUpdateManyAction {

    public static final ModifiableActionDefinition ACTION_DEFINITION = action("updateMany")
        .title("Update Many")
        .description("Updates all documents in a collection matching a filter.")
        .properties(
            string(COLLECTION)
                .label("Collection")
        ...
        .perform(MongoDBUpdateManyAction::perform);

    private MongoDBUpdateManyAction() {
    }
