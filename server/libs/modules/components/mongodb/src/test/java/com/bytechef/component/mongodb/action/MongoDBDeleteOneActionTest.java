...
class MongoDBDeleteOneActionTest {
    ...
    void testPerform() {
        ...
        try (MockedStatic<MongoDBUtils> mongoDBUtilsMockedStatic = mockStatic(MongoDBUtils.class, CALLS_REAL_METHODS)) {
            ...
            assertEquals(Map.of("deletedCount", 1L), result);
