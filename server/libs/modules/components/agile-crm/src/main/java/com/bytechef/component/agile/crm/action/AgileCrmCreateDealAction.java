...
import static com.bytechef.component.agile.crm.util.AgileCrmUtils.ifPropertyIsNull;
        ...
        return context.http(http -> http.post("/opportunity"))
            .body(
                Body.of(
                    ...
                    DESCRIPTION, ifPropertyIsNull(inputParameters.getString(DESCRIPTION)),
                    EXPECTED_VALUE, inputParameters.getRequiredDouble(EXPECTED_VALUE),
                    MILESTONE, ifPropertyIsNull(inputParameters.getString(MILESTONE)),
                    PROBABILITY, ifPropertyIsNull(String.valueOf(inputParameters.getInteger(PROBABILITY))),
                    OWNER_ID, ifPropertyIsNull(inputParameters.getString(OWNER_ID))))
