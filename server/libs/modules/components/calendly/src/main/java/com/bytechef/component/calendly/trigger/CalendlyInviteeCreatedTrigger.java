 ...
 */
public class CalendlyInviteeCreatedTrigger {

    public static final ModifiableTriggerDefinition TRIGGER_DEFINITION = trigger("inviteeCreated")
    ...
    private CalendlyInviteeCreatedTrigger() {
    }
    ...
    protected static WebhookEnableOutput webhookEnable(
        ...
        return CalendlyUtils.subscribeWebhook(
            context, webhookUrl, inputParameters.getRequiredString(SCOPE), "invitee.created");
    }
