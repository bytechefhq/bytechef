 ...
 */
abstract class AbstractCalendlyTriggerTest {
    ...
    protected Parameters mockedWebhookEnableOutputParameters = mock(Parameters.class);
    ...
    protected Parameters mockedParameters = MockParametersFactory.create(Map.of(SCOPE, "scope", UUID, "123"));
    protected TriggerContext mockedTriggerContext = mock(TriggerContext.class);
    protected MockedStatic<CalendlyUtils> calendlyUtilsMockedStatic;
    ...
    @BeforeEach
    void beforeEach() {
        calendlyUtilsMockedStatic = mockStatic(CalendlyUtils.class);
    }

    @AfterEach
    void afterEach() {
        calendlyUtilsMockedStatic.close();
    }
}
