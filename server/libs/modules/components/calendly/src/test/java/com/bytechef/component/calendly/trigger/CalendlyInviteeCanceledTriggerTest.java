 ...
 */
class CalendlyInviteeCanceledTriggerTest extends AbstractCalendlyTriggerTest {
    ...
    void testWebhookDisable() {
        ...
        CalendlyInviteeCanceledTrigger.webhookDisable(
    ...
    void testWebhookEnable() {
        ...
        WebhookEnableOutput webhookEnableOutput = CalendlyInviteeCanceledTrigger.webhookEnable(
            mockedParameters, mockedParameters, webhookUrl, workflowExecutionId, mockedTriggerContext);

        assertEquals(mockedWebhookEnableOutput, webhookEnableOutput);

        assertEquals(mockedTriggerContext, contextArgumentCaptor.getValue());
        assertEquals(List.of(webhookUrl, "scope", "invitee.canceled"), stringArgumentCaptor.getAllValues());
    }
