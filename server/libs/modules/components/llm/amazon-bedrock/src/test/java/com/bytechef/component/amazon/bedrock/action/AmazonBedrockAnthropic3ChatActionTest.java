...
class AmazonBedrockAnthropic3ChatActionTest extends ChatActionTest {
    @Test
    void testPerform() {
        performTest((ActionDefinition.SingleConnectionPerformFunction) AmazonBedrockAnthropic3ChatAction.ACTION_DEFINITION.getPerform().get());
    }
