...
package com.bytechef.component.qianfan.connection;
...
public final class QIanFanConnection {
    ...
    public static final ModifiableConnectionDefinition CONNECTION_DEFINITION = connection()
        .baseUri((connectionParameters, context) -> "https://api.qianfan.chat")
        .authorizations(
            authorization(BEARER_TOKEN)
                ...
                .properties(
                    string(TOKEN)
                        .label("API Key")
                        .required(true),
                    string(QIanFanConstants.SECRET_KEY)
                        .label("Secret Key")
                        .required(true)));

    private QIanFanConnection() {
    }
}
