...
package com.bytechef.component.pdf.helper.util;
 ...
 */
class PdfHelperUtilsTest {

    private final ByteArrayOutputStream mockByteArrayOutputStream = mock(ByteArrayOutputStream.class);
