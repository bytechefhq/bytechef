...
public class HubspotContactMapper
    implements ProviderContactMapper<HubspotContactInputModel, HubspotContactOutputModel> {

    @Override
    public HubspotContactInputModel desunify(
    ...
    public ContactUnifiedOutputModel unify(
        HubspotContactOutputModel outputModel, List<CustomFieldMapping> customFieldMappings) {
