 ...
 */
public class HubspotNewContactTrigger {
    ...
    private HubspotNewContactTrigger() {
    }
    ...
    protected static void webhookDisable(
        ...
        HubspotUtils.unsubscribeWebhook(
            inputParameters.getRequiredString(APP_ID), outputParameters.getRequiredString(ID),
        ...
        return new WebhookEnableOutput(
            Map.of(ID,
                HubspotUtils.subscribeWebhook(
                    "contact.creation", inputParameters.getRequiredString(APP_ID),
