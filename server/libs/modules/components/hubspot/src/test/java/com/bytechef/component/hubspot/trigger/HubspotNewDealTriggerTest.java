 ...
 */
class HubspotNewDealTriggerTest extends AbstractHubspotTriggerTest {
    ...
    void testWebhookEnable() {
        ...
        hubspotUtilsMockedStatic.when(
            ...
            .thenReturn("123");
        WebhookEnableOutput webhookEnableOutput = HubspotNewDealTrigger.webhookEnable(
        ...
        assertEquals("deal.creation", eventTypeArgumentCaptor.getValue());
    ...
    void testWebhookDisable() {
        ...
        HubspotNewDealTrigger.webhookDisable(
    ...
    void testWebhookRequest() {
        ...
        Object result = HubspotNewDealTrigger.webhookRequest(
