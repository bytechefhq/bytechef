 ...
 */
class HubspotNewTicketTriggerTest extends AbstractHubspotTriggerTest {
    ...
    void testWebhookEnable() {
        ...
        hubspotUtilsMockedStatic.when(
            ...
            .thenReturn("123");
        WebhookEnableOutput webhookEnableOutput = HubspotNewTicketTrigger.webhookEnable(
        ...
        assertEquals("ticket.creation", eventTypeArgumentCaptor.getValue());
    ...
    void testWebhookDisable() {
        ...
        HubspotNewTicketTrigger.webhookDisable(
    ...
    void testWebhookRequest() {
        ...
        Object result = HubspotNewTicketTrigger.webhookRequest(
