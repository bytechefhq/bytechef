...
public class MondayConstants {
    ...
    public static final String CREATE_BOARD_DESCRIPTION = "Create a new board.";
    public static final String CREATE_BOARD_TITLE = "Create Board";
    public static final String CREATE_COLUMN = "createColumn";
    public static final String CREATE_COLUMN_DESCRIPTION = "Create a new column in board.";
    public static final String CREATE_COLUMN_TITLE = "Create Column";
    public static final String CREATE_GROUP = "createGroup";
    public static final String CREATE_GROUP_DESCRIPTION = "Creates a new group in board.";
    public static final String CREATE_GROUP_TITLE = "Create Group";
    public static final String CREATE_ITEM = "createItem";
    public static final String CREATE_ITEM_DESCRIPTION = "Create a new item in a board.";
    public static final String CREATE_ITEM_TITLE = "Create Item";
    public static final String DATA = "data";
    public static final String DELETE_ITEM = "deleteItem";
    public static final String DELETE_ITEM_DESCRIPTION = "Deletes an item from a board.";
    public static final String DELETE_ITEM_TITLE = "Delete Item";
