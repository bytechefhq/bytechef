...
class InfobipSendWhatsAppTemplateMessageActionTest {
    ...
    void testPerform(
        ...
        try (MockedStatic<InfobipUtils> infobipUtilsMockedStatic = mockStatic(InfobipUtils.class)) {
            ...
            assertEquals(
                Body.of("messages",
                    List.of(Map.of(FROM, "123", TO, "456", CONTENT, Map.of(TEMPLATE_NAME, "template", "templateData",
                        Map.of("body", Map.of(PLACEHOLDERS, List.of("value1", "value2", "value3"))), LANGUAGE, "en")))),
