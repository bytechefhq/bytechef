 ...
 */
public class InfobipNewSMSTrigger {

    public static final ModifiableTriggerDefinition TRIGGER_DEFINITION = trigger("newSMS")
    ...
    protected static WebhookEnableOutput webhookEnable(
        ...
        return getWebhookEnableOutput(inputParameters.getRequiredString(NUMBER_KEY), "SMS", webhookUrl, triggerContext);
    }
