...
class ClickupNewTaskTriggerTest extends AbstractClickupTriggerTest {
    ...
    void testDynamicWebhookEnable() {
        ...
        githubUtilsMockedStatic.when(
            ...
            .thenReturn("abc");
        DynamicWebhookEnableOutput dynamicWebhookEnableOutput = ClickupNewTaskTrigger.dynamicWebhookEnable(
    ...
    void testDynamicWebhookDisable() {
        ...
        ClickupNewTaskTrigger.dynamicWebhookDisable(
    ...
    void testDynamicWebhookRequest() {
        ...
        Map<String, Object> result = ClickupNewTaskTrigger.dynamicWebhookRequest(
