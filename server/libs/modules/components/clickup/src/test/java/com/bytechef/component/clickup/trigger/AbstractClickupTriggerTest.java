 ...
 */
abstract class AbstractClickupTriggerTest {
    ...
    protected MockedStatic<ClickupUtils> githubUtilsMockedStatic;
    protected String workflowExecutionId = "testWorkflowExecutionId";

    @BeforeEach
    public void beforeEach() {
        githubUtilsMockedStatic = mockStatic(ClickupUtils.class);
    }
