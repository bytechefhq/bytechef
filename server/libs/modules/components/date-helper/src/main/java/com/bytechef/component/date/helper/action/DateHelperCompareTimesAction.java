 ...
 */
public class DateHelperCompareTimesAction {

    public static final ModifiableActionDefinition ACTION_DEFINITION = action("compareTimes")
        .title("Compare Times")
        .description("Compare two time values, ignoring the dates/days.")
        .properties(
            dateTime(DATE_A)
                .label("Date A")
