...
class ResendEmailDeliveredTriggerTest {
    ...
    void testWebhookEnable(
        ...
        WebhookEnableOutput webhookEnableOutput = ResendEmailDeliveredTrigger.webhookEnable(
        ...
        assertEquals(
            Body.of(
                Map.of("events", List.of("email.delivered"), "endpoint", webhookUrl),
    ...
    void testWebhookDisable(
        ...
        ResendEmailDeliveredTrigger.webhookDisable(null, null, mockedParameters, "", mockedTriggerContext);
    ...
    void testWebhookRequest() {
        ...
        Object result = ResendEmailDeliveredTrigger.webhookRequest(
