 ...
 */
class AITableCreateRecordActionTest extends AbstractAITableActionTest {
    ...
    void testPerform() {
        ...
        Object result = AITableCreateRecordAction.perform(mockedParameters, mockedParameters, mockedContext);

        assertEquals(responseMap, result);

        Http.Body body = bodyArgumentCaptor.getValue();

        assertEquals(Map.of(RECORDS, List.of(Map.of(FIELDS, fieldMap))), body.getContent());
    }
