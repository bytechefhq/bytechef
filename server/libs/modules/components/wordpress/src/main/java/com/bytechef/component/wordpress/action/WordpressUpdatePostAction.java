 ...
 * @generated
 */
public class WordpressUpdatePostAction {
    public static final ComponentDsl.ModifiableActionDefinition ACTION_DEFINITION = action("updatePost")
        .title("Update Post")
        .description("Update a post.")
        .metadata(
            Map.of(
                "method", "PUT",
                "path", "/wp/v2/posts/{postId}", "bodyContentType", BodyContentType.JSON, "mimeType", "application/json"
        ...
        .properties(string("postId").label("Post ID")
            ...
            string("content").metadata(
                Map.of(
                    "type", PropertyType.BODY))
                .label("Content")
                .description("Content of the post, uses the WordPress Text Editor which supports HTML.")
                .required(false),
                ...
                "_links")
                    .properties(
                        ...
                        array("predecessor-version")
                            .items(object().properties(string("href").description("URL to the linked resource.")
                                ...
                                integer("id").description("id of the predecessor version.")
                                    .required(false))
                                .description("Predecessor version of this post."))
                            .description("Predecessor version of this post.")
                            .required(false),
                        array("wp:attachment")
                            .items(object().properties(string("href").description("URL to the linked resource.")
                        ...
                        array("wp:action-unfiltered-html")
                            ...
                            .description("Action link for unfiltered HTML editing.")
                            .required(false),
                        array("wp:action-sticky")
                            .items(object().properties(string("href").description("URL to the linked resource.")
                                .required(false))
                                .description("Link to top of this post."))
                            .description("Link to top of this post.")
                            .required(false),
                        array("wp:action-assign-author")
                            ...
                            .description("Action link to assign a new author to this post.")
                            .required(false),
                        array("wp:action-create-categories")
                            .items(object().properties(string("href").description("URL to the linked resource.")
                                .required(false))
                                .description("Action link to create a new category for this post."))
                            .description("Action link to create a new category for this post.")
                            .required(false),
                        array("wp:action-assign-categories")
                            .items(object().properties(string("href").description("URL to the linked resource.")
                                .required(false))
                                .description("Action link to assign a new category to this post."))
                            .description("Action link to assign a new category to this post.")
                            .required(false),
                        array("wp:action-assign-tags")
                            .items(object().properties(string("href").description("URL to the linked resource.")
                                .required(false))
                                .description("Action link to assign a new tag to this post."))
                            .description("Action link to assign a new tag to this post.")
                            .required(false),
                        array("wp:action-create-tags")
                            .items(object().properties(string("href").description("URL to the linked resource.")
                                .required(false))
                                .description("Action link to create a new tag for this post."))
                            .description("Action link to create a new tag for this post.")
                            .required(false),
        ...
        .help("", "https://docs.bytechef.io/reference/components/wordpress_v1#update-post");

    private WordpressUpdatePostAction() {
    }
}
