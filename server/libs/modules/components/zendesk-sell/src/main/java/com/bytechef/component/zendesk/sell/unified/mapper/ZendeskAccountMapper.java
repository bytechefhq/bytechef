 ...
 * @author Ivica Cardic
 */
public class ZendeskAccountMapper
    implements ProviderAccountMapper<ZendeskAccountInputModel, ZendeskAccountOutputModel> {

    @Override
    public ZendeskAccountInputModel desunify(
    ...
    public AccountUnifiedOutputModel unify(
        ZendeskAccountOutputModel outputModel, List<CustomFieldMapping> customFieldMappings) {
