...
import com.bytechef.component.google.search.console.property.GoogleSearchConsoleWmxSiteProperties;
 ...
 * @generated
 */
public class GoogleSearchConsoleGetSiteAction {
    public static final ComponentDsl.ModifiableActionDefinition ACTION_DEFINITION = action("getSite")
        .title("Get Site")
        ...
        .output(outputSchema(object().properties(GoogleSearchConsoleWmxSiteProperties.PROPERTIES)
            .description(
