 ...
 */
class GoogleWorkspaceAdminAssignRoleToUserActionTest {
    ...
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(ROLE_ID, "role-1", USER_ID, "user-1"));
    ...
    void testPerform() {
        ...
        Object result =
            GoogleWorkspaceAdminAssignRoleToUserAction.perform(mockedParameters, null, mockedContext);
        ...
        assertEquals("https://admin.googleapis.com/admin/directory/v1/customer/my_customer/roleassignments",
            stringArgumentCaptor.getValue());
        assertEquals(
            Body.of(Map.of(ROLE_ID, "role-1", "assignedTo", "user-1"), Http.BodyContentType.JSON),
