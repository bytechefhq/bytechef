 ...
 */
class GoogleWorkspaceAdminCreateUserActionTest {
    ...
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(FIRST_NAME, "name", LAST_NAME, "surname", EMAIL, "test@test.com", PASSWORD, "password",
            CHANGE_PASSWORD, true, ADDRESS, "Test Address 1", PHONE, "+123456789"));
    ...
    void testPerform() {
        ...
        Object result =
            GoogleWorkspaceAdminCreateUserAction.perform(mockedParameters, null, mockedContext);
        ...
        assertEquals("https://admin.googleapis.com/admin/directory/v1/users",
            stringArgumentCaptor.getValue());
        assertEquals(
            Body.of(Map.of(EMAIL, "test@test.com", PASSWORD, "password",
                "name", Map.of(FIRST_NAME, "name", LAST_NAME, "surname"),
                CHANGE_PASSWORD, true, ADDRESS, "Test Address 1",
                PHONE, "+123456789"), Http.BodyContentType.JSON),
