 ...
 */
class GoogleWorkspaceAdminSuspendUserActionTest {
    ...
    void testPerform() {
        ...
        Object result =
            GoogleWorkspaceAdminSuspendUserAction.perform(mockedParameters, null, mockedContext);
        ...
        assertEquals("https://admin.googleapis.com/admin/directory/v1/users/user-1",
            stringArgumentCaptor.getValue());
        assertEquals(
            Body.of(Map.of("suspended", true), Http.BodyContentType.JSON),
