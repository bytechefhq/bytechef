 ...
 */
public class GoogleDriveListFilesAction {
    ...
    public static final ModifiableActionDefinition ACTION_DEFINITION = action("listFiles")
        ...
        .perform(GoogleDriveListFilesAction::perform);

    private GoogleDriveListFilesAction() {
    }

    public static List<File> perform(Parameters inputParameters, Parameters connectionParameters, Context context) {
        return listFiles(inputParameters.getString(FOLDER_ID, "root"), false, connectionParameters);
    }
}
