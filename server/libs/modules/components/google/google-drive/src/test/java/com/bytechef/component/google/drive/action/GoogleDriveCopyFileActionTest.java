...
import static com.bytechef.component.google.drive.constant.GoogleDriveConstants.*;
...
public class GoogleDriveCopyFileActionTest extends AbstractGoogleDriveActionTest {
  ...
  private final File testFile =
          new File().setName("newFileName").setParents(Collections.singletonList("newFolderId")).setMimeType(
                  "application/pdf");
