 ...
 */
class GoogleDriveNewFileTriggerTest {
        ...
        try (MockedStatic<GoogleDriveUtils> googleDriveUtilsMockedStatic = mockStatic(GoogleDriveUtils.class)) {
            googleDriveUtilsMockedStatic
                .when(() -> GoogleDriveUtils.getPollOutput(
                    mockedParameters, mockedParameters, mockedParameters, mockedTriggerContext, true))
                .thenReturn(mockedPollPOutput);

            PollOutput pollOutput = GoogleDriveNewFileTrigger.poll(mockedParameters, mockedParameters, mockedParameters,
