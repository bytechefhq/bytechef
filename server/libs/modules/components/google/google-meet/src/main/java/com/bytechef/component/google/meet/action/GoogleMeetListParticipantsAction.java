...
public class GoogleMeetListParticipantsAction {
                                ...
                                object()
                                    .properties(
                                        ...
                                        string("latestEndTime")
                                            .description(
                                                "Time when the participant left the meeting for the last time. This can be "
                                                    +
                                                    "null if it's an active meeting."))))))
    ...
    public static Object perform(Parameters inputParameters, Parameters connectionParameters, Context context) {
        return context
            .http(http -> http.get(
                "https://meet.googleapis.com/v2/" + inputParameters.getRequiredString(CONFERENCE_RECORDS)
                    + "/participants"))
