...
class GoogleMapsNearbySearchActionTest {
    ...
    void testPerform() {
        ...
        try (MockedStatic<GoogleMapsUtils> mockedGoogleMapsUtils = mockStatic(GoogleMapsUtils.class)) {
            ...
            assertEquals(List.of("mockedAddress", "X-Goog-FieldMask",
                "places.accessibilityOptions,places.displayName,places.googleMapsLinks,places.location,places.businessStatus"),
