...
public class GoogleMapsGetRouteAction {
                            ...
                            .items(
                                object()
                                    ...
                                    .properties(
                                                ...
                                                object()
                                                    .properties(
                                                        integer("distanceMeters")
                                                            .description(
                                                                "Distance from origin and destination in meters."),
                                                        string("duration")
                                                            .description("Duration of the route in seconds."),
                                                        string("staticDuration")
                                                            .description("Static duration of the route in seconds."),
                                                        object("polyline")
                                                        ...
                                                        object("localizedValues")
                                                            .description("Localized values of the route.")
                                                            .properties(
                                                                object("distance")
                                        ...
                                        string("duration")
                                            .description("Duration of route in seconds."),
                                        string("staticDuration")
                                            .description("Static duration of route in seconds."),
                                        object("polyline")
                                            .description("Polyline of the route.")
                                            .properties(
                                                object("encodedPolyline")
                                                    .description("Encoded polyline of route.")),
                                        string("description")
                                            .description("Description of the route."),
                                        object("viewport")
                                            .description("Viewport of the route.")
                                            .properties(
                                                object("low")
                                                    .properties(
                                                        number("latitude"),
                                        ...
                                        object("travelAdvisory")
                                            .description("Route travel advisory."),
                                        object("localizedValues")
                                            .description("Localized values of the route.")
                                            .properties(
                                                object("distance")
    ...
    public static Map<String, Object> perform(
        ...
        Map<String, Object> originGeoLocation = getAddressLatLng(
            context, inputParameters.getRequiredString(ORIGIN));

        Map<String, Object> destinationGeoLocation = getAddressLatLng(
