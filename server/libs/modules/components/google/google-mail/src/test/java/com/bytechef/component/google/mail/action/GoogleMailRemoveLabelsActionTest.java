 ...
 */
class GoogleMailRemoveLabelsActionTest {
    ...
    void testPerform() throws IOException {
        ...
        try (MockedStatic<GoogleServices> googleServicesMockedStatic = mockStatic(GoogleServices.class)) {
            ...
            Message result = GoogleMailRemoveLabelsAction.perform(parameters, parameters, mock(ActionContext.class));
            ...
            ModifyMessageRequest expectedModifyMessageRequest = new ModifyMessageRequest()
                .setRemoveLabelIds(List.of("1", "2", "3"));
