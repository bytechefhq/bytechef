...
import static com.bytechef.component.google.mail.util.GoogleMailUtils.deleteMail;
...
public class GoogleMailDeleteMailAction {
    public static final ModifiableActionDefinition ACTION_DEFINITION = action("deleteMail")
        .title("Delete Mail")
        .description("Discard an email from your Gmail account to trash via Id")
        .properties(
            string(ID)
                .label("Message ID")
    ...
    public static Object perform(
        ...
        return deleteMail(inputParameters, gmail);
    }
