...
import static com.bytechef.component.google.contacts.action.GoogleContactsCreateGroupAction.OUTPUT_SCHEMA;
import static com.bytechef.component.google.contacts.action.GoogleContactsCreateGroupAction.PROPERTIES;
 ...
 */
public class GoogleContactsCreateGroupTool {
    ...
    public static final ClusterElementDefinition<SingleConnectionToolFunction> CLUSTER_ELEMENT_DEFINITION =
        ComponentDsl.<SingleConnectionToolFunction>clusterElement(CREATE_GROUP)
            ...
            .object(() -> GoogleContactsCreateGroupAction::perform);
}
