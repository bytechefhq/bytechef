...
class GoogleTasksUpdateTaskActionTest {
    ...
    void testPerform() throws Exception {
        Optional<? extends BasePerformFunction> basePerformFunction = GoogleTasksUpdateTaskAction.ACTION_DEFINITION
            .getPerform();
        ...
        assertEquals("/lists/id-1/tasks/task", stringArgumentCaptor.getValue());
        assertEquals(
