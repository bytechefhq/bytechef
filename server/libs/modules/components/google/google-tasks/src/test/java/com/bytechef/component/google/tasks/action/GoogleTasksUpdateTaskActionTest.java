 ...
 */
class GoogleTasksUpdateTaskActionTest {
    ...
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(LIST_ID, "id-1", TASK_ID, "task", TITLE, "test", STATUS, "needsAction", NOTES, "abc"));
    ...
    void testPerform() throws Exception {
        Optional<PerformFunction> performFunction = GoogleTasksUpdateTaskAction.ACTION_DEFINITION.getPerform();
        ...
        assertEquals("https://tasks.googleapis.com/tasks/v1/lists/id-1/tasks/task", stringArgumentCaptor.getValue());
        assertEquals(
