...
package com.bytechef.component.google.bigquery.connection;
...
public class GoogleBigQueryConnection {
    ...
    public static final ModifiableConnectionDefinition CONNECTION_DEFINITION = GoogleConnection.createConnection(
        ...
        1,
        "https://docs.bytechef.io/reference/components/google-bigquery_v1#connection-setup",
        (connection, context) -> Map.of(
            ...
            "https://www.googleapis.com/auth/bigquery.readonly", false,
