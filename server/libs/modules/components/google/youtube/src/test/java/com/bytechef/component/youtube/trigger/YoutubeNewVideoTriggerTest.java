...
class YoutubeNewVideoTriggerTest {
    ...
    void testWebhookEnable() {
        ...
        Assertions.assertNull(
            YoutubeNewVideoTrigger.webhookEnable(parameters, parameters, webhookUrl, workflowExecutionId,
    ...
    void testWebhookRequest() {
        ...
        Assertions.assertNull(
            YoutubeNewVideoTrigger.webhookRequest(parameters, parameters, mock(TriggerDefinition.HttpHeaders.class),
