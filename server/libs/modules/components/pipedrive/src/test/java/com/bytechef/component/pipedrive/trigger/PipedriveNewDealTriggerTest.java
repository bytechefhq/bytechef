 ...
 */
class PipedriveNewDealTriggerTest extends AbstractPipedriveTriggerTest {
    ...
    void testDynamicWebhookEnable() {
        ...
        pipedriveUtilsMockedStatic.when(
            () -> PipedriveUtils.subscribeWebhook("deal", ADDED, webhookUrl, mockedTriggerContext))
            .thenReturn(123);

        DynamicWebhookEnableOutput dynamicWebhookEnableOutput = PipedriveNewDealTrigger.dynamicWebhookEnable(
    ...
    void testDynamicWebhookRequest() {
        ...
        Object result = PipedriveNewDealTrigger.dynamicWebhookRequest(
