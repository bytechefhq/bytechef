 ...
 */
class PipedriveNewPersonTriggerTest extends AbstractPipedriveTriggerTest {
    ...
    void testDynamicWebhookEnable() {
        ...
        pipedriveUtilsMockedStatic.when(
            () -> PipedriveUtils.subscribeWebhook("person", ADDED, webhookUrl, mockedTriggerContext))
            .thenReturn(123);

        DynamicWebhookEnableOutput dynamicWebhookEnableOutput = PipedriveNewPersonTrigger.dynamicWebhookEnable(
    ...
    void testDynamicWebhookRequest() {
        ...
        Object result = PipedriveNewPersonTrigger.dynamicWebhookRequest(
