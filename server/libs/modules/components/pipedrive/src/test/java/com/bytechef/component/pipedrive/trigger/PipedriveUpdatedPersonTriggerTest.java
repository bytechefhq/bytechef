 ...
 */
class PipedriveUpdatedPersonTriggerTest extends AbstractPipedriveTriggerTest {
    ...
    void testDynamicWebhookEnable() {
        ...
        pipedriveUtilsMockedStatic.when(
            () -> PipedriveUtils.subscribeWebhook("person", UPDATED, webhookUrl, mockedTriggerContext))
            .thenReturn(123);

        DynamicWebhookEnableOutput dynamicWebhookEnableOutput = PipedriveUpdatedPersonTrigger.dynamicWebhookEnable(
    ...
    void testDynamicWebhookRequest() {
        ...
        Object result = PipedriveUpdatedPersonTrigger.dynamicWebhookRequest(
