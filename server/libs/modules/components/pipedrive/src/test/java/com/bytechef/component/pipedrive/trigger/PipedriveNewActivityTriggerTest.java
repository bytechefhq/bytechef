 ...
 */
class PipedriveNewActivityTriggerTest extends AbstractPipedriveTriggerTest {
    ...
    void testDynamicWebhookEnable() {
        ...
        pipedriveUtilsMockedStatic.when(
            () -> PipedriveUtils.subscribeWebhook("activity", ADDED, webhookUrl, mockedTriggerContext))
            .thenReturn(123);

        DynamicWebhookEnableOutput dynamicWebhookEnableOutput = PipedriveNewActivityTrigger.dynamicWebhookEnable(
    ...
    void testDynamicWebhookRequest() {
        ...
        Object result = PipedriveNewActivityTrigger.dynamicWebhookRequest(
