 ...
 * @author Ivica Cardic
 */
public class NewPersonTrigger {

    public static final TriggerDefinition TRIGGER_DEFINITION = ComponentDSL.trigger("newPerson")
        .display(
            display("New Person")
                .description("This trigger activates whenever a new person is added."))
        ...
        .exampleOutput(
            """
                ...
                """)
        .dynamicWebhookEnable(NewPersonTrigger::dynamicWebhookEnable)
        .dynamicWebhookDisable(NewPersonTrigger::dynamicWebhookDisable)
        .dynamicWebhookRequest(NewPersonTrigger::dynamicWebhookRequest);
