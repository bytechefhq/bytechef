...
public class PipedriveAddDealAction {
    public static final ComponentDSL.ModifiableActionDefinition ACTION_DEFINITION = action("addDeal")
        ...
        .outputSchema(bool("success").required(false), integer("email_messages_count").required(false),
            string("cc_email").required(false), integer("products_count").required(false),
            string("next_activity_date").required(false), string("next_activity_type").required(false),
            string("next_activity_duration").required(false), integer("id").required(false),
            ...
            string("pic_hash").required(false), string("visible_to").required(false), string("address").required(false),
