...
public class ActivityTypesActions {
    public static final List<ComponentDSL.ModifiableActionDefinition> ACTIONS = List.of(action("getActivityTypes")
        .display(
            display("Get all activity types")
        ...
        .output(object(null).properties(array("data").items(object(null).properties(integer("id").label("Id")
            ...
            string("name").label("Name")
                ...
                .required(false),
            string("icon_key").label("Icon_key")
                .description("Icon graphic to use for representing this activity type")
                .options(option("Task", "task"), option("Email", "email"), option("Meeting", "meeting"),
                    option("Deadline", "deadline"), option("Call", "call"), option("Lunch", "lunch"),
                    option("Calendar", "calendar"), option("Downarrow", "downarrow"), option("Document", "document"),
                    option("Smartphone", "smartphone"), option("Camera", "camera"), option("Scissors", "scissors"),
                    option("Cogs", "cogs"), option("Bubble", "bubble"), option("Uparrow", "uparrow"),
                    option("Checkbox", "checkbox"), option("Signpost", "signpost"), option("Shuffle", "shuffle"),
                    option("Addressbook", "addressbook"), option("Linegraph", "linegraph"),
                    option("Picture", "picture"), option("Car", "car"), option("World", "world"),
                    option("Search", "search"), option("Clip", "clip"), option("Sound", "sound"),
                    option("Brush", "brush"), option("Key", "key"), option("Padlock", "padlock"),
                    option("Pricetag", "pricetag"), option("Suitcase", "suitcase"), option("Finish", "finish"),
                    option("Plane", "plane"), option("Loop", "loop"), option("Wifi", "wifi"), option("Truck", "truck"),
                    option("Cart", "cart"), option("Bulb", "bulb"), option("Bell", "bell"),
            ...
            integer("order_nr").label("Order_nr")
                ...
                .required(false),
            string("key_string").label("Key_string")
                .description(
            ...
            bool("active_flag").label("Active_flag")
                ...
                .required(false),
            bool("is_custom_flag").label("Is_custom_flag")
