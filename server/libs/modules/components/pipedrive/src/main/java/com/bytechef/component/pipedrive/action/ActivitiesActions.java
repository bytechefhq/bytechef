...
public class ActivitiesActions {
    public static final List<ComponentDSL.ModifiableActionDefinition> ACTIONS = List.of(
            action("deleteActivities")
                    ...
                    .metadata(Map.of("requestMethod", "DELETE", "path", "/activities"))
            ...
            action("getActivities")
                    .display(display("Get all activities assigned to a particular user")
                            .description("Returns all activities assigned to a particular user."))
                    .metadata(Map.of("requestMethod", "GET", "path", "/activities"))
                    .properties(
                            integer("user_id")
                                    .label("User_id")
                                    .description(
                                            ...
                                            .items(object(null)
                                                    .properties(
                                                            ...
                                                            integer("notification_language_id")
                                                                    .label("Notification_language_id")
                                                                    .description(
                                                            ...
                                                            string("location_admin_area_level_2")
                                                                    .label("Location_admin_area_level_2")
                                                                    .description(
                                                            ...
                                                            string("location_admin_area_level_1")
                                                                    .label("Location_admin_area_level_1")
                                                                    .description(
                                                            ...
                                                            string("conference_meeting_client")
                                                                    .label("Conference_meeting_client")
                                                                    .description(
                                                            ...
                                                            integer("last_notification_user_id")
                                                                    .label("Last_notification_user_id")
                                                                    .description(
                                                            ...
                                                            string("calendar_sync_include_context")
                                                                    .label("Calendar_sync_include_context")
                                                                    .description(
            ...
            action("addActivity")
                    ...
                    .metadata(Map.of("requestMethod", "POST", "path", "/activities", "bodyContentType", "JSON"))
                    ...
                    .output(object(null)
                            .properties(
                                    ...
                                    string("add_time")
                                            ...
                                            .required(false),
                                    object("additional_data")
                                            .properties(integer("updates_story_id")
                                                    .label("Updates_story_id")
            ...
            action("deleteActivity")
                    ...
                    .metadata(Map.of("requestMethod", "DELETE", "path", "/activities/{id}"))
            ...
            action("getActivity")
                    .display(display("Get details of an activity")
                            .description("Returns the details of a specific activity."))
                    .metadata(Map.of("requestMethod", "GET", "path", "/activities/{id}"))
                    .properties(integer("id")
                            .label("Id")
                            .description("The ID of the activity")
                            .required(true)
            ...
            action("updateActivity")
                    ...
                    .metadata(Map.of("requestMethod", "PUT", "path", "/activities/{id}", "bodyContentType", "JSON"))
                    .properties(
                            integer("id")
                                    .label("Id")
                                    .description("The ID of the activity")
