 ...
 * @author Ivica Cardic
 */
public class NewDealTrigger {

    public static final TriggerDefinition TRIGGER_DEFINITION = ComponentDSL.trigger("newDeal")
        .display(
            display("New Deal")
                .description("This trigger activates whenever a new deal is added."))
        ...
        .exampleOutput("""
            ...
            """)
        .dynamicWebhookEnable(NewDealTrigger::dynamicWebhookEnable)
        .dynamicWebhookDisable(NewDealTrigger::dynamicWebhookDisable)
        .dynamicWebhookRequest(NewDealTrigger::dynamicWebhookRequest);
