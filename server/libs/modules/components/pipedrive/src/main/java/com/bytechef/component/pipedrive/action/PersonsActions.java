...
public class PersonsActions {
    public static final List<ComponentDSL.ModifiableActionDefinition> ACTIONS = List.of(
        action("deletePersons")
            ...
            .metadata(Map.of("requestMethod", "DELETE", "path", "/persons"))
            ...
            .output(object(null)
                .properties(
                    object("data")
                        .properties(array("id")
                            .items(integer(null).description("The list of deleted persons IDs"))
                            .label("Id")
        ...
        action("getPersons")
            .display(display("Get all persons").description("Returns all persons."))
            .metadata(Map.of("requestMethod", "GET", "path", "/persons"))
            .properties(
                integer("user_id")
                    .label("User_id")
                    .description(
        ...
        action("addPerson")
            ...
            .metadata(Map.of("requestMethod", "POST", "path", "/persons", "bodyContentType", "JSON"))
        ...
        action("searchPersons")
            ...
            .metadata(Map.of("requestMethod", "GET", "path", "/persons/search"))
            .properties(
                string("term")
                    .label("Term")
                    .description(
        ...
        action("deletePerson")
            ...
            .metadata(Map.of("requestMethod", "DELETE", "path", "/persons/{id}"))
        ...
        action("getPerson")
            ...
            .metadata(Map.of("requestMethod", "GET", "path", "/persons/{id}"))
            .properties(integer("id")
                .label("Id")
                .description("The ID of the person")
                .required(true)
        ...
        action("updatePerson")
            ...
            .metadata(Map.of("requestMethod", "PUT", "path", "/persons/{id}", "bodyContentType", "JSON"))
            .properties(
                integer("id")
                    .label("Id")
                    .description("The ID of the person")
        ...
        action("getPersonDeals")
            .display(display("List deals associated with a person")
                .description("Lists deals associated with a person."))
            .metadata(Map.of("requestMethod", "GET", "path", "/persons/{id}/deals"))
            .properties(
                integer("id")
                    .label("Id")
                    .description("The ID of the person")
        ...
        action("mergePersons")
            ...
            .metadata(Map.of("requestMethod", "PUT", "path", "/persons/{id}/merge", "bodyContentType", "JSON"))
            .properties(
                integer("id")
                    .label("Id")
                    .description("The ID of the person")
            ...
            .output(object(null)
                .properties(
                    ...
                    integer("participant_open_deals_count")
                        .label("Participant_open_deals_count")
                    ...
                    integer("participant_closed_deals_count")
                        .label("Participant_closed_deals_count")
