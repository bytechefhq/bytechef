...
public class UsersActions {
    public static final List<ComponentDSL.ModifiableActionDefinition> ACTIONS = List.of(action("getUsers")
        .display(
        ...
        .output(object(null).properties(array("data").items(object(null).properties(integer("id").label("Id")
            ...
            string("phone").label("Phone")
                ...
                .required(false),
            bool("activated").label("Activated")
                .description("Boolean that indicates whether the user is activated")
                .required(false),
            string("last_login").label("Last_login")
                .description("The last login date and time of the user. Format: YYYY-MM-DD HH:MM:SS")
                .required(false),
            string("created").label("Created")
                .description("The creation date and time of the user. Format: YYYY-MM-DD HH:MM:SS")
                .required(false),
            string("modified").label("Modified")
                .description("The last modification date and time of the user. Format: YYYY-MM-DD HH:MM:SS")
                .required(false),
            bool("has_created_company").label("Has_created_company")
                .description("Boolean that indicates whether the user has created a company")
                .required(false),
            array("access").items(object(null).properties(string("app").label("App")
                .options(option("Sales", "sales"), option("Projects", "projects"), option("Campaigns", "campaigns"),
                    option("Global", "global"), option("Account_settings", "account_settings"))
                .required(false),
                bool("admin").label("Admin")
                    .required(false),
                string("permission_set_id").label("Permission_set_id")
                    .required(false)))
                .placeholder("Add")
                .label("Access")
                .required(false),
            bool("active_flag").label("Active_flag")
                .description("Boolean that indicates whether the user is activated")
                .required(false),
            string("timezone_name").label("Timezone_name")
                .description("The user timezone name")
                .required(false),
            string("timezone_offset").label("Timezone_offset")
                .description("The user timezone offset")
                .required(false),
            integer("role_id").label("Role_id")
        ...
        action("findUsersByName")
            ...
            .properties(string("term").label("Term")
                ...
                .metadata(
                    Map.of(
                        "type", "QUERY")),
                number("search_by_email").label("Search_by_email")
                    .description(
