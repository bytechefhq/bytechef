 ...
 * @author Ivica Cardic
 */
public class UpdatedOrganizationTrigger {

    public static final TriggerDefinition TRIGGER_DEFINITION = ComponentDSL.trigger("updatedOrganization")
        .display(
            display("Updated Organization")
                .description("This trigger activates whenever an existing organization is updated."))
        ...
        .exampleOutput(
            """
                ...
                """)
        .dynamicWebhookEnable(UpdatedOrganizationTrigger::dynamicWebhookEnable)
        .dynamicWebhookDisable(UpdatedOrganizationTrigger::dynamicWebhookDisable)
        .dynamicWebhookRequest(UpdatedOrganizationTrigger::dynamicWebhookRequest);
