...
public class FiltersActions {
    public static final List<ComponentDSL.ModifiableActionDefinition> ACTIONS = List.of(
        action("getFilters")
            .display(display("Get all filters").description("Returns data about all filters."))
            .metadata(Map.of("requestMethod", "GET", "path", "/filters"))
                        ...
                        .items(object(null)
                            .properties(
                                ...
                                integer("visible_to")
                                    ...
                                    .required(false),
                                integer("custom_view_id")
                                    .label("Custom_view_id")
