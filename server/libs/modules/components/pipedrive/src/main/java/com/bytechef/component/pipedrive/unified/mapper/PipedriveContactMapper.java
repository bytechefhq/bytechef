 ...
 * @author Ivica Cardic
 */
public class PipedriveContactMapper
    implements ProviderContactMapper<PipedriveContactInputModel, PipedriveContactOutputModel> {

    @Override
    public PipedriveContactInputModel desunify(
    ...
    public ContactUnifiedOutputModel unify(
        PipedriveContactOutputModel outputModel, List<CustomFieldMapping> customFieldMappings) {
