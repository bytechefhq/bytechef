 ...
 * @author Ivica Cardic
 */
public class UpdatedDealTrigger {

    public static final TriggerDefinition TRIGGER_DEFINITION = ComponentDSL.trigger("updatedDeal")
        .display(
            display("Updated Deal")
                .description("This trigger activates whenever an existing deal is updated."))
        ...
        .exampleOutput("""
            ...
            """)
        .dynamicWebhookEnable(UpdatedDealTrigger::dynamicWebhookEnable)
        .dynamicWebhookDisable(UpdatedDealTrigger::dynamicWebhookDisable)
        .dynamicWebhookRequest(UpdatedDealTrigger::dynamicWebhookRequest);
