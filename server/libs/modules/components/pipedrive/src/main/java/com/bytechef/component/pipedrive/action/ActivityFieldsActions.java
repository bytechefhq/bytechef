...
public class ActivityFieldsActions {
    public static final List<ComponentDSL.ModifiableActionDefinition> ACTIONS = List.of(
        action("getActivityFields")
            .display(display("Get all activity fields").description("Returns all activity fields."))
            .metadata(Map.of("requestMethod", "GET", "path", "/activityFields"))
            .properties()
            .output(object(null)
                .properties(
                    array("data")
                            ...
                            .properties(
                                ...
                                string("field_type")
                                    ...
                                    .options(
                                        ...
                                        option("User", "user"),
                                        option("Varchar", "varchar"),
                                        option("Varchar_auto", "varchar_auto"),
                                ...
                                string("update_time")
                                    ...
                                    .required(false),
                                integer("last_updated_by_user_id")
                                    .label("Last_updated_by_user_id")
                                    .description(
                                ...
                                bool("edit_flag")
                                    ...
                                    .required(false),
                                bool("index_visible_flag")
                                    .label("Index_visible_flag")
                                    .description("Not used")
                                    .required(false),
                                bool("details_visible_flag")
                                    .label("Details_visible_flag")
                                    .description("Not used")
                                    .required(false),
                                bool("add_visible_flag")
                                    .label("Add_visible_flag")
                                    .description("Not used")
                                    .required(false),
                                bool("important_flag")
                                    .label("Important_flag")
                                    .description("Not used")
                                    .required(false),
                                bool("bulk_edit_allowed")
                                    .label("Bulk_edit_allowed")
                                    .description(
                                        "Whether or not the field of an item can be edited in bulk")
                                    .required(false),
                                bool("searchable_flag")
                                    .label("Searchable_flag")
                                    .description(
                                        "Whether or not items can be searched by this field")
                                    .required(false),
                                bool("filtering_allowed")
                                    .label("Filtering_allowed")
                                    .description(
