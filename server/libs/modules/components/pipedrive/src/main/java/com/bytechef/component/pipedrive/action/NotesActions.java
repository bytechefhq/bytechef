...
public class NotesActions {
    public static final List<ComponentDSL.ModifiableActionDefinition> ACTIONS = List.of(
        action("addNote")
            .display(display("Add a note").description("Adds a new note."))
            .metadata(Map.of("requestMethod", "POST", "path", "/notes", "bodyContentType", "JSON"))
            .properties(object(null)
                .properties(
                    number("pinned_to_organization_flag")
                        .label("Pinned_to_organization_flag")
                        .description(
                    ...
                    integer("org_id")
                        ...
                        .required(false),
                    number("pinned_to_lead_flag")
                        .label("Pinned_to_lead_flag")
                        .description(
                    ...
                    string("add_time")
                        ...
                        .required(false),
                    number("pinned_to_person_flag")
                        .label("Pinned_to_person_flag")
                        .description(
                    ...
                    string("lead_id")
                        ...
                        .required(false),
                    number("pinned_to_deal_flag")
                        .label("Pinned_to_deal_flag")
                        .description(
