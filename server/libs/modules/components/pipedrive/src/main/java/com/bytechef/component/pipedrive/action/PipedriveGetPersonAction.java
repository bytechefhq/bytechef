            ...
            object()
                .properties(
                    object("additional_data")
                        .properties(string("dropbox_email").description("Dropbox email for the person")
                            .required(false))
                        .required(false),
            ...
            Map.<String, Object>ofEntries(Map.entry("success", true),
                Map.entry("data",
                    Map.<String, Object>ofEntries(Map.entry("id", 1), Map.entry("company_id", 12),
                        ...
                        Map.entry("name", "Will Smith"), Map.entry("first_name", "Will"),
                        ...
                        Map.entry("phone",
                            List.of(
                                Map.<String, Object>ofEntries(Map.entry("value", 12345.0), Map.entry("primary", true),
