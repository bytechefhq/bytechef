...
public class DealsActions {
    public static final List<ComponentDSL.ModifiableActionDefinition> ACTIONS = List.of(action("deleteDeals")
        .display(
        ...
        .output(object(null).properties(bool("success").label("Success")
            ...
            .required(false),
            object("data").properties(array("id").items(integer(null).description("The list of deleted deals IDs"))
                .placeholder("Add")
                .label("Id")
        ...
        action("addDeal")
            ...
            .properties(object(null).properties(date("expected_close_date").label("Expected_close_date")
        ...
        action("searchDeals")
            ...
            .properties(string("term").label("Term")
                ...
                string("fields").label("Fields")
                    ...
                    .options(option("Custom_fields", "custom_fields"), option("Notes", "notes"),
                        option("Title", "title"))
                    .required(false)
                    .metadata(
                        Map.of(
                    ...
                    null)
                        .properties(
                            ...
                            bool("success").label("Success")
                                .description("If the response is successful or not")
                                .required(false),
                            object("additional_data").properties(object("pagination").properties(
                                integer("start").label("Start")
                                    .description("Pagination start")
                                    .required(false),
                                integer("limit").label("Limit")
        ...
        action("getDealsTimeline")
            ...
            .properties(date("start_date").label("Start_date")
                ...
                string("interval").label("Interval")
                    ...
                    .options(option("Day", "day"), option("Week", "week"), option("Month", "month"),
                        option("Quarter", "quarter"))
                    .required(true)
                    .metadata(
                        Map.of(
                            "type", PropertyType.QUERY)),
                integer("amount").label("Amount")
                    .description(
                ...
                integer("filter_id").label("Filter_id")
                    ...
                    .metadata(
                        Map.of(
                            "type", PropertyType.QUERY)),
                number("exclude_deals").label("Exclude_deals")
                    .description(
            ...
            .output(object(null).properties(bool("success").label("Success")
                .description("If the response is successful or not")
                .required(false),
                object("data").properties(string("period_start").label("Period_start")
                    .description("The start date and time of the period")
                    .required(false),
                    string("period_end").label("Period_end")
                        .description("The end date and time of the period")
                        .required(false),
                    array("deals").items(object(null).properties(
                        integer("email_messages_count").label("Email_messages_count")
                            .description("The number of emails associated with the deal")
                            .required(false),
                        string("cc_email").label("Cc_email")
                        ...
                        integer("person_id").label("Person_id")
                            .description("The ID of the person associated with the deal")
                            .required(false),
                        integer("creator_user_id").label("Creator_user_id")
                            .description("The ID of the deal creator")
                            .required(false),
                        date("expected_close_date").label("Expected_close_date")
                            .description("The expected close date of the deal")
                        ...
                        .label("Deals")
                        .required(false),
                    object("totals").properties(integer("count").label("Count")
                        .description("The number of deals for the given period")
                        .required(false),
                        object("values").label("Values")
                            .description("The total values of deals grouped by deal currency")
                            .required(false),
                        object("weighted_values").label("Weighted_values")
                            .description(
                        ...
                        object("weighted_open_values").label("Weighted_open_values")
                            ...
                            .required(false),
                        integer("won_count").label("Won_count")
                            .description("The number of won deals for the given period")
                            .required(false),
                        object("won_values").label("Won_values")
        ...
        action("updateDeal")
            ...
            .metadata(
                Map.of(
                    "requestMethod", "PUT",
                    "path", "/deals/{id}", "bodyContentType", BodyContentType.JSON, "mimeType", "application/json"
            ...
            .properties(integer("id").label("Id")
                ...
                .metadata(
                    Map.of(
                        "type", PropertyType.PATH)),
                object(null).properties(date("expected_close_date").label("Expected_close_date")
                    .description("The expected close date of the deal. In ISO 8601 format: YYYY-MM-DD.")
                    .required(false),
                    integer("stage_id").label("Stage_id")
                        .description(
        ...
        action("mergeDeals")
            ...
            .metadata(
                Map.of(
                    "requestMethod", "PUT",
                    "path", "/deals/{id}/merge", "bodyContentType", BodyContentType.JSON, "mimeType", "application/json"
        ...
        action("getDealUsers")
            ...
            .output(object(null)
                .properties(
                    object("data")
                        .properties(array("id").items(integer(null).description("The list of permitted users IDs"))
                            .placeholder("Add")
                            .label("Id")
        ...
        action("getDealPersons")
            ...
            .output(object(null).properties(object("additional_data").properties(integer("start").label("Start")
                ...
                .required(false),
                array("data")
                    .items(object(null).properties(integer("related_closed_deals_count")
                ...
                object("related_objects")
                    .properties(object("organization").properties(string("address").label("Address")
                        .description("The address of the organization")
                        .required(false),
                        integer("owner_id").label("Owner_id")
                            .description("The ID of the owner of the organization that is associated with the item")
