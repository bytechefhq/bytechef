...
public class LeadsActions {
    public static final List<ComponentDSL.ModifiableActionDefinition> ACTIONS = List.of(action("getLeads")
        .display(
        ...
        action("addLead")
            ...
            .properties(object(null).properties(string("title").label("Title")
                ...
                array("label_ids")
                    .items(
                        string(null).description("The IDs of the lead labels which will be associated with the lead"))
                    .placeholder("Add")
                    .label("Label_ids")
            ...
            .output(object(null).properties(bool("success").label("Success")
                ...
                object("data").properties(string("id").label("Id")
                    ...
                    array("label_ids")
                        .items(
                            string(null).description("The IDs of the lead labels which are associated with the lead"))
                        .placeholder("Add")
                        .label("Label_ids")
                        .description("The IDs of the lead labels which are associated with the lead")
                        .required(false),
