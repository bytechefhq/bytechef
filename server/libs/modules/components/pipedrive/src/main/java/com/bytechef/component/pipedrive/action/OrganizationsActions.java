...
public class OrganizationsActions {
    public static final List<ComponentDSL.ModifiableActionDefinition> ACTIONS = List.of(
            action("deleteOrganizations")
                    ...
                    .metadata(Map.of("requestMethod", "DELETE", "path", "/organizations"))
            ...
            action("getOrganizations")
                    .display(display("Get all organizations").description("Returns all organizations."))
                    .metadata(Map.of("requestMethod", "GET", "path", "/organizations"))
                    .properties(
                            integer("user_id")
                                    .label("User_id")
                                    .description(
                                            ...
                                            .items(object(null)
                                                    .properties(
                                                            ...
                                                            string("address_admin_area_level_2")
                                                                    .label("Address_admin_area_level_2")
                                                                    .description(
                                                            ...
                                                            string("address_admin_area_level_1")
                                                                    .label("Address_admin_area_level_1")
                                                                    .description(
                                                            ...
                                                            string("address_formatted_address")
                                                                    .label("Address_formatted_address")
            ...
            action("addOrganization")
                    ...
                    .metadata(Map.of("requestMethod", "POST", "path", "/organizations", "bodyContentType", "JSON"))
            ...
            action("searchOrganization")
                    ...
                    .metadata(Map.of("requestMethod", "GET", "path", "/organizations/search"))
                    .properties(
                            string("term")
                                    .label("Term")
                                    .description(
            ...
            action("deleteOrganization")
                    ...
                    .metadata(Map.of("requestMethod", "DELETE", "path", "/organizations/{id}"))
            ...
            action("getOrganization")
                    ...
                    .metadata(Map.of("requestMethod", "GET", "path", "/organizations/{id}"))
                    .properties(integer("id")
                            .label("Id")
                            .description("The ID of the organization")
                            .required(true)
            ...
            action("updateOrganization")
                    .display(
                            display("Update an organization").description("Updates the properties of an organization."))
                    .metadata(Map.of("requestMethod", "PUT", "path", "/organizations/{id}", "bodyContentType", "JSON"))
                    .properties(
                            integer("id")
                                    .label("Id")
                                    .description("The ID of the organization")
            ...
            action("getOrganizationDeals")
                    .display(display("List deals associated with an organization")
                            .description("Lists deals associated with an organization."))
                    .metadata(Map.of("requestMethod", "GET", "path", "/organizations/{id}/deals"))
                    .properties(
                            integer("id")
                                    .label("Id")
                                    .description("The ID of the organization")
                            ...
                            string("sort")
                                    ...
                                    .required(false)
                                    .metadata(Map.of("type", "QUERY")),
                            number("only_primary_association")
                                    .label("Only_primary_association")
                                    .description(
            ...
            action("mergeOrganizations")
                    ...
                    .metadata(Map.of(
                            "requestMethod", "PUT", "path", "/organizations/{id}/merge", "bodyContentType", "JSON"))
                    .properties(
                            integer("id")
                                    .label("Id")
                                    .description("The ID of the organization")
