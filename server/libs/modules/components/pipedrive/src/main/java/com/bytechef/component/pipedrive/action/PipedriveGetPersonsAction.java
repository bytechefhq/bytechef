    ...
    public static final ComponentDSL.ModifiableActionDefinition ACTION_DEFINITION = action("getPersons")
        ...
        .outputSchema(
            object("additional_data")
                ...
                .required(false),
            array("data")
                .items(integer("related_closed_deals_count").required(false),
                    integer("email_messages_count").required(false), string("cc_email").required(false),
                    string("name").required(false), integer("has_pic").required(false),
                    bool("active_flag").required(false), integer("id").required(false),
                    integer("value").required(false), string("email").required(false),
                    ...
                    integer("id").required(false), string("org_name").required(false),
                    string("first_name").required(false),
                    array("email")
                    ...
                    integer("related_won_deals_count").required(false),
                    string("last_incoming_mail_time").required(false), string("first_char").required(false),
                    integer("undone_activities_count").required(false), integer("closed_deals_count").required(false),
                    string("last_name").required(false), string("last_activity_date").required(false),
                    ...
                    string("name").required(false), bool("active_flag").required(false),
                    ...
                    string("name").required(false), integer("lost_deals_count").required(false),
