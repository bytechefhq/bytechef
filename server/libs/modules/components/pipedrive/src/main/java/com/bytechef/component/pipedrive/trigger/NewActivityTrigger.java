...
public class NewActivityTrigger {
    ...
    public static final TriggerDefinition TRIGGER_DEFINITION = ComponentDSL.trigger("newActivity")
        ...
        .exampleOutput("""
            ...
            """)
        .dynamicWebhookEnable(NewActivityTrigger::dynamicWebhookEnable)
        .dynamicWebhookDisable(NewActivityTrigger::dynamicWebhookDisable)
        .dynamicWebhookRequest(NewActivityTrigger::dynamicWebhookRequest);
