...
public class StagesActions {
    public static final List<ComponentDSL.ModifiableActionDefinition> ACTIONS = List.of(
        action("getStages")
            .display(display("Get all stages").description("Returns data about all stages."))
            .metadata(Map.of("requestMethod", "GET", "path", "/stages"))
            .properties(integer("pipeline_id")
                .label("Pipeline_id")
                .description(
                        ...
                        .items(object(null)
                            .properties(
                                string("update_time")
                                    ...
                                    .required(false),
                                bool("pipeline_deal_probability")
                                    .label("Pipeline_deal_probability")
                                    .description(
        ...
        action("getStage")
            .display(display("Get one stage").description("Returns data about a specific stage."))
            .metadata(Map.of("requestMethod", "GET", "path", "/stages/{id}"))
            .properties(
                integer("id")
                    .label("Id")
                    .description("The ID of the stage")
            ...
            .output(object(null)
                .properties(
                    ...
                    object("deals_summary")
                        .properties(
                            object("per_stages")
                                .properties(object("STAGE_ID")
                                    .properties(object("CURRENCY_ID")
                                        .properties(
                                            integer("count")
                                                .label("Count")
                                                .description(
                                ...
                                .required(false),
                            object("per_currency")
                                .properties(integer("CURRENCY_ID")
                                    .label("CURRENCY_ID")
                                    .description(
