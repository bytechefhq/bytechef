    ...
    public static final TriggerDefinition TRIGGER_DEFINITION = ComponentDSL.trigger("newOrganization")
        ...
        .exampleOutput(
            """
                ...
                """)
        .dynamicWebhookEnable(NewOrganizationTrigger::dynamicWebhookEnable)
        .dynamicWebhookDisable(NewOrganizationTrigger::dynamicWebhookDisable)
        .dynamicWebhookRequest(NewOrganizationTrigger::dynamicWebhookRequest);
