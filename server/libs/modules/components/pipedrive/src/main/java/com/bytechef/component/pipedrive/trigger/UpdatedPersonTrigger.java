 ...
 * @author Ivica Cardic
 */
public class UpdatedPersonTrigger {

    public static final TriggerDefinition TRIGGER_DEFINITION = ComponentDSL.trigger("updatedPerson")
        .display(
            display("Updated Person")
                .description("This trigger activates whenever an existing person is updated."))
        ...
        .exampleOutput(
            """
                ...
                """)
        .dynamicWebhookEnable(UpdatedPersonTrigger::dynamicWebhookEnable)
        .dynamicWebhookDisable(UpdatedPersonTrigger::dynamicWebhookDisable)
        .dynamicWebhookRequest(UpdatedPersonTrigger::dynamicWebhookRequest);
        ...
        return new DynamicWebhookEnableOutput(
            Map.of(
                ...
                PipedriveUtils.subscribeWebhook(
                    connection.getBaseUri(), "person", "updated", context.webhookUrl())),
            null);
    }
}
