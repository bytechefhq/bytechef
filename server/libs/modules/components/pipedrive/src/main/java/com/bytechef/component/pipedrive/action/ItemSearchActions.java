...
public class ItemSearchActions {
    public static final List<ComponentDSL.ModifiableActionDefinition> ACTIONS = List.of(
        action("searchItem")
            .display(display("Perform a search from multiple item types")
                .description("Performs a search from your choice of item types and fields."))
            .metadata(Map.of("requestMethod", "GET", "path", "/itemSearch"))
            .properties(
                string("term")
                    .label("Term")
                    .description(
                ...
                string("item_types")
                    ...
                    .options(
                        ...
                        option("Lead", "lead"),
                        option("File", "file"),
                        option("Mail_attachment", "mail_attachment"),
                ...
                string("fields")
                    ...
                    .options(
                        ...
                        option("Name", "name"),
                        option("Notes", "notes"),
                        option("Organization_name", "organization_name"),
                        option("Person_name", "person_name"),
                        option("Phone", "phone"),
                        option("Title", "title"),
                        option("Description", "description"))
                    .required(false)
                    .metadata(Map.of("type", "QUERY")),
                bool("search_for_related_items")
                    .label("Search_for_related_items")
                    .description(
                ...
                string("include_fields")
                    ...
                    .options(
                        option("Deal.cc_email", "deal.cc_email"),
                        option("Person.picture", "person.picture"),
        ...
        action("searchItemByField")
            ...
            .metadata(Map.of("requestMethod", "GET", "path", "/itemSearch/field"))
            .properties(
                string("term")
                    .label("Term")
                    .description(
                ...
                string("field_type")
                    ...
                    .options(
                        option("DealField", "dealField"),
                        option("LeadField", "leadField"),
                        option("PersonField", "personField"),
                        option("OrganizationField", "organizationField"),
                        option("ProductField", "productField"),
                        option("ProjectField", "projectField"))
                    .required(true)
                    .metadata(Map.of("type", "QUERY")),
                bool("exact_match")
                    .label("Exact_match")
                ...
                string("field_key")
                    ...
                    .required(true)
                    .metadata(Map.of("type", "QUERY")),
                bool("return_item_ids")
                    .label("Return_item_ids")
                    .description(
            ...
            .output(object(null)
                .properties(
                    ...
                    object("additional_data")
                        ...
                        .label("Additional_data")
                        .required(false))
                .metadata(Map.of("responseType", "TEXT")))
            .exampleOutput(
