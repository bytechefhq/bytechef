...
public class PipelinesActions {
    public static final List<ComponentDSL.ModifiableActionDefinition> ACTIONS = List.of(
        action("getPipelines")
            .display(display("Get all pipelines").description("Returns data about all pipelines."))
            .metadata(Map.of("requestMethod", "GET", "path", "/pipelines"))
            .properties()
            .output(object(null)
                .properties(
                    array("data")
        ...
        action("getPipeline")
            ...
            .metadata(Map.of("requestMethod", "GET", "path", "/pipelines/{id}"))
            .properties(
                integer("id")
                    .label("Id")
                    .description("The ID of the pipeline")
