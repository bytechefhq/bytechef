...
public class DealFieldsActions {
    public static final List<ComponentDSL.ModifiableActionDefinition> ACTIONS = List.of(
            action("getDealFields")
                    .display(display("Get all deal fields").description("Returns data about all deal fields."))
                    .metadata(Map.of("requestMethod", "GET", "path", "/dealFields"))
                    .properties(
                            integer("start")
                                    .label("Start")
