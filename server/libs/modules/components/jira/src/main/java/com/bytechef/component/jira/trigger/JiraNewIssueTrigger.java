...
public class JiraNewIssueTrigger {
    ...
    public static final ModifiableTriggerDefinition TRIGGER_DEFINITION = trigger(NEW_ISSUE)
        ...
        .dynamicWebhookEnable(JiraNewIssueTrigger::dynamicWebhookEnable)
        .dynamicWebhookDisable(JiraNewIssueTrigger::dynamicWebhookDisable)
        .dynamicWebhookRequest(JiraNewIssueTrigger::dynamicWebhookRequest);
