 ...
 * @generated
 */
public class HistoryMetadataProperties {
    public static final List<Property> PROPERTIES = List.of(string("type").label("Type")
        ...
        string("emailDescriptionKey").label("EmailDescriptionKey")
            ...
            .required(false),
        object("actor").properties(HistoryMetadataParticipantProperties.PROPERTIES)
            .label("Actor")
            .description("Details of user or system associated with a issue history metadata item.")
            .required(false),
        object("generator").properties(HistoryMetadataParticipantProperties.PROPERTIES)
            .label("Generator")
            .description("Details of user or system associated with a issue history metadata item.")
            .required(false),
        object("cause").properties(HistoryMetadataParticipantProperties.PROPERTIES)
            .label("Cause")
            .description("Details of user or system associated with a issue history metadata item.")
            .required(false),
