...
import com.bytechef.component.jira.property.IssueBeanProperties;
        ...
        .properties(string("issueIdOrKey").label("IssueIdOrKey")
            ...
            bool("updateHistory").label("UpdateHistory")
                ...
                .metadata(
                    Map.of(
                        "type", PropertyType.QUERY)))
        .output(object(null).properties(IssueBeanProperties.PROPERTIES)
