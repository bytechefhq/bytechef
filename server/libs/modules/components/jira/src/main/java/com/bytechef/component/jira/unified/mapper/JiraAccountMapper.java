 ...
 * @author Ivica Cardic
 */
public class JiraAccountMapper
    implements ProviderAccountMapper<JiraAccountInputModel, JiraAccountOutputModel> {

    @Override
    public JiraAccountInputModel desunify(
    ...
    public AccountUnifiedOutputModel unify(
        JiraAccountOutputModel outputModel, List<CustomFieldMapping> customFieldMappings) {
