...
public class IssueSearchActions {
    public static final List<ComponentDSL.ModifiableActionDefinition> ACTIONS = List.of(
            action("searchForIssuesUsingJql")
                    ...
                    .metadata(Map.of("requestMethod", "GET", "path", "/rest/api/3/search"))
                    .properties(
                            string("jql")
                                    .label("Jql")
                                    .description(
                            ...
                            bool("fieldsByKeys")
                                    ...
                                    .metadata(Map.of("type", "QUERY")))
                    .output(object(null)
                            .properties(SearchResultsSchema.COMPONENT_SCHEMA)
