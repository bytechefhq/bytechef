 ...
 * @generated
 */
public class IssueTransitionProperties {
    public static final List<Property> PROPERTIES = List.of(string("id").label("Id")
        ...
        string("name").label("Name")
            ...
            .required(false),
        object("to").properties(StatusDetailsProperties.PROPERTIES)
            .label("To")
        ...
        bool("isConditional").label("IsConditional")
            ...
            .required(false),
        object("fields").additionalProperties(object().properties(FieldMetadataProperties.PROPERTIES))
            .placeholder("Add")
            .label("Fields")
            .description(
