...
import com.bytechef.component.jira.schema.IssueBeanSchema;
 ...
 * @generated
 */
public class IssuesActions {
    public static final List<ComponentDSL.ModifiableActionDefinition> ACTIONS = List.of(action("getIssue")
        .display(
            display("Get issue")
        ...
        .properties(string("issueIdOrKey").label("IssueIdOrKey")
            ...
            array("properties").items(string(null))
                ...
                .metadata(
                    Map.of(
                        "type", PropertyType.QUERY)),
            bool("updateHistory").label("UpdateHistory")
                .description(
                ...
                .metadata(
                    Map.of(
                        "type", PropertyType.QUERY)))
        .output(object(null).properties(IssueBeanSchema.COMPONENT_SCHEMA)
