 ...
 * @author Ivica Cardic
 */
class SecretKeyDetectorUtilsObfuscationTest {
    ...
    void testSecretSplitByBackslashNewlineIsNotReassembledButPrefixHalfStillMatchesWhenLongEnough() {
        ...
        List<SecretMatch> shortMatches = SecretKeyDetectorUtils.detect(splitShort, Permissiveness.BALANCED);
    ...
    void testSecretSplitAcrossNewlinesDoesNotReassembleIntoSingleMatch() {
        ...
        List<SecretMatch> matches = SecretKeyDetectorUtils.detect(splitSecret, Permissiveness.BALANCED);
    ...
    void testUrlEncodedSecretIsNotDecodedButMayTripHighEntropyHeuristic() {
        ...
        List<SecretMatch> matches = SecretKeyDetectorUtils.detect(urlEncoded, Permissiveness.BALANCED);
    ...
    void testJsonEscapedSecretIsMatchedIfEscapesDontBreakThePrefixContiguity() {
        ...
        List<SecretMatch> matches = SecretKeyDetectorUtils.detect(jsonEscaped, Permissiveness.BALANCED);
    ...
    void testJsonEscapedSecretWithUnicodeEscapeInThePrefixDoesNotMatch() {
        ...
        List<SecretMatch> matches = SecretKeyDetectorUtils.detect(unicodeEscaped, Permissiveness.BALANCED);
