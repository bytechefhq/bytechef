...
public final class GuardrailsConstants {
    ...
    /**
     * Metadata flag set when SanitizeTextAdvisor replaced the assistant payload with the sanitizer-failure placeholder.
     */
    public static final String SANITIZE_WITHHELD_KEY = "guardrail.sanitizeWithheld";
    ...
    public static final boolean DEFAULT_VALIDATE_INPUT = true;

    public static final boolean DEFAULT_VALIDATE_OUTPUT = true;

    public static final ComponentDsl.ModifiableBooleanProperty VALIDATE_INPUT_PROPERTY = bool(VALIDATE_INPUT)
        .label("Validate Input")
        .description("Check user input before sending to model.")
        .defaultValue(DEFAULT_VALIDATE_INPUT);

    public static final ComponentDsl.ModifiableBooleanProperty VALIDATE_OUTPUT_PROPERTY = bool(VALIDATE_OUTPUT)
        .label("Validate Output")
        .description("Check model response before returning.")
        .defaultValue(DEFAULT_VALIDATE_OUTPUT);
