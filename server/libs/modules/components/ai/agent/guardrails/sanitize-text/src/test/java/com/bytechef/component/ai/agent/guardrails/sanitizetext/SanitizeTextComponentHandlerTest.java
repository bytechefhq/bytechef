 ...
 * @author Ivica Cardic
 */
public class SanitizeTextComponentHandlerTest {
    ...
    public void testGetComponentDefinition() {
        ...
        JsonFileAssert.assertEquals(
            "definition/sanitizeText_v1.json",
            new SanitizeTextComponentHandler(new SanitizeText(clusterElementDefinitionService)).getDefinition());
    }
}
