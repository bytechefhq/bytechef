...
public final class TopicalAlignment {
    ...
    public static ClusterElementDefinition<GuardrailCheckFunction> of() {
        return ComponentDsl.<GuardrailCheckFunction>clusterElement("topicalAlignment")
            ...
            .description("LLM checks if the input stays on a defined topic.")
            ...
            .properties(
                ...
                bool(CUSTOMIZE_PROMPT)
                    ...
                    .description("If false, uses the built-in topical-alignment classifier prompt.")
                    .defaultValue(false),
                string(PROMPT)
                    .label("Prompt")
            ...
            .object(() -> new GuardrailCheckFunction() {
                ...
                public Optional<Violation> apply(String text, GuardrailContext context) throws Exception {
                    return TopicalAlignment.apply(text, context);
                }
    ...
    private static Optional<Violation> apply(String text, GuardrailContext context) {
        ChatClient chatClient = context.requireChatClient(() -> new MissingModelChildException("topicalAlignment"));
