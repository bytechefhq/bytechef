 ...
 * @author Ivica Cardic
 */
public class TopicalAlignmentComponentHandlerTest {

    @Test
    public void testGetComponentDefinition() {
        JsonFileAssert.assertEquals(
            "definition/topicalAlignment_v1.json",
            new TopicalAlignmentComponentHandler(new TopicalAlignment()).getDefinition());
    }
}
