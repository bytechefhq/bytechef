...
class UrlsTest {
    ...
    void testSanitizeMasksUrl() throws Exception {
        GuardrailSanitizerFunction function = Urls.ofSanitize()
            .getElement();
    ...
    @Test
    void testSanitizeMaskReturnsEntitiesForBlockedUrls() {
        PreflightSanitizerFunction function = (PreflightSanitizerFunction) Urls.ofSanitize()
            .getElement();
        ...
        assertThat(entities.get("URL")).containsExactlyInAnyOrder("https://evil.com/p", "https://bad.com/x");
    }
