 ...
 * @author Ivica Cardic
 */
public class CosmosDbChatMemoryListConversationsAction {
                ...
                object()
                    .properties(
                        array("conversationIds")
                            .items(string()),
                        integer("count"))))
        .perform(CosmosDbChatMemoryListConversationsAction::perform);

    private CosmosDbChatMemoryListConversationsAction() {
    }
