 ...
 * @author Ivica Cardic
 */
public class CosmosDbChatMemoryGetMessagesAction {
                            ...
                            .items(
                                object()
                                    .properties(
                                        string("role"),
                                        string("content"))))))
        .perform(CosmosDbChatMemoryGetMessagesAction::perform);

    private CosmosDbChatMemoryGetMessagesAction() {
    }
    ...
    protected static Object perform(
        ...
        List<Map<String, String>> messageList = messages.stream()
            .map(CosmosDbChatMemoryGetMessagesAction::toMessageMap)
            .toList();
