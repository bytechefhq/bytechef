...
package com.bytechef.component.ai.agent.chat.memory.cosmosdb.action;

import static com.bytechef.component.ai.agent.chat.memory.cosmosdb.constant.CosmosDbChatMemoryConstants.CONVERSATION_ID;
import static com.bytechef.component.ai.agent.chat.memory.cosmosdb.constant.CosmosDbChatMemoryConstants.MESSAGES;
import static com.bytechef.component.ai.agent.chat.memory.cosmosdb.constant.CosmosDbChatMemoryConstants.MESSAGE_CONTENT;
import static com.bytechef.component.ai.agent.chat.memory.cosmosdb.constant.CosmosDbChatMemoryConstants.MESSAGE_ROLE;
 ...
 * @author Ivica Cardic
 */
public class CosmosDbChatMemoryAddMessagesAction {
                    ...
                    object()
                        .properties(
                            ...
                            string(MESSAGE_CONTENT)
                                ...
                                .required(true))))
        .perform(CosmosDbChatMemoryAddMessagesAction::perform);

    private CosmosDbChatMemoryAddMessagesAction() {
    }
