...
public class AwsChatMemory {
    ...
    public static final ClusterElementDefinition<ChatMemoryFunction> CLUSTER_ELEMENT_DEFINITION =
        ComponentDsl.<ChatMemoryFunction>clusterElement("chatMemory")
            ...
            .description(
                "Memory is retrieved from an Amazon S3 bucket and added as prior messages in the conversation.")
            .properties(
                string(CONVERSATION_ID)
                    .label("Conversation ID")
                    .description("The unique identifier for the conversation.")
                    .options(AwsChatMemoryUtils.getFirstMessages())
                    .required(true))
            .type(CHAT_MEMORY)
