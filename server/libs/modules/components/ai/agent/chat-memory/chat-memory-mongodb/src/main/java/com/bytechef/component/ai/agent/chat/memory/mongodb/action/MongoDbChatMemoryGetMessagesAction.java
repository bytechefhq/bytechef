 ...
 * @author Ivica Cardic
 */
public class MongoDbChatMemoryGetMessagesAction {
                            ...
                            .items(
                                object()
                                    .properties(
                                        string("role"),
                                        string("content"))))))
        .perform(MongoDbChatMemoryGetMessagesAction::perform);

    private MongoDbChatMemoryGetMessagesAction() {
    }
    ...
    protected static Object perform(
        ...
        List<Map<String, String>> messageList = messages.stream()
            .map(MongoDbChatMemoryGetMessagesAction::toMessageMap)
            .toList();
