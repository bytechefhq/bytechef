 ...
 */
@Component(NEO4J + "/v1/" + LOAD)
public class Neo4jLoadTaskHandler extends AbstractTaskHandler {

    public Neo4jLoadTaskHandler(ActionDefinitionFacade actionDefinitionFacade) {
        super(NEO4J, 1, LOAD, actionDefinitionFacade);
    }
}
