 ...
 */
public final class Neo4jDeleteAction {

    private Neo4jDeleteAction() {
    }

    public static ActionDefinition of(ClusterElementDefinitionService clusterElementDefinitionService) {
        return AbstractDeleteAction.of(NEO4J, VECTOR_STORE, List.of(), clusterElementDefinitionService);
    }
}
