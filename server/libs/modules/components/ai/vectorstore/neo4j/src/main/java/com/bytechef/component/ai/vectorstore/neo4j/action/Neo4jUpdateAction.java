 ...
 */
public final class Neo4jUpdateAction {

    private Neo4jUpdateAction() {
    }

    public static ActionDefinition of(ClusterElementDefinitionService clusterElementDefinitionService) {
        return AbstractUpdateAction.of(NEO4J, List.of(), VECTOR_STORE, clusterElementDefinitionService);
    }
}
