...
public class S3VectorStoreSearchTaskHandler extends AbstractTaskHandler {

    public S3VectorStoreSearchTaskHandler(ActionDefinitionFacade actionDefinitionFacade) {
