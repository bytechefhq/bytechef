...
public class AgenticAiToolFacade extends AbstractToolFacade {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AgenticAiToolFacade.class);
    ...
    public ToolCallback getFunctionToolCallback(
        ...
        if (toolDescription != null) {
            ...
            logger.warn(
                "Tool '{}' on component '{}' (cluster element '{}') has no description; " +
                    "LLM tool selection accuracy may degrade.",
                clusterElement.getWorkflowNodeName(), clusterElement.getComponentName(),
                clusterElement.getClusterElementName());
        }
