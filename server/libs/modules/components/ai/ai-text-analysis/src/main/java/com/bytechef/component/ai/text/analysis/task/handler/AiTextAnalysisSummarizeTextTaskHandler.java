 ...
 * @author Ivica Cardic
 */
@Component(AI_TEXT_ANALYSIS + "/v1/" + SUMMARIZE_TEXT)
public class AiTextAnalysisSummarizeTextTaskHandler extends AbstractTaskHandler {

    public AiTextAnalysisSummarizeTextTaskHandler(ActionDefinitionFacade actionDefinitionFacade) {
        super(AI_TEXT_ANALYSIS, 1, SUMMARIZE_TEXT, actionDefinitionFacade);
    }
}
