...
package com.bytechef.component.openai.aiagent;
...
public class OpenAiModel {
    ...
    public static final ClusterElementDefinition<ModelFunction> CLUSTER_ELEMENT_DEFINITION =
        ComponentDsl.<ModelFunction>clusterElement("model")
            ...
            .object(
                () -> (inputParameters, connectionParameters, context) -> apply(inputParameters, connectionParameters))
            .properties(
                MODEL_PROPERTY,
                MAX_TOKENS_PROPERTY,
                N_PROPERTY,
    ...
    protected static ChatModel apply(Parameters inputParameters, Parameters connectionParameters) {
        return OpenAiChatAction.CHAT_MODEL.createChatModel(inputParameters, connectionParameters);
    }
}
