...
import static com.bytechef.component.ai.llm.router.open.router.constant.OpenRouterConstants.SPEECH_MODEL_PROPERTY;
...
public class OpenRouterCreateSpeechAction {
    public static final ModifiableActionDefinition ACTION_DEFINITION = action(CREATE_SPEECH)
        ...
        .perform(OpenRouterCreateSpeechAction::perform);

    private OpenRouterCreateSpeechAction() {
    }
