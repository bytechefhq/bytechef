...
package com.bytechef.component.ai.llm.router.open.router;

import static com.bytechef.component.definition.ComponentDsl.component;

import com.bytechef.component.ComponentHandler;
import com.bytechef.component.ai.llm.router.open.router.action.OpenRouterChatAction;
import com.bytechef.component.ai.llm.router.open.router.action.OpenRouterCreateImageAction;
import com.bytechef.component.ai.llm.router.open.router.action.OpenRouterCreateSpeechAction;
import com.bytechef.component.ai.llm.router.open.router.action.OpenRouterCreateTranscriptionAction;
import com.bytechef.component.ai.llm.router.open.router.cluster.OpenRouterChatModel;
import com.bytechef.component.ai.llm.router.open.router.cluster.OpenRouterEmbedding;
import com.bytechef.component.ai.llm.router.open.router.connection.OpenRouterConnection;
