...
package com.bytechef.component.ai.llm.router.cluster;
 ...
 */
public class RouterEmbedding {

    private RouterEmbedding() {
    }

    public static EmbeddingModel createEmbeddingModel(
        String baseUrl, Parameters inputParameters, Parameters connectionParameters) {
