...
import static com.bytechef.component.ai.llm.router.requesty.constant.RequestyConstants.CHAT_MODEL_PROPERTY;
import static com.bytechef.component.ai.llm.router.requesty.constant.RequestyConstants.REASONING_PROPERTY;
import static com.bytechef.component.ai.llm.router.requesty.constant.RequestyConstants.SUPPORTED_PARAMETERS_PROPERTY;
 ...
 */
public class RequestyChatAction {

    public static final ModifiableActionDefinition ACTION_DEFINITION = action(ASK)
        .title("Ask")
        .description("Ask anything you want.")
        .help("", "https://docs.bytechef.io/reference/components/requesty_v1#ask")
        .properties(
        ...
        .perform(RequestyChatAction::perform);
    ...
    public static final ChatModel CHAT_MODEL = (inputParameters, connectionParameters, responseFormatRequired) -> {
        ...
        return RequestyChatModel.builder()
