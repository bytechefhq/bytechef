 ...
 */
public class RequestyImageModel implements ImageModel {
    ...
    private RequestyImageModel(Builder builder) {
    ...
    public static class Builder {
        ...
        public RequestyImageModel build() {
            return new RequestyImageModel(this);
        }
    }
}
