...
import static com.bytechef.component.ai.llm.router.requesty.constant.RequestyConstants.EMBEDDING_MODEL_PROPERTY;
 ...
 */
public class RequestyEmbedding {
    ...
    public static final ClusterElementDefinition<?> CLUSTER_ELEMENT_DEFINITION =
        ComponentDsl.<EmbeddingFunction>clusterElement("embedding")
            .title("Requesty Embedding")
            .description("Requesty embedding.")
            .type(EmbeddingFunction.EMBEDDING)
            .object(() -> RequestyEmbedding::apply)
