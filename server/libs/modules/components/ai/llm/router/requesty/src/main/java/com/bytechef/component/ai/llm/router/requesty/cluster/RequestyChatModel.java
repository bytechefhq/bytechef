...
package com.bytechef.component.ai.llm.router.requesty.cluster;
...
import static com.bytechef.component.ai.llm.router.requesty.action.RequestyChatAction.CHAT_MODEL;
 ...
 */
public class RequestyChatModel {
    ...
    public static final ClusterElementDefinition<ModelFunction> CLUSTER_ELEMENT_DEFINITION =
        ComponentDsl.<ModelFunction>clusterElement("model")
            ...
            .object(() -> RequestyChatModel::apply)
            .properties(
