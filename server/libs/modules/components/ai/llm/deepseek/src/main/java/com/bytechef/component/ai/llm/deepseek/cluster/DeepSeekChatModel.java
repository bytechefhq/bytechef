...
package com.bytechef.component.ai.llm.deepseek.cluster;
...
public class DeepSeekChatModel {
    ...
    public static final ClusterElementDefinition<ModelFunction> CLUSTER_ELEMENT_DEFINITION =
        ComponentDsl.<ModelFunction>clusterElement("model")
            ...
            .object(() -> DeepSeekChatModel::apply)
            .properties(
                CHAT_MODEL_PROPERTY,
                MAX_TOKENS_PROPERTY,
                N_PROPERTY,
    ...
    protected static ChatModel apply(Parameters inputParameters, Parameters connectionParameters) {
        return DeepSeekChatAction.CHAT_MODEL.createChatModel(inputParameters, connectionParameters);
    }
}
