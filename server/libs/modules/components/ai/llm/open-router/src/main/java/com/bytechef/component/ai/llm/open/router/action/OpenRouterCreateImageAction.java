...
import static com.bytechef.component.ai.llm.open.router.constant.OpenRouterConstants.ASPECT_RATIO;
import static com.bytechef.component.ai.llm.open.router.constant.OpenRouterConstants.IMAGE_MODEL_PROPERTY;
...
import com.bytechef.component.ai.llm.open.router.model.OpenRouterImageModel;
 ...
 */
public class OpenRouterCreateImageAction {
    ...
    public static final ModifiableActionDefinition ACTION_DEFINITION = action(CREATE_IMAGE)
        ...
        .perform(OpenRouterCreateImageAction::perform);

    public static final ImageModel IMAGE_MODEL =
        (inputParameters, connectionParameters) -> OpenRouterImageModel.builder()
    ...
    private OpenRouterCreateImageAction() {
    }
