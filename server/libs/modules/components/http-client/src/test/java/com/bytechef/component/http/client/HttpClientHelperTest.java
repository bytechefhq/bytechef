...
public class HttpClientHelperTest {
    ...
    private final HttpClientHelper httpClientHelper = new HttpClientHelper(context);

    @Test
    public void testCreateBodyHandler() {
        MockExecutionParameters parameters = new MockExecutionParameters();

        HttpResponse.BodyHandler<?> bodyHandler = httpClientHelper.createBodyHandler(parameters);
        ...
        bodyHandler = httpClientHelper.createBodyHandler(parameters);
    ...
    public void testCreateBodyPublisher() {
        ...
        MultipartBodyPublisher multipartBodyPublisher =
                (MultipartBodyPublisher) httpClientHelper.createBodyPublisher(parameters);
        ...
        FormBodyPublisher formBodyPublisher = (FormBodyPublisher) httpClientHelper.createBodyPublisher(parameters);
        ...
        MimeBodyPublisherAdapter mimeBodyPublisherAdapter =
                (MimeBodyPublisherAdapter) httpClientHelper.createBodyPublisher(parameters);
        ...
        mimeBodyPublisherAdapter = (MimeBodyPublisherAdapter) httpClientHelper.createBodyPublisher(parameters);
        ...
        HttpRequest.BodyPublisher bodyPublisher = httpClientHelper.createBodyPublisher(parameters);
    ...
    public void testCreateHTTPClient() {
        ...
        HttpClient httpClient = httpClientHelper.createHTTPClient(parameters, Map.of(), Map.of());
        ...
        parameters.set(CONNECTION_ID, "connectiononId");
        ...
        httpClientHelper.createHTTPClient(parameters, headers, Map.of());
        ...
        httpClientHelper.createHTTPClient(parameters, Map.of(), queryParams);
        ...
        httpClient = httpClientHelper.createHTTPClient(parameters, Map.of(), Map.of());
        ...
        httpClient = httpClientHelper.createHTTPClient(parameters, new HashMap<>(), new HashMap<>());
    ...
    public void testHandleResponse() throws Exception {
        ...
        Assertions.assertNull(httpClientHelper.handleResponse(parameters, new TestHttpResponse(null)));
        ...
        Assertions.assertEquals(
                com.bytechef.hermes.file.storage.domain.FileEntry.of("file.txt", "base64:dGV4dA==")
                        .toMap(),
                ((FileEntry) httpClientHelper.handleResponse(
                                parameters,
        ...
        Assertions.assertEquals("text", httpClientHelper.handleResponse(parameters, new TestHttpResponse("text")));
        ...
        Assertions.assertEquals(
                ...
                httpClientHelper.handleResponse(parameters, new TestHttpResponse("text")));
    }
