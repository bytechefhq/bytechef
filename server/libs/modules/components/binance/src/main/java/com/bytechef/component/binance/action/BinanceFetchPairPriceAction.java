...
public class BinanceFetchPairPriceAction {
    ...
    public static final ComponentDsl.ModifiableActionDefinition ACTION_DEFINITION = action("fetchPairPrice")
        ...
        .properties(
            string(SYMBOL)
                ...
                .options((OptionsDataSource.ActionOptionsFunction<String>) BinanceUtils::getSymbolsOptions)
                .required(true))
        .output(outputSchema(
            object()
                .properties(
