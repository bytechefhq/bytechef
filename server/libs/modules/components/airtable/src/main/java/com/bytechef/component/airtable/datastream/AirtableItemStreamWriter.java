 ...
 * @author Ivica Cardic
 */
public class AirtableItemStreamWriter implements ItemWriter {

    public static final ClusterElementDefinition<AirtableItemStreamWriter> CLUSTER_ELEMENT_DEFINITION =
        ComponentDsl.<AirtableItemStreamWriter>clusterElement("write")
            .title("Write tabel rows")
            .type(DESTINATION)
            .object(AirtableItemStreamWriter.class)
            .properties(
