...
class ScrapeUnblockerGetParsedDataActionTest {

    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(URL, "mockUrl", PROXY_COUNTRY, "US"));
    ...
    void testPerform(
        ...
        String stringResponse = "{\"title\":\"Example\"}";
        ...
        String result = ScrapeUnblockerGetParsedDataAction.perform(mockedParameters, mockedParameters, mockedContext);
        ...
        Object[] expectedQueryParameters = {
            URL, "mockUrl", PARSED_DATA, true, PROXY_COUNTRY, "US"
        };
