...
class ScrapeUnblockerGetPageSourceActionTest {

    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(URL, "mockUrl", PROXY_COUNTRY, "US", TIME_SLEEP, 3));
    ...
    void testPerform(
        ...
        String stringResponse = "<html></html>";
        ...
        String result = ScrapeUnblockerGetPageSourceAction.perform(mockedParameters, mockedParameters, mockedContext);

        assertEquals(stringResponse, result);
        assertNotNull(httpFunctionArgumentCaptor.getValue());
        assertEquals("/getPageSource", stringArgumentCaptor.getValue());

        Object[] expectedQueryParameters = {
            URL, "mockUrl", PROXY_COUNTRY, "US", TIME_SLEEP, 3
        };
