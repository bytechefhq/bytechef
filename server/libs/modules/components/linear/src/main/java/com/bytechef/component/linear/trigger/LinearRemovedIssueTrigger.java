 ...
 */
public class LinearRemovedIssueTrigger {
    ...
    public static final ModifiableTriggerDefinition TRIGGER_DEFINITION = trigger("removedIssue")
        ...
        .webhookEnable(LinearRemovedIssueTrigger::webhookEnable)
        .webhookDisable(LinearRemovedIssueTrigger::webhookDisable)
        .webhookRequest(LinearRemovedIssueTrigger::webhookRequest);

    private LinearRemovedIssueTrigger() {
    }
