 ...
 */
class LinearNewIssueTriggerTest extends AbstractLinearTriggerTest {
    ...
    void testWebhookEnable() {
        ...
        WebhookEnableOutput actualOutput = LinearNewIssueTrigger.webhookEnable(
    ...
    void testWebhookRequest() {
        linearUtilsMockedStatic.when(
            () -> LinearUtils.executeIssueTriggerQuery("create", mockedWebhookBody, mockedTriggerContext))
            .thenReturn(Map.of("id", "123"));

        Object result = LinearNewIssueTrigger.webhookRequest(
