...
class BeamerTriggerTest {
    ...
    void testWebhookEnable() {
        ...
        Assertions.assertNull(
            BeamerTrigger.webhookEnable(parameters, parameters, webhookUrl, workflowExecutionId,
    ...
    void testWebhookRequest() {
        ...
        Assertions.assertNull(
            BeamerTrigger.webhookRequest(parameters, parameters, mock(TriggerDefinition.HttpHeaders.class),
