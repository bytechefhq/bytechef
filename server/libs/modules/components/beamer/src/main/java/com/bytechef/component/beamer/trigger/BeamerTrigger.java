...
public class BeamerTrigger {
    ...
    public static final ModifiableTriggerDefinition TRIGGER_DEFINITION = trigger("dummyTrigger")
        ...
        .webhookEnable(BeamerTrigger::webhookEnable)
        .webhookDisable(BeamerTrigger::webhookDisable)
        .webhookRequest(BeamerTrigger::webhookRequest)
        .webhookValidate(BeamerTrigger::webhookValidate);

    private BeamerTrigger() {
    }
