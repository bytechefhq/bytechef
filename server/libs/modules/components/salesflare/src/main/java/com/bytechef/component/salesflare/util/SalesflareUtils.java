...
package com.bytechef.component.salesflare.util;
 ...
 */
public class SalesflareUtils {

    private SalesflareUtils() {
    }
    ...
    public static List<Option<String>> getContactIdOptions(
        ...
        List<Map<String, ?>> body = context
            .http(http -> http.get("https://api.salesflare.com/contacts"))
