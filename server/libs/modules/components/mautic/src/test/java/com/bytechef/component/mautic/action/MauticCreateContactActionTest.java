 ...
 */
class MauticCreateContactActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = ArgumentCaptor.forClass(Body.class);
    private final Context mockedContext = mock(Context.class);
    private final Http.Executor mockedExecutor = mock(Http.Executor.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(FIRSTNAME, "first", LASTNAME, "last", OVERWRITE_WITH_BLANK, false, EMAIL, "email"));
    ...
    void testPerform() {
        ...
        Map<String, Object> result = MauticCreateContactAction.perform(
        ...
        assertEquals(
            Map.of(FIRSTNAME, "first", LASTNAME, "last", EMAIL, "email", OVERWRITE_WITH_BLANK, false),
            body.getContent());
    }
}
