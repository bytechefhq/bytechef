 ...
 */
class GithubNewIssueTriggerTest extends AbstractGithubTriggerTest {
    ...
    void testDynamicWebhookEnable() {
        ...
        githubUtilsMockedStatic.when(
            ...
            .thenReturn(123);
        DynamicWebhookEnableOutput dynamicWebhookEnableOutput = GithubNewIssueTrigger.dynamicWebhookEnable(
    ...
    void testDynamicWebhookDisable() {
        ...
        GithubNewIssueTrigger.dynamicWebhookDisable(
