...
public class ZohoBooksCreateInvoiceAction {
    ...
    public static final ModifiableActionDefinition ACTION_DEFINITION = action("createInvoice")
        ...
        .help("", "https://docs.bytechef.io/reference/components/zoho-books_v1#create-invoice")
        .properties(
            string(CUSTOMER_ID)
                .label("Customer ID")
        ...
        .perform(ZohoBooksCreateInvoiceAction::perform);

    private ZohoBooksCreateInvoiceAction() {
    }
