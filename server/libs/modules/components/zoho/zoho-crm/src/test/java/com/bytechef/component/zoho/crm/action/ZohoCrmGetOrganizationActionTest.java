...
class ZohoCrmGetOrganizationActionTest {
    ...
    void testPerform(
        ...
        Object result = ZohoCrmGetOrganizationAction.perform(null, null, mockedContext);
        ...
        assertEquals("/org", stringArgumentCaptor.getValue());
