...
import static com.bytechef.component.baserow.action.BaserowUpdateRowAction.PROPERTIES;
 ...
 */
public class BaserowUpdateRowTool {
    ...
    public static final ClusterElementDefinition<SingleConnectionToolFunction> CLUSTER_ELEMENT_DEFINITION =
        ComponentDsl.<SingleConnectionToolFunction>clusterElement(UPDATE_ROW)
            ...
            .output()
            .object(() -> BaserowUpdateRowAction::perform);
}
