...
import static com.bytechef.component.baserow.action.BaserowDeleteRowAction.PROPERTIES;
 ...
 */
public class BaserowDeleteRowTool {
    ...
    public static final ClusterElementDefinition<SingleConnectionToolFunction> CLUSTER_ELEMENT_DEFINITION =
        ComponentDsl.<SingleConnectionToolFunction>clusterElement(DELETE_ROW)
            ...
            .object(() -> BaserowDeleteRowAction::perform);
}
