...
class BaserowUpdateRowActionTest {
    ...
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(TABLE_ID, 1, ROW_ID, 2, FIELDS, bodyMap, USER_FIELD_NAMES, true));
    ...
    void testPerform(
        ...
        Object result = BaserowUpdateRowAction.perform(mockedParameters, null, mockedContext);
        ...
        assertEquals(
            List.of("/database/rows/table/1/2/", USER_FIELD_NAMES, "true"), stringArgumentCaptor.getAllValues());
