...
class BaserowCreateRowActionTest {
    ...
    private final Parameters mockedParameters =
        MockParametersFactory.create(Map.of(FIELDS, bodyMap, USER_FIELD_NAMES, true));
    ...
    void testPerform() {
        ...
        Object result = BaserowCreateRowAction.perform(mockedParameters, mockedParameters, mockedActionContext);
