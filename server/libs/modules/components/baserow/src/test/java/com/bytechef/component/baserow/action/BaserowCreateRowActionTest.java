...
class BaserowCreateRowActionTest {
    ...
    void testPerform(
        ...
        Object result = BaserowCreateRowAction.perform(mockedParameters, null, mockedContext);
        ...
        assertEquals(List.of("/database/rows/table/5/", USER_FIELD_NAMES, "true"), stringArgumentCaptor.getAllValues());
        assertEquals(Http.Body.of(bodyMap), bodyArgumentCaptor.getValue());
    }
}
