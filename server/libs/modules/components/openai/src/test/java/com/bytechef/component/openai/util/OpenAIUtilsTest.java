 ...
 */
 class OpenAIUtilsTest extends AbstractOpenAIActionTest {
    ...
    @Test
     void testGetNumberOfImagesPropertiesForDallE2() {
        when(parameterMap.getRequiredString(MODEL))
            .thenReturn("dall-e-2");
    ...
    @Test
     void testGetNumberOfImagesPropertiesForDallE3() {
        when(parameterMap.getRequiredString(MODEL))
            .thenReturn("dall-e-3");
    ...
    @Test
     void testGetOutputSchemaFunctionForStream() {
    ...
    @Test
     void testGetOutputSchemaFunction() {
