    ...
    public static final ModifiableActionDefinition ACTION_DEFINITION = action(ASK_CHAT_GPT)
        ...
        .properties(
            ...
            number(FREQUENCY_PENALTY)
                ...
                .description(
                    "Number between -2.0 and 2.0. Positive values penalize new tokens based on their existing " +
                        "frequency in the text so far, decreasing the model's likelihood to repeat the same " +
                        "line verbatim.")
                .defaultValue(0)
                .minValue(-2)
                .maxValue(2)
            ...
            number(TEMPERATURE)
                .label("Temperature")
                .description(
                    "Controls randomness:  Higher values will make the output more random,  while lower values " +
                        "like will make it more focused and deterministic.")
                .defaultValue(1)
                .minValue(0)
                .maxValue(2)
                .required(false),
