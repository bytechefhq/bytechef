 ...
 * @author Ivona Pavela
 */
class MergeHelperSQLQueryActionTest {
    ...
    void testPerformJoinTwoInputs() {
        ...
        List<Map<String, Object>> result = MergeHelperSQLQueryAction.perform(
    ...
    void testPerformMultipleRows() {
        ...
        assertEquals(List.of(Map.of("name", "Alice", "amount", 100), Map.of("name", "Bob", "amount", 200)), result);
    }
    ...
    void testInvalidSqlThrowsException() {
        ...
        assertThrows(
            ...
            () -> MergeHelperSQLQueryAction.perform(mockedParameters, mockedParameters, context));
    }
}
