 ...
 * @author Ivona Pavela
 */
class MergeHelperCombineActionTest {
    ...
    void testPerformMatchingFields() {
        ...
        List<Map<String, Object>> result =
            MergeHelperCombineAction.perform(mockedParameters, mockedParameters, context);
    ...
    void testPerformAllPossibleCombinations() {
        ...
        List<Map<String, Object>> result = MergeHelperCombineAction.perform(
