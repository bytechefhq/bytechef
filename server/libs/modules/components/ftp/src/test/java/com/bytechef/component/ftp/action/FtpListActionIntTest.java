...
@Testcontainers
public class FtpListActionIntTest {
    ...
    private static final String TEST_FILE_BASE_NAME = "test-document";
    private static final String TEST_FILE_BASE_EXTENSION = ".txt";
    private static final String TEST_FILE_NAME = TEST_FILE_BASE_NAME + TEST_FILE_BASE_EXTENSION;
     ...
     */
    private static final String FTP_REMOTE_PATH = TEST_FILE_NAME;
    private static final String SFTP_UPLOAD_DIR = "upload";
    private static final String SFTP_REMOTE_PATH = "/" + SFTP_UPLOAD_DIR + "/" + TEST_FILE_NAME;
    ...
    void testList() throws Exception {
        ...
        assertEquals(6, remoteFileSystemEntryList.size());
    ...
    private static void uploadTestFileViaFtp() throws Exception {
        String filePath = "/ftp/" + FTP_USERNAME + "/" + TEST_FILE_NAME;
    ...
    private static void copyTestFileViaFtp(String newFileSuffix) throws Exception {
        ...
        String copyOfFilePath =
            "/ftp/" + FTP_USERNAME + "/" + TEST_FILE_BASE_NAME + "-" + newFileSuffix + TEST_FILE_BASE_EXTENSION;
