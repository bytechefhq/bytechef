 ...
 */
class VboutCreateSocialMediaMessageActionTest {
    ...
    void testPerform() {
        Parameters parameters = MockParametersFactory.create(
            Map.of(MESSAGE, "This is a message.", CHANNEL, "facebook", CHANNEL_ID, "1"));
        ...
        Object result = VboutCreateSocialMediaMessageAction.perform(parameters, parameters, mockedContext);

        assertNull(result);

        Object[] query = queryArgumentCaptor.getValue();
        assertEquals(
            List.of(MESSAGE, "This is a message.", CHANNEL, "facebook", CHANNEL_ID, "1"),
            Arrays.asList(query));
    }
}
