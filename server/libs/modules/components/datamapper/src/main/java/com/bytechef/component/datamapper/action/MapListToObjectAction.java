 ...
 * @author Ivica Cardic
 */
public class MapListToObjectAction {
    ...
    public static final ActionDefinition ACTION_DEFINITION = ComponentDSL.action("mapListToObject")
        .display(display("Map list to object").description("Map an array of key value objects to a single object."))
        .properties(
            array(INPUT)
                .label("Input")
            ...
            string(FIELD_VALUE)
                ...
                .required(true))
        .execute(MapListToObjectAction::execute);
