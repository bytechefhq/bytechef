 ...
 * @author Ivica Cardic
 */
public class MapMultipleValuesBetweenObjectsAction {
    ...
    public static final ActionDefinition ACTION_DEFINITION = ComponentDSL.action("mapMultipleValuesBetweenObjects")
        .display(display("Map multiple values between objects\n").description(
                ...
                .items(
                    object().properties(
                        ...
                        string(TO)
                            .label("To")))
                .required(true))
        .execute(MapMultipleValuesBetweenObjectsAction::execute);
