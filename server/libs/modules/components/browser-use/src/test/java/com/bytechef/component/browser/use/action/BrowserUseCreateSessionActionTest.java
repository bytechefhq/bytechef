...
import static com.bytechef.component.browser.use.constant.BrowserUseConstants.FORMAT;
...
import static com.bytechef.component.browser.use.constant.BrowserUseConstants.SCHEMA;
...
class BrowserUseCreateSessionActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Body.class);
    private final ArgumentCaptor<String> stringArgumentCaptor = forClass(String.class);
    private final Object mockedObject = mock(Object.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(TASK, "This is a task.", MODEL, "model", OUTPUT_SCHEMA, Map.of(FORMAT, "format",
            SCHEMA, "schema"), SESSION_ID, "1", KEEP_ALIVE, true, ENABLE_SCHEDULED_TASKS, true,
            SKILLS, true));
    ...
    void testPerform(
        ...
        Object result = BrowserUseCreateSessionAction.perform(mockedParameters, null, mockedContext);
        ...
        assertEquals(
            Body.of(
                Map.of(
                    TASK, "This is a task.", MODEL, "model", SESSION_ID, "1", KEEP_ALIVE, true,
                    ENABLE_SCHEDULED_TASKS, true, SKILLS, true),
