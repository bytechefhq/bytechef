...
class BrowserUseCreateRunActionTest {

    private final ArgumentCaptor<Body> bodyArgumentCaptor = forClass(Body.class);
    private final ArgumentCaptor<String> stringArgumentCaptor = forClass(String.class);
    private final Object mockedObject = mock(Object.class);
    private final Parameters mockedParameters = MockParametersFactory.create(
        Map.of(TASK, "Find the latest Browser Use release.", MODEL, "gpt-5.6-luna", SESSION_ID, "session-1"));
    ...
    void testPerform(
        ...
        Object result = BrowserUseCreateRunAction.perform(mockedParameters, null, mockedContext);
        ...
        assertEquals(
            Body.of(
                Map.of(
                    TASK, "Find the latest Browser Use release.", MODEL, "gpt-5.6-luna", SESSION_ID, "session-1"),
