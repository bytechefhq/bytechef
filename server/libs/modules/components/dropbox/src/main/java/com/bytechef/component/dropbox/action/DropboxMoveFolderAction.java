 ...
 */
public class DropboxMoveFolderAction {

    public static final ModifiableActionDefinition ACTION_DEFINITION = action("moveFolder")
        .title("Move Folder")
        .description(
        ...
        .output(
            outputSchema(
                object()
                    .properties(
                        object("metadata")
                            .description("Metadata containing details about the moved folder.")
                            .properties(
                                string("name")
                                    .description(
                                        "The name of the moved folder, including its extension. This is the last " +
                                            "component of the path."),
                                string("path_lower")
                                    .description(
                                        "The full path to the moved folder in lowercase, as stored in the user's " +
                                            "Dropbox."),
                                string("path_display")
                                    .description(
                                        "The display-friendly version of the path to the moved folder, preserving " +
                                            "original casing."),
                                string("id")
                                    .description("ID of the moved folder.")))))
        .perform(DropboxMoveFolderAction::perform);

    private DropboxMoveFolderAction() {
    }
