 ...
 */
public class DropboxDeleteFolderAction {
        ...
        .output(
            outputSchema(
                object()
                    .properties(
                        object("metadata")
                            .description("Metadata containing details about the deleted folder.")
                            .properties(
                                string("name")
                                    .description(
                                        "The name of the deleted folder, including its extension. This is the last " +
                                            "component of the path."),
                                string("path_lower")
                                    .description(
                                        "The full path to the deleted folder in lowercase, as stored in the user's " +
                                            "Dropbox."),
                                string("path_display")
                                    .description(
                                        "The display-friendly version of the path to the deleted folder, preserving " +
                                            "original casing."),
                                string("id")
                                    .description("ID of the deleted folder.")))))
        .perform(DropboxDeleteFolderAction::perform);

    private DropboxDeleteFolderAction() {
    }
