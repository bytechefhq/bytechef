...
import static com.bytechef.component.dropbox.action.DropboxCopyAction.POST_COPY_CONTEXT_FUNCTION;
...
class DropboxCopyActionTest extends AbstractDropboxActionTest {
    ...
    void testPerform() {
        ...
        when(mockedContext.http(POST_COPY_CONTEXT_FUNCTION))
        ...
        Object result = DropboxCopyAction.perform(mockedParameters, mockedParameters, mockedContext);
