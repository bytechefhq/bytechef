...
package com.bytechef.component.wolfram.alpha.shortanswers.connection;
 ...
 * @generated
 */
public class WolframAlphaShortanswersConnection {
    public static final ComponentDsl.ModifiableConnectionDefinition CONNECTION_DEFINITION = connection()
        .baseUri((connectionParameters, context) -> "https://api.wolframalpha.com/v1")
    ...
    private WolframAlphaShortanswersConnection() {
    }
}
