...
import com.bytechef.component.wolfram.alpha.shortanswers.action.WolframAlphaShortanswersGetShortAnswerAction;
import com.bytechef.component.wolfram.alpha.shortanswers.connection.WolframAlphaShortanswersConnection;
    ...
    private final ComponentDefinition componentDefinition = modifyComponent(
        component("wolfram-alpha-shortanswers")
            ...
            .description("Wolfram Alpha Short Answers returns a single plain text result as an answer to your query."))
                ...
                .clusterElements(
                    modifyClusterElements(tool(WolframAlphaShortanswersGetShortAnswerAction.ACTION_DEFINITION)))
