 ...
 * @generated
 */
public class WolframAlphaFullResultsSubpodProperties {
    public static final List<ComponentDsl.ModifiableValueProperty<?, ?>> PROPERTIES = List.of(
        ...
        string("plaintext").label("Plaintext")
            .required(false),
        object("img").properties(WolframAlphaFullResultsImageProperties.PROPERTIES)
            .label("Img")
            .required(false));

    private WolframAlphaFullResultsSubpodProperties() {
    }
}
