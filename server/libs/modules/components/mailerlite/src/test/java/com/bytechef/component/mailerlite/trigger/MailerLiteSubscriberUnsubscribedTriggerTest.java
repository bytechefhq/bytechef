 ...
 */
class MailerLiteSubscriberUnsubscribedTriggerTest extends AbstractsMailerLiteTriggerTest {
    ...
    void webhookEnable() {
        ...
        WebhookEnableOutput webhookEnableOutput = MailerLiteSubscriberUnsubscribedTrigger.webhookEnable(
        ...
        assertEquals(List.of(SUBSCRIBER_UNSUBSCRIBED_TRIGGER_NAME, SUBSCRIBER_UNSUBSCRIBED_TRIGGER_EVENT, webhookUrl),
    ...
    void webhookDisable() {
        ...
        MailerLiteSubscriberUnsubscribedTrigger.webhookDisable(
    ...
    void webhookRequest() {
        ...
        Map<String, Object> result = MailerLiteSubscriberUnsubscribedTrigger.webhookRequest(
