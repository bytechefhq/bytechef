...
/**
 * Facade for the AI Hub chat-artifact audit listing. Hosts the {@code ADMIN} authorization guard (and the workspace
 ...
 * @author Ivica Cardic
 */
public interface AiHubChatArtifactFacade {

    AiHubChatArtifactPage getAiHubChatArtifacts(
     ...
     */
    record AiHubChatArtifactPage(
        List<AiHubChatArtifact> items, long totalCount, boolean hasMore,
        boolean pageClamped, boolean sizeClamped) {

        public AiHubChatArtifactPage {
