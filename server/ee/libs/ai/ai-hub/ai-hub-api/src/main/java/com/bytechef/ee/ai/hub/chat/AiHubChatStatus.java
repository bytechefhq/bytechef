...
/**
 * Lifecycle status of a AI Hub chat.
 *
 * <p>
 * <strong>Ordinal stability is load-bearing.</strong> {@link AiHubChat#getStatus()} persists this enum as an
 * {@code int} ordinal in the {@code ai_hub_chat.status} column (see the Liquibase migration that declares the column
