 ...
 * path: {@code id}, {@code name}, {@code format}, plus {@code chatLinked} so the chat surface can flag the rare
 ...
 * @param chatLinked  {@code true} when the {@code (chatId, fileId, AUTHORED)} join was recorded. {@code false} when the
 *                    request carried no chat id (first-turn race) — the file still exists but won't appear in the
 *                    chat's "Files" panel until something attaches it.
 */
