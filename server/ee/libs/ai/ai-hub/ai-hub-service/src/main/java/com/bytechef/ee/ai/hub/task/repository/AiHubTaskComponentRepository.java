...
public interface AiHubTaskComponentRepository extends ListCrudRepository<AiHubTaskComponent, Long> {
    ...
    /**
     * User-global "added connectors" (task_id NULL, scoped by user + workspace). Powers the Connectors page list and
     * the resolver's union of user-global tools with the task's own.
     */
    List<AiHubTaskComponent> findAllByUserIdAndWorkspaceId(long userId, long workspaceId);
     ...
     */
    Optional<AiHubTaskComponent> findByUserIdAndWorkspaceIdAndComponentNameAndComponentVersion(
     ...
     * {@link com.bytechef.ee.ai.hub.task.AiHubTaskToolFacade#setComponentConnection} instead of a second insert.
     *
     * <p>
