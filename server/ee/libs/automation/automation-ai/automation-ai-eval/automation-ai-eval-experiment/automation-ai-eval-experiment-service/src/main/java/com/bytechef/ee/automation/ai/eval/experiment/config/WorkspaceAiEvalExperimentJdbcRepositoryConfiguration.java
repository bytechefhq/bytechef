...
/**
 * Activates Spring Data JDBC repository scanning for the {@code workspace_ai_eval_experiment} membership table.
...
@EnableJdbcRepositories(basePackages = "com.bytechef.ee.automation.ai.eval.experiment.repository")
public class WorkspaceAiEvalExperimentJdbcRepositoryConfiguration {
}
