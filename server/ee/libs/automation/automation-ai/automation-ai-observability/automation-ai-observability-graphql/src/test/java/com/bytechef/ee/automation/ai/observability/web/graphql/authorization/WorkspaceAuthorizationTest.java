...
class WorkspaceAuthorizationTest {
    ...
    @Test
    void testDeniesWithUniformMessageWhenRoleInsufficient() {
        // The exception message must NOT include the workspace id or required role — distinguishable messages
        // would let workspace-A enumerate workspace ids by reading the GraphQL error body. Diagnostic context
        // is logged server-side at WARN by the throw site instead.
        ...
        assertEquals("Not authorized for the requested workspace", exception.getMessage());
    }
}
