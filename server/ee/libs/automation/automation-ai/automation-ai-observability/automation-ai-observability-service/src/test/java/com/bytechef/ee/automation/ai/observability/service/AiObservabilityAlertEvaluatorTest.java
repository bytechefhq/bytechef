...
class AiObservabilityAlertEvaluatorTest {
    ...
    @Mock
    private AiLlmUsageRepository aiGatewayRequestLogRepository;
    ...
    void setUp() {
        aiObservabilityAlertEvaluator = new AiObservabilityAlertEvaluator(
            aiObservabilityMetrics, aiGatewayRequestLogRepository, aiObservabilityAlertEventService,
            aiObservabilityAlertRuleService, workspaceAiObservabilityAlertRuleService,
    ...
    void testOnAlertEvaluationFiresDispatchAndMetricWhenThresholdBreached() {
        ...
        AiObservabilityAlertRule rule = new AiObservabilityAlertRule(
            "volume-rule", AiObservabilityAlertMetric.REQUEST_VOLUME,
        ...
        AiLlmUsage requestLog = new AiLlmUsage("req-1", "gpt-4");
        ...
        verify(aiObservabilityMetrics).incrementAlertTriggered("REQUEST_VOLUME");
    ...
    void testLessThanConditionFiresWhenMetricDropsBelowThreshold() {
        AiObservabilityAlertRule rule = new AiObservabilityAlertRule(
            "volume-under-threshold", AiObservabilityAlertMetric.REQUEST_VOLUME,
        ...
        when(aiGatewayRequestLogRepository.findAllByWorkspaceIdAndCreatedDateBetween(
            any(), any(), any())).thenReturn(List.of(new AiLlmUsage("req-1", "gpt-4")));
        when(aiObservabilityAlertEventService.create(any())).thenReturn(savedEvent);
    ...
    void testEqualsConditionFiresOnExactMatch() {
        AiObservabilityAlertRule rule = new AiObservabilityAlertRule(
            "volume-exact", AiObservabilityAlertMetric.REQUEST_VOLUME,
    ...
    void testLessThanConditionDoesNotFireWhenMetricMeetsThreshold() {
        ...
        AiObservabilityAlertRule rule = new AiObservabilityAlertRule(
            "volume-above", AiObservabilityAlertMetric.REQUEST_VOLUME,
        ...
        when(aiGatewayRequestLogRepository.findAllByWorkspaceIdAndCreatedDateBetween(
            any(), any(), any())).thenReturn(
                List.of(
                    new AiLlmUsage("req-1", "gpt-4"),
                    new AiLlmUsage("req-2", "gpt-4")));
    ...
    void testGreaterThanConditionDoesNotFireWhenMetricBelowThreshold() {
        ...
        AiObservabilityAlertRule rule = new AiObservabilityAlertRule(
            "volume-below", AiObservabilityAlertMetric.REQUEST_VOLUME,
    ...
    void testEqualsConditionDoesNotFireOnMismatch() {
        ...
        AiObservabilityAlertRule rule = new AiObservabilityAlertRule(
            "volume-mismatch", AiObservabilityAlertMetric.REQUEST_VOLUME,
            AiObservabilityAlertCondition.EQUALS, BigDecimal.ONE, 5, 0);
    ...
    void testEvaluateMetricReturnsNullWhenNoRequestLogsInWindow() {
        ...
        when(workspaceAiObservabilityAlertRuleService.getWorkspaceId(99L)).thenReturn(100L);
        when(aiGatewayRequestLogRepository.findAllByWorkspaceIdAndCreatedDateBetween(
    ...
    private static AiObservabilityAlertRule newRule() {
        return new AiObservabilityAlertRule(
            "rule", AiObservabilityAlertMetric.REQUEST_VOLUME, AiObservabilityAlertCondition.GREATER_THAN,
