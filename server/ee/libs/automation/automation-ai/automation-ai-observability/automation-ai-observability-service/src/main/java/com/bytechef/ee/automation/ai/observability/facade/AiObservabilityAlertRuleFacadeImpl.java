...
/**
 * Implementation of {@link AiObservabilityAlertRuleFacade}. Delegates to the shared
 * {@code WorkspaceAiObservabilityAlertRuleService} and carries the authorization guard so it is enforced for every
...
class AiObservabilityAlertRuleFacadeImpl implements AiObservabilityAlertRuleFacade {

    private final WorkspaceAiObservabilityAlertRuleService workspaceAiObservabilityAlertRuleService;

    @SuppressFBWarnings("EI")
    AiObservabilityAlertRuleFacadeImpl(
