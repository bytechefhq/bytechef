...
/**
 * The in-editor custom-component Copilot agent — the custom-component twin of {@link CodeWorkflowSpringAIAgent}.
 * Extends the base {@link SpringAIAgent} but overrides {@link #toolContext(RunAgentInput)} to carry the run's
 * authenticated-user / tenant / skip-automation-authorization signals from the AG-UI {@link State} into the Spring AI
 * {@code ToolContext}.
 *
 * <p>
 * This is required because the custom-component tools call {@code CustomComponentFacade} methods, all of which are
...
public class CustomComponentSpringAIAgent extends CopilotSpringAIAgent {
    ...
    public static class Builder extends SpringAIAgent.Builder {
        ...
        public CustomComponentSpringAIAgent build() throws AGUIException {

            return new CustomComponentSpringAIAgent(this);
        }
    }
}
