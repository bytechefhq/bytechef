...
import com.bytechef.ee.automation.ai.gateway.facade.AiGatewayProjectFacade;
 ...
 *
 * <p>
 * Authorization is enforced on {@link AiGatewayProjectFacade}, not here.
 *
 * @version ee
 *
 * @author Ivica Cardic
...
class AiGatewayProjectGraphQlController {
    ...
    private final AiGatewayProjectFacade aiGatewayProjectFacade;

    @SuppressFBWarnings("EI")
    AiGatewayProjectGraphQlController(AiGatewayProjectFacade aiGatewayProjectFacade) {
        this.aiGatewayProjectFacade = aiGatewayProjectFacade;
    }

    @QueryMapping
    public AiGatewayProject aiGatewayProject(@Argument long id) {
        return aiGatewayProjectFacade.getProject(id);
    }

    @QueryMapping
    public List<AiGatewayProject> aiGatewayProjects(@Argument long workspaceId) {
        return aiGatewayProjectFacade.getProjectsByWorkspaceId(workspaceId);
    }
    ...
    public AiGatewayProject createAiGatewayProject(@Argument CreateAiGatewayProjectInput input) {
        ...
        return aiGatewayProjectFacade.createInWorkspace(project, Long.parseLong(input.workspaceId()));
    }

    @MutationMapping
    public boolean deleteAiGatewayProject(@Argument long id) {
        aiGatewayProjectFacade.delete(id);
    ...
    public AiGatewayProject updateAiGatewayProject(
        ...
        AiGatewayProject project = aiGatewayProjectFacade.getProject(id);
        ...
        return aiGatewayProjectFacade.update(project);
    }
