...
import com.bytechef.ee.automation.ai.gateway.facade.AiGatewayBudgetFacade;
 ...
 *
 * <p>
 * Authorization is enforced on {@link AiGatewayBudgetFacade}, not here.
 *
 * @version ee
 *
 * @author Ivica Cardic
...
class AiGatewayBudgetGraphQlController {
    ...
    private final AiGatewayBudgetFacade aiGatewayBudgetFacade;

    @SuppressFBWarnings("EI")
    AiGatewayBudgetGraphQlController(AiGatewayBudgetFacade aiGatewayBudgetFacade) {
        this.aiGatewayBudgetFacade = aiGatewayBudgetFacade;
    }

    @QueryMapping
    public AiGatewayBudget aiGatewayBudget(@Argument long workspaceId) {
        return aiGatewayBudgetFacade.getBudgetByWorkspaceId(workspaceId)
            .orElse(null);
    }
    ...
    public AiGatewayBudget createAiGatewayBudget(@Argument CreateAiGatewayBudgetInput input) {
        ...
        return aiGatewayBudgetFacade.createInWorkspace(budget, Long.parseLong(input.workspaceId()));
    }

    @MutationMapping
    public boolean deleteAiGatewayBudget(@Argument long id) {
        aiGatewayBudgetFacade.delete(id);
    ...
    public AiGatewayBudget updateAiGatewayBudget(
        ...
        AiGatewayBudget budget = aiGatewayBudgetFacade.getBudget(id);
        ...
        return aiGatewayBudgetFacade.update(budget);
    }
