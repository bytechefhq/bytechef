...
import com.bytechef.ee.automation.ai.gateway.facade.AiGatewayRoutingPolicyFacade;
 ...
 *
 * <p>
 * Authorization is enforced on {@link AiGatewayRoutingPolicyFacade}, not here.
 *
 * @version ee
 *
 * @author Ivica Cardic
...
class AiGatewayRoutingPolicyGraphQlController {
    ...
    public AiGatewayRoutingPolicy createAiGatewayRoutingPolicy(
        ...
        return aiGatewayRoutingPolicyFacade.create(policy);
    }

    @MutationMapping
    public boolean deleteAiGatewayRoutingPolicy(@Argument long id) {
        aiGatewayRoutingPolicyFacade.delete(id);
    ...
    public AiGatewayRoutingPolicy updateAiGatewayRoutingPolicy(
        ...
        AiGatewayRoutingPolicy policy = aiGatewayRoutingPolicyFacade.getRoutingPolicy(id);
        ...
        return aiGatewayRoutingPolicyFacade.update(policy);
    }
