 ...
 *
 * <p>
 * Authorization (USER authority) is enforced on {@link WorkspaceAiGatewayModelFacade}, not here, so the guard applies
 * to every caller of the facade rather than only this GraphQL entry point.
 *
 * @version ee
 *
 * @author Ivica Cardic
