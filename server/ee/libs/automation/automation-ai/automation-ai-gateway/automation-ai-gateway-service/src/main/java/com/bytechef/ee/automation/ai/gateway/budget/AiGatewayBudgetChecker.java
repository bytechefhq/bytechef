...
public class AiGatewayBudgetChecker {
    ...
    private static final Logger log = LoggerFactory.getLogger(AiGatewayBudgetChecker.class);
    ...
    public BudgetCheckResult checkBudget(long workspaceId) {
        ...
        Optional<AiGatewayBudget> budgetOptional = workspaceAiGatewayBudgetService.getBudgetByWorkspaceId(workspaceId);
    ...
    public void recordSpendAndEnforce(long workspaceId) {
        ...
        if (currentSpendMoney.compareTo(budgetMoney) >= 0) {
            ...
            log.warn("Workspace {} is now hard-blocked: spend ${} exceeds budget ${}",
    ...
    private Money sumSpend(long workspaceId, Instant periodStart, Instant periodEnd) {
        return workspaceAiGatewaySpendService.getSpendSummariesByWorkspaceId(workspaceId, periodStart, periodEnd)
            .stream()
