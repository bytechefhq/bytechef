...
@Schema(name = "TagList", description = "A list of supported tags.")
@JsonTypeName("TagList")
...
public class TagListModel {
  ...
  @Valid
  private List<@Valid TagModel> data = new ArrayList<>();

  public TagListModel _object(@Nullable String _object) {
  ...
  public TagListModel data(List<@Valid TagModel> data) {
    this.data = data;
    return this;
  }

  public TagListModel addDataItem(TagModel dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty("data")
  public List<@Valid TagModel> getData() {
    return data;
  }

  public void setData(List<@Valid TagModel> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    TagListModel tagList = (TagListModel) o;
    return Objects.equals(this._object, tagList._object) &&
