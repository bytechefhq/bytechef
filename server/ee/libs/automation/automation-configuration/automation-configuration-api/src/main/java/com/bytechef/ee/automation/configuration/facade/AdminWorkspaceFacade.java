 ...
 * {@link com.bytechef.ee.automation.configuration.service.WorkspaceService} — this facade layers the global admin gate
 * on top, exactly as the controller did, and is required because {@code WorkspaceService.getWorkspaces()} is an
 * intentionally unguarded trusted-caller method.
 *
 * @version ee
 *
 * @author Ivica Cardic
