...
public class WorkflowReferenceModel {
  ...
  public WorkflowReferenceModel id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  @Schema(name = "id", description = "The id of a workflow.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("id")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, workflowReference.id) &&
        Objects.equals(this.label, workflowReference.label);
  }
