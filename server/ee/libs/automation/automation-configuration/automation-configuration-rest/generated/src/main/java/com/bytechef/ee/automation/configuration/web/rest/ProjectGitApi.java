...
public interface ProjectGitApi {
    ...
    /**
     * GET /projects/{id}/git/configuration : Get git configuration of a project.
    ...
    /**
     * POST /projects/{id}/git/push : Pushes project to git repository.
     * Pushes project to git repository.
     *
     * @param id The id of a project. (required)
     * @param pushProjectToGitRequestModel  (required)
     * @return Successful operation. (status code 204)
     */
    @Operation(
        operationId = "pushProjectToGit",
        summary = "Pushes project to git repository.",
        description = "Pushes project to git repository.",
        tags = { "project-git" },
        responses = {
            @ApiResponse(responseCode = "204", description = "Successful operation.")
        }
    ...
    @RequestMapping(
        method = RequestMethod.POST,
        value = "/projects/{id}/git/push",
        consumes = { "application/json" }
    )
    
    default ResponseEntity<Void> pushProjectToGit(
        @Parameter(name = "id", description = "The id of a project.", required = true, in = ParameterIn.PATH) @PathVariable("id") Long id,
        @Parameter(name = "PushProjectToGitRequestModel", description = "", required = true) @Valid @RequestBody PushProjectToGitRequestModel pushProjectToGitRequestModel
    ) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
