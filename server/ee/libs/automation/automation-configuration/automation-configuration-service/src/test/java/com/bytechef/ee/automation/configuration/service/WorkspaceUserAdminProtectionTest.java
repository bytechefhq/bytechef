...
class WorkspaceUserAdminProtectionTest {
    ...
    void testRefusesToRemoveTheLastAdminOfAnEnvironment() {
        ...
        when(workspaceUserRepository.findAllByUserIdAndWorkspaceId(OTHER_USER_ID, WORKSPACE_ID))
            .thenReturn(
                List.of(
                    productionAdmin,
                    WorkspaceUser.forRole(OTHER_USER_ID, WORKSPACE_ID, WorkspaceRole.VIEWER, Environment.DEVELOPMENT)));
        when(
