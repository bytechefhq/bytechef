...
class CustomRoleScopeResolverTest {
    ...
    void testResolveScopesReturnsCorrectScopes() {
        CustomRole customRole = new CustomRole("Test Role", Set.of("WORKFLOW_VIEW", "EXECUTION_VIEW"));
        ...
        assertThat(scopes)
            .isPresent()
            .hasValueSatisfying(s -> assertThat(s).containsExactlyInAnyOrder("WORKFLOW_VIEW", "EXECUTION_VIEW"));
    }
