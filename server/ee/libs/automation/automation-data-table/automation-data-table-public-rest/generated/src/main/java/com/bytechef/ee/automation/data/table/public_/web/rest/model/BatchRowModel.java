...
public class BatchRowModel {
   ...
   */
  public BatchRowModel(Map<String, Object> values) {
    this.values = values;
  }

  public BatchRowModel values(Map<String, Object> values) {
    this.values = values;
    return this;
  }
  ...
  public BatchRowModel externalId(@Nullable String externalId) {
