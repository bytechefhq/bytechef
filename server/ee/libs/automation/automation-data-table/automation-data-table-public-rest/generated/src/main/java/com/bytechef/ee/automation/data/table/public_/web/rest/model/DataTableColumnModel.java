...
public class DataTableColumnModel {
   ...
   */
  public DataTableColumnModel(String name, ColumnTypeModel type) {
    this.name = name;
    this.type = type;
  }

  public DataTableColumnModel name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DataTableColumnModel type(ColumnTypeModel type) {
    this.type = type;
    return this;
  }
