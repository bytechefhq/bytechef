...
public class EnumConverterConfiguration {
    ...
    @Bean(name = "org.openapitools.configuration.EnumConverterConfiguration.columnTypeConverter")
    Converter<String, ColumnTypeModel> columnTypeConverter() {
        return new Converter<String, ColumnTypeModel>() {
            @Override
            public ColumnTypeModel convert(String source) {
                return ColumnTypeModel.fromValue(source);
            }
        };
    }
    @Bean(name = "org.openapitools.configuration.EnumConverterConfiguration.createStrategyConverter")
    Converter<String, CreateStrategyModel> createStrategyConverter() {
        return new Converter<String, CreateStrategyModel>() {
            @Override
            public CreateStrategyModel convert(String source) {
                return CreateStrategyModel.fromValue(source);
            }
        };
    }
