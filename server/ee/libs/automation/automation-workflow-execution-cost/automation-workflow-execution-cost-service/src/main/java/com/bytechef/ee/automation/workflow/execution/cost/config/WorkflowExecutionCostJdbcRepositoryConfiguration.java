...
@EnableJdbcRepositories(basePackages = "com.bytechef.ee.automation.workflow.execution.cost.repository")
public class WorkflowExecutionCostJdbcRepositoryConfiguration {
}
