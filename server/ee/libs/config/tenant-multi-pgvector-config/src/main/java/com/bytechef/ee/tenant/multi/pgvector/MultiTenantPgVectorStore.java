...
public class MultiTenantPgVectorStore extends AbstractObservationVectorStore implements VectorStore {
    ...
    private static final Logger log = LoggerFactory.getLogger(MultiTenantPgVectorStore.class);
    ...
    private int embeddingDimensions() {
        ...
        try {
            ...
            log.warn("Failed to obtain the embedding dimensions from the embedding model and fall backs to default:"
