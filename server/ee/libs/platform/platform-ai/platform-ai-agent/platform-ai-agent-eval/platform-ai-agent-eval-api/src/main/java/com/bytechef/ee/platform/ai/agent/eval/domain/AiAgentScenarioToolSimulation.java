 ...
 * @author Ivica Cardic
 */
@Table("ai_agent_scenario_tool_simulation")
public final class AiAgentScenarioToolSimulation {
    ...
    public AiAgentScenarioToolSimulation() {
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AiAgentScenarioToolSimulation agentScenarioToolSimulation)) {
            return false;
        }
    ...
    public String toString() {
        return "AiAgentScenarioToolSimulation{" +
            "id=" + id +
