 ...
 * @author Ivica Cardic
 */
@Table("ai_agent_scenario_judge")
public final class AiAgentScenarioJudge {
    ...
    public AiAgentJudgeType getType() {
        return AiAgentJudgeType.values()[type];
    }

    public void setType(AiAgentJudgeType type) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AiAgentScenarioJudge agentScenarioJudge)) {
            return false;
        }
