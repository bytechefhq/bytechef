...
public final class AiModel {
    ...
    public AiModel(Long providerId, String name) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AiModel aiModel)) {
            return false;
        }
     ...
     * {@link com.bytechef.ee.platform.ai.model.catalog.service.AiModelService#unpin(long)}.
     */
     ...
     * {@code AiModel} would change only this accessor's Money construction, not every caller.
     */
