...
public class AiGatewayRateLimit {
    ...
    public AiGatewayRateLimit(
        String name, AiGatewayRateLimitScope scope, AiGatewayRateLimitType limitType, int limitValue,
        int windowSeconds) {
    ...
    public static AiGatewayRateLimit perProperty(
        String name, String propertyKey, AiGatewayRateLimitType limitType, int limitValue, int windowSeconds) {
        ...
        AiGatewayRateLimit rateLimit = new AiGatewayRateLimit(
            name, AiGatewayRateLimitScope.PER_PROPERTY, limitType, limitValue, windowSeconds);
