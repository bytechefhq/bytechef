...
public class AiGatewayContextCompressorImpl implements AiGatewayContextCompressor {

    private static final int ESTIMATED_DOCUMENT_TOKEN_CHARS = 1500 * 4;
    private static final int ESTIMATED_IMAGE_TOKEN_CHARS = 765 * 4;
    private static final Logger log = LoggerFactory.getLogger(AiGatewayContextCompressorImpl.class);

    private final ObjectMapper objectMapper;

    public AiGatewayContextCompressorImpl(ObjectMapper objectMapper) {
    ...
    private AiGatewayChatMessage minifyJsonContent(AiGatewayChatMessage message) {
        ...
        try {
            ...
            log.debug("Failed to minify JSON content in message (role={}): {}",
