...
public class AiGatewayCooldownTracker {
    ...
    private static final Logger log = LoggerFactory.getLogger(AiGatewayCooldownTracker.class);
    ...
    public void recordFailure(long deploymentId) {
        ...
        if (count >= DEFAULT_FAILURE_THRESHOLD) {
            log.warn("Deployment {} entering cooldown for {}s after {} consecutive failures",
