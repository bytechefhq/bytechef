...
public class AiGatewayChatModelFactoryImpl implements AiGatewayChatModelFactory {

    public AiGatewayChatModelFactoryImpl() {
    }
    ...
    private ChatModel createOpenAiCompatibleChatModel(
        ...
        // Spring AI 2.0.0-M5's OpenAiChatModel constructor builds a fresh async client from chat options when none is
        // supplied; without options the fallback fails with `credential is required`. Provide both clients explicitly.
