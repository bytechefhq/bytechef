...
public sealed interface AiObservabilityNotificationChannelConfig {
    ...
    /**
     * Webhook channel config. URL is validated by the dispatcher at send time via {@code AiObservabilityUrlValidator}
     * (SSRF guard); an optional shared HMAC secret may be sent in {@code X-ByteChef-Signature} headers.
     */
