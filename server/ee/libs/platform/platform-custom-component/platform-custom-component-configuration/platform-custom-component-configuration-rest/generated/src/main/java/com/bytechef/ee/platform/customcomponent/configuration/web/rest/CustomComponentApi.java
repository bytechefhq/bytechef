...
public interface CustomComponentApi {
    ...
    public static final String PATH_DELETE_CUSTOM_COMPONENT = "/custom-components/{id}";
    /**
    ...
    public static final String PATH_ENABLE_CUSTOM_COMPONENT = "/custom-components/{id}/enable/{enable}";
    /**
    ...
    public static final String PATH_GET_CUSTOM_COMPONENT = "/custom-components/{id}";
    /**
    ...
    public static final String PATH_GET_CUSTOM_COMPONENTS = "/custom-components";
    /**
