...
public class AwsTriggerScheduler implements TriggerScheduler {
    ...
    public void cancelDynamicWebhookTriggerRefresh(String workflowExecutionId) {
        schedulerClient.deleteSchedule(request ->
            request.clientToken(workflowExecutionId)
    ...
    @Override
    public void scheduleDynamicWebhookTriggerRefresh(LocalDateTime webhookExpirationDate, String componentName, int componentVersion, WorkflowExecutionId workflowExecutionId, Long connectionId) {
...
//                .build())
        ...
        schedulerClient.createSchedule(request ->
            request.clientToken("" + workflowExecutionId.getInstanceId())
                .groupName(SCHEDULE_TRIGGER)
    ...
    @Override
    public void scheduleScheduleTrigger(String pattern, String zoneId, Map<String, Object> output, WorkflowExecutionId workflowExecutionId) {
//        cancelScheduleTrigger("" + workflowExecutionId.getInstanceId());
...
//                .build())
    ...
    public List<ScheduleSummary> listSchedules(){
        ListSchedulesResponse listSchedulesResponse = schedulerClient.listSchedules(builder -> builder.groupName(SCHEDULE_TRIGGER));
