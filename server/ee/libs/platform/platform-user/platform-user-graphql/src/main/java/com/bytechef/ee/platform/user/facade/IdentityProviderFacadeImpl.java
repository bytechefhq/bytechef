...
/**
 * Implementation of {@link IdentityProviderFacade}. Delegates to the shared {@code IdentityProviderService} and carries
 * the {@code ADMIN} authorization guard so it is enforced for every caller of the facade.
 *
 * @version ee
 *
 * @author Ivica Cardic
