 ...
 */
@Component
public class RemoteOAuth2ServiceClient implements RemoteOAuth2Service {

    private static final String CONFIGURATION_SERVICE_APP = "configuration-service-app";
    private static final String OAUTH_2_SERVICE = "/remote/oauth2-service";

    private final LoadBalancedWebClient loadBalancedWebClient;

    @SuppressFBWarnings("EI")
    public RemoteOAuth2ServiceClient(LoadBalancedWebClient loadBalancedWebClient) {
    ...
    public Map<String, ?> checkPredefinedParameters(
        ...
        return loadBalancedWebClient.put(
            uriBuilder -> uriBuilder
                ...
                .path(OAUTH_2_SERVICE + "/check-predefined-parameters/{componentName}")
                .build(componentName),
    ...
    public String getRedirectUri() {
        return loadBalancedWebClient.get(
            uriBuilder -> uriBuilder
                .host(CONFIGURATION_SERVICE_APP)
                .path(OAUTH_2_SERVICE + "/get-redirect-uri")
                .build(),
            String.class);
    }
}
