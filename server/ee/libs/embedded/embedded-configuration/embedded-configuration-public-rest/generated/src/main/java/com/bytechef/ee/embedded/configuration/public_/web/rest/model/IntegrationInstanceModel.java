...
import com.bytechef.ee.embedded.configuration.public_.web.rest.model.IntegrationInstanceWorkflowsInnerModel;
...
public class IntegrationInstanceModel {
  ...
  @Valid
  private List<@Valid IntegrationInstanceWorkflowsInnerModel> workflows = new ArrayList<>();
  ...
  public IntegrationInstanceModel workflows(List<@Valid IntegrationInstanceWorkflowsInnerModel> workflows) {
    this.workflows = workflows;
    return this;
  }

  public IntegrationInstanceModel addWorkflowsItem(IntegrationInstanceWorkflowsInnerModel workflowsItem) {
  ...
  public List<@Valid IntegrationInstanceWorkflowsInnerModel> getWorkflows() {
    return workflows;
  }

  public void setWorkflows(List<@Valid IntegrationInstanceWorkflowsInnerModel> workflows) {
    this.workflows = workflows;
  }
