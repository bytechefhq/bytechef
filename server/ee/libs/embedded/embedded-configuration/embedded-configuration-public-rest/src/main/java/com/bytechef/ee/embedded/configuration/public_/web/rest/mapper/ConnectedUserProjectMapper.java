...
import com.bytechef.ee.embedded.configuration.public_.web.rest.model.ProjectModel;
...
public interface ConnectedUserProjectMapper extends Converter<ConnectedUserProjectDTO, ProjectModel> {

    @Override
    @Mapping(target = "workflows", source = "connectedUserProjectWorkflows")
    ProjectModel convert(ConnectedUserProjectDTO connectedUserProjectDTO);
}
