...
public interface IntegrationInstanceApi {
    ...
    public static final String PATH_DELETE_INTEGRATION_INSTANCE = "/integration-instances/{id}";
    /**
    ...
    public static final String PATH_ENABLE_INTEGRATION_INSTANCE = "/integration-instances/{id}/enable/{enable}";
    /**
    ...
    public static final String PATH_ENABLE_INTEGRATION_INSTANCE_WORKFLOW = "/integration-instances/{id}/workflows/{workflowId}/enable/{enable}";
    /**
    ...
    public static final String PATH_GET_INTEGRATION_INSTANCE = "/integration-instances/{id}";
    /**
