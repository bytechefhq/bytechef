...
import com.bytechef.ee.embedded.unified.web.rest.crm.model.InlineObjectModel;
    ...
    @Operation(
        ...
        responses = {
            ...
            @ApiResponse(responseCode = "400", description = "Bad request", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = InlineObjectModel.class))
            }),
