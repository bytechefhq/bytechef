...
public class WorkflowExecutionModel {
  ...
  public WorkflowExecutionModel integration(@Nullable IntegrationReferenceModel integration) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, status, startDate, endDate, error, inputs, outputs, integration, workflow, taskExecutions);
  }
