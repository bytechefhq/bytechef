...
package com.bytechef.ee.embedded.security.web.rest.mapper;

import com.bytechef.ee.embedded.security.domain.SigningKey;
import com.bytechef.ee.embedded.security.web.rest.mapper.config.EmbeddedSecurityMapperSpringConfig;
 ...
 * @author Ivica Cardic
 */
@Mapper(config = EmbeddedSecurityMapperSpringConfig.class)
