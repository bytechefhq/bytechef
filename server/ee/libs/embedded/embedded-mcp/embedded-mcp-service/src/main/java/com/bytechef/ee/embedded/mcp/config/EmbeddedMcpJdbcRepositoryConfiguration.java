...
package com.bytechef.ee.embedded.mcp.config;
...
@EnableJdbcRepositories(basePackages = "com.bytechef.ee.embedded.mcp.repository")
class EmbeddedMcpJdbcRepositoryConfiguration {
}
