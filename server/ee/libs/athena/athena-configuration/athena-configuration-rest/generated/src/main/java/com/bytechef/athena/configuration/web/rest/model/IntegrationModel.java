...
public class IntegrationModel {
    ...
    @Schema(
        name = "id", accessMode = Schema.AccessMode.READ_ONLY, description = "The id of an integration.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("id")
    public Long getId() {
        return id;
    ...
    @Schema(
        name = "description", description = "The description of the integration.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Valid
    @Schema(
        name = "publishedDate", description = "The published date.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(
        name = "integrationVersion", description = "The version of an integration.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(
        name = "status", description = "A status of an integration.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("status")
    ...
    @Schema(
        name = "workflowIds", description = "The workflow ids belonging to this integration.",
        requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(category, createdBy, createdDate, id, name, description, lastModifiedBy, lastModifiedDate,
            publishedDate, integrationVersion, status, tags, workflowIds, version);
    }
    ...
    public String toString() {
        ...
        sb.append("    publishedDate: ")
            .append(toIndentedString(publishedDate))
            .append("\n");
        sb.append("    integrationVersion: ")
            .append(toIndentedString(integrationVersion))
            .append("\n");
        sb.append("    status: ")
        ...
        sb.append("    tags: ")
            ...
            .append("\n");
        sb.append("    workflowIds: ")
            .append(toIndentedString(workflowIds))
            .append("\n");
        sb.append("    version: ")
