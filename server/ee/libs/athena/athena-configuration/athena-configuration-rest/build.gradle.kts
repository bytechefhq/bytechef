...
val generateOpenAPISpring by tasks.registering(org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    apiPackage.set("com.bytechef.athena.configuration.web.rest")
    configOptions.set(
        mapOf(
    ...
    modelPackage.set("com.bytechef.athena.configuration.web.rest.model")
...
val generateOpenAPITypeScriptFetch by tasks.registering(org.openapitools.generator.gradle.plugin.tasks.GenerateTask::class) {
    ...
    inputSpec.set("$projectDir/openapi.yaml")
    modelNameSuffix.set("Model")
    outputDir.set("$rootDir/client/src/ee/middleware/athena/configuration")
    typeMappings.set(
        mapOf(
            "DateTime" to "Date"
        )
...
dependencies {
    ...
    implementation(project(":server:ee:libs:athena:athena-configuration:athena-configuration-api"))
    implementation(project(":server:ee:libs:athena:athena-configuration:athena-configuration-api"))
