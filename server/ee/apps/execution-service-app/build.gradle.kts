...
dependencies {
    ...
    implementation(project(":server:libs:atlas:atlas-execution:atlas-execution-converter"))
    ...
    implementation(project(":server:libs:hermes:hermes-data-storage:hermes-data-storage-converter"))
    implementation(project(":server:libs:hermes:hermes-data-storage:hermes-data-storage-db-service"))
    implementation(project(":server:libs:hermes:hermes-execution:hermes-execution-converter"))
