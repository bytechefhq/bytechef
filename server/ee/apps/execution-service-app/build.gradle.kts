...
dependencies {
    ...
    implementation(project(":server:libs:core:data-storage:data-storage-converter"))
    ...
    implementation(project(":server:libs:core:file-storage:file-storage-converter"))
