...
dependencies {
    ...
    run {
        rootProject.subprojects
            ...
            .filterNot { it.path in setOf(":server:libs:modules:components:ai:agent:chat-memory:chat-memory-builtin", ":server:libs:modules:components:ai:agent:chat-memory:chat-memory-jdbc", ":server:libs:modules:components:data-stream", ":server:libs:modules:components:example") }
            .sortedBy { it.path }
