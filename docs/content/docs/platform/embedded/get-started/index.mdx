...
- [Embedded Configuration APIs](/openapi/embedded-configuration-integration) — programmatic CRUD for integrations, workflows, and connections, designed for product surfaces.
