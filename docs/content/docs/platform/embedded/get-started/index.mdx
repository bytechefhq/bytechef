...
- [White-label execution](/platform/embedded/get-started/white-label-execution) — the workflow engine running inside your product, branded as yours.
- [Tenant-isolated security](/platform/embedded/get-started/tenant-isolated-security) — the multi-tenant defaults each connected user's data sits behind.
