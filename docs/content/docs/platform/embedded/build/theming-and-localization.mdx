...
- [Component Kit](/platform/embedded/build/component-kit) - the tools API, where the names and descriptions your agent surfaces come from the components themselves rather than from your copy.
