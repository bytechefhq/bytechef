...
and [add documents](/platform/automation/data/knowledge-base/add-documents) later.
...
[Use it in workflows & agents](/platform/automation/data/knowledge-base/use-in-workflows#filtering-by-tag).
