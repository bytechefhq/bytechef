...
description: Test voice workflows directly from the workflow editor's Playground panel, without deploying or embedding them.
ee: true
comingSoon: true
---
...
sub-workflow under `websocketTasks`. See the [Voice Quickstart](./quickstart).
...
- [Voice Quickstart](./quickstart) - initial workflow setup
