...
Bearer tokens should be treated with extreme care, as anyone who has the token has full access to the associated resources. ByteChef encrypts all stored bearer tokens at rest with AES-GCM to ensure they are protected.

---

Related: [Troubleshooting Bearer Auth](/platform/automation/build/connections/troubleshooting#api-key-bearer-and-basic-auth-issues)
