...
| `BYTECHEF_MAIL_BASE_URL` | Base URL for mail links | - |
...
| Environment Variable | Description | Default Value |
|----------------------|-------------|---------------|
| `BYTECHEF_OAUTH2_REDIRECT_URI` | OAuth2 redirect URI | - |
...
| Environment Variable | Description | Default Value |
|----------------------|-------------|---------------|
| `BYTECHEF_SECURITY_CONTENT_SECURITY_POLICY` | Content Security Policy | - |
