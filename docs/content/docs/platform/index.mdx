...
<Cards>
  <Card icon={<Workflow className="text-purple-300" />} title='Automation' href="/automation/getting_started">
  ...
  <Card icon={<LayoutTemplate className="text-blue-300" />} title='Embedded' href="/embedded/getting_started">
...
<Callout title="Want to learn more?">
  Read our in-depth [Platform Overview](/platform/platform-overview) introduction.
</Callout>
