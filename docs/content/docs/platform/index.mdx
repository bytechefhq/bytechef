...
<Cards>
  <Card icon={<Workflow className="text-purple-300" />} title='Automation' href="/platform/automation/getting_started">
  ...
  <Card icon={<LayoutTemplate className="text-blue-300" />} title='Embedded' href="/platform/embedded/getting_started">
  ...
  <Card icon={<Blocks />} title='Developer Guide' href='/developers'>
...
<Callout title="Want to learn more?">
  Read our in-depth [What is ByteChef](/platform/what-is-bytechef) introduction.
</Callout>
