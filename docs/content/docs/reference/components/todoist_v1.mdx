...
| labels | Labels | ARRAY <details> <summary> Items </summary> [STRING] </details> | List of labels to be applied to the task. | false |
| section_id | Section ID | STRING <details> <summary> Depends On </summary> project_id </details> | ID of the section to add the task to. | false |
...
| labels | ARRAY <details> <summary> Items </summary> [STRING] </details> | List of labels applied to the task. |
| checked | BOOLEAN <details> <summary> Options </summary> <span>true</span>, <span>false</span> </details> | Whether the task is checked. |
| is_deleted | BOOLEAN <details> <summary> Options </summary> <span>true</span>, <span>false</span> </details> | Whether the task is deleted. |
