...
```{_links=[{schema=string, targetSchema=string, method=GET, rel=string, href=string}], id=string, timestamp_signup=2019-08-24T14:15:22, interests={property2=true, property1=true}, language=string, email_type=string, marketing_permissions=[{enabled=true, marketing_permission_id=string, text=string}], tags=[{id=0, name=string}], ip_signup=string, location={latitude=0, region=string, longitude=0, gmtoff=0, country_code=string, timezone=string, dstoff=0}, ip_opt=string, timestamp_opt=2019-08-24T14:15:22, unsubscribe_reason=string, status=subscribed, email_address=string, last_note={created_by=string, note=string, created_at=2019-08-24T14:15:22, note_id=0}, contact_id=string, stats={avg_click_rate=0, ecommerce_data={number_of_orders=0, total_revenue=0, currency_code=USD}, avg_open_rate=0}, merge_fields={property2=, property1=}, full_name=string, list_id=string, tags_count=0, unique_email_id=string, email_client=string, consents_to_one_to_one_messaging=true, source=string, last_changed=2019-08-24T14:15:22, vip=true, member_rating=0, web_id=0}```
...
| fired_at | DATE_TIME | The date and time the webhook was triggered. |
