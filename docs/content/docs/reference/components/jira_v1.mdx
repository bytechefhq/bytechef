...
| accountId | Account ID | STRING <details> <summary> Depends On </summary> project </details> | ID of the account user who will be assigned the issue. | true |
...
|:------------:|:------------:|:-------------------:|
| assigned | BOOLEAN <details> <summary> Options </summary> true, false </details> |  |
