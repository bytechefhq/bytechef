...
|      Name       |      Label     |     Type     |     Description     | Required |
|:---------------:|:--------------:|:------------:|:-------------------:|:--------:|
| author | Post As | STRING <details> <summary> Options </summary> <span>PERSON</span>, <span>ORGANIZATION</span> </details> | Choose whether to post as a Person or Organization. | true |
...
| contentType | Media Category | STRING <details> <summary> Options </summary> <span>ARTICLE</span>, <span>DOCUMENT</span>, <span>IMAGES</span> </details> | Type of media to be posted. | false |
| visibility | Visibility | STRING <details> <summary> Options </summary> <span title="Anyone can view this.">PUBLIC</span>, <span title="Represents 1st degree network of owner.">CONNECTIONS</span> </details> | Visibility restrictions on content. | true |
...
|:------------:|:------------:|:-------------------:|
| isReshareDisabledByAuthor | BOOLEAN <details> <summary> Options </summary> <span>true</span>, <span>false</span> </details> | Indicates whether resharing of the post has been disabled by the author. |
