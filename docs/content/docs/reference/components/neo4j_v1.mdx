...
| initializeSchema | Initialize Schema | BOOLEAN <details> <summary> Options </summary> true, false </details> | Whether to initialize the required schema | false |
...
| distanceType | Distance Type | STRING <details> <summary> Options </summary> COSINE, EUCLIDEAN </details> | The distance function to use. | false |
