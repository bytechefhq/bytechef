...
| format | Format | STRING <details> <summary> Options </summary> STRUCTURED_SUMMARY, BRIEF_TITLE, CONCISE_SENTENCE, BULLETED_LIST, CUSTOM_PROMPT </details> | In what format do you wish the text summarized? | true |
