...
|:------------:|:------------:|:-------------------:|
| links | OBJECT <details> <summary> Properties </summary> &#123;&#125; </details> |  |
| contacts | ARRAY <details> <summary> Items </summary> [&#123;STRING\(id), STRING\(name), STRING\(description), [&#123;BOOLEAN\(isPrimary), STRING\(name), STRING\(value)&#125;]\(emails), [&#123;BOOLEAN\(isPrimary), STRING\(name), &#123;STRING\(countryCode), STRING\(number), STRING\(extension), STRING\(numberFormatted), STRING\(E164), STRING\(countryCodeAndNumber)&#125;\(value)&#125;]\(phones)&#125;] </details> |  |
