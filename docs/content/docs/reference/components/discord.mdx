...
| tts | BOOLEAN <details> <summary> Options </summary> true, false </details> | Whether this was a TTS message. |
...
| pinned | BOOLEAN <details> <summary> Options </summary> true, false </details> | Whether this message is pinned. |
| mention_everyone | BOOLEAN <details> <summary> Options </summary> true, false </details> | Whether this message mentions everyone. |
...
| nsfw | BOOLEAN <details> <summary> Options </summary> true, false </details> | Whether the channel is marked as NSFW (Not Safe For Work). |
