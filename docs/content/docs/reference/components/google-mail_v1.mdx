...
| labelIds | Labels IDs | ARRAY <details> <summary> Items </summary> [STRING] </details> | ID of the labels to add to message. You can add up to 100 labels with each update. | true |
...
| labelIds | Labels IDs | ARRAY <details> <summary> Items </summary> [STRING] </details> | ID of the labels to remove from message. | true |
