...
| allDay | All Day Event? | BOOLEAN <details> <summary> Options </summary> <span>true</span>, <span>false</span> </details> | Whether it is an all day event. | true |
...
| attachments | Attachments | ARRAY <details> <summary> Items </summary> [FILE_ENTRY] </details> | The attachments to the event. | false |
...
| reminders | Reminders | ARRAY <details> <summary> Items </summary> [&#123;STRING\(method), INTEGER\(minutes)&#125;] </details> | The reminders that will be sent about the event. | false |
...
| dateRange | Date Range | OBJECT <details> <summary> Properties </summary> &#123;DATE\(fromDate), TIME\(fromTime), DATE\(toDate), TIME\(toTime)&#125; </details> | Date range to find events that exist in this range. | false |
...
|:---------------:|:--------------:|:------------:|:-------------------:|:--------:|
| calendarId | Calendar ID | STRING | Unique identifier of the calendar. | true |
| dateRange | Date Range | OBJECT <details> <summary> Properties </summary> &#123;DATE\(fromDate), TIME\(fromTime), DATE\(toDate), TIME\(toTime)&#125; </details> | Date range to find free time. | true |
...
| allDay | All Day Event? | BOOLEAN <details> <summary> Options </summary> <span>true</span>, <span>false</span> </details> | Whether it is an all day event. | false |
