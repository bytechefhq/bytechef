...
| unit | Unit to Extract | STRING <details> <summary> Options </summary> year, month, day, hour, minute, second, dayOfWeek, monthName, date, time </details> | Unit to extract from the input date. | true |
