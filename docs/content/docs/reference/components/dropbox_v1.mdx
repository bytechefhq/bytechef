...
|      Name       |      Label     |     Type     |     Description     | Required |
|:---------------:|:--------------:|:------------:|:-------------------:|:--------:|
| from_path | Source Path | STRING | The source path of the file. | true |
| to_path | Destination Path | STRING | The destination path for the copied file. | true |
| autorename | Auto Rename | BOOLEAN <details> <summary> Options </summary> <span>true</span>, <span>false</span> </details> | If there's a conflict, have the Dropbox server try to autorename the file to avoid the conflict. | false |
...
|:------------:|:------------:|:-------------------:|
| metadata | OBJECT <details> <summary> Properties </summary> &#123;STRING\(name), STRING\(path_lower), STRING\(path_display), STRING\(id)&#125; </details> | Metadata containing details about the copied file. |
...
|      Name       |      Label     |     Type     |     Description     | Required |
|:---------------:|:--------------:|:------------:|:-------------------:|:--------:|
| from_path | From Path | STRING | The source path of the folder. | true |
| to_path | Destination Path | STRING | The destination path for the copied folder. | true |
| autorename | Auto Rename | BOOLEAN <details> <summary> Options </summary> <span>true</span>, <span>false</span> </details> | If there's a conflict, have the Dropbox server try to autorename the folder to avoid the conflict. | false |
...
|     Name     |     Type     |     Description     |
|:------------:|:------------:|:-------------------:|
| metadata | OBJECT <details> <summary> Properties </summary> &#123;STRING\(name), STRING\(path_lower), STRING\(path_display), STRING\(id)&#125; </details> | Metadata containing details about the copied folder. |
...
|     Name     |     Type     |     Description     |
|:------------:|:------------:|:-------------------:|
| metadata | OBJECT <details> <summary> Properties </summary> &#123;STRING\(name), STRING\(path_lower), STRING\(path_display), STRING\(id)&#125; </details> | Metadata containing details about the deleted file. |
...
|     Name     |     Type     |     Description     |
|:------------:|:------------:|:-------------------:|
| metadata | OBJECT <details> <summary> Properties </summary> &#123;STRING\(name), STRING\(path_lower), STRING\(path_display), STRING\(id)&#125; </details> | Metadata containing details about the deleted folder. |
...
|      Name       |      Label     |     Type     |     Description     | Required |
|:---------------:|:--------------:|:------------:|:-------------------:|:--------:|
| from_path | Source Path | STRING | Path of the file in the user's Dropbox to be moved. | true |
| to_path | Destination Path | STRING | Path in the user's Dropbox that is the destination. | true |
| autorename | Auto Rename | BOOLEAN <details> <summary> Options </summary> <span>true</span>, <span>false</span> </details> | If there's a conflict, have the Dropbox server try to autorename the file to avoid the conflict. | false |
...
|     Name     |     Type     |     Description     |
|:------------:|:------------:|:-------------------:|
| metadata | OBJECT <details> <summary> Properties </summary> &#123;STRING\(name), STRING\(path_lower), STRING\(path_display), STRING\(id)&#125; </details> | Metadata containing details about the moved file. |
...
|      Name       |      Label     |     Type     |     Description     | Required |
|:---------------:|:--------------:|:------------:|:-------------------:|:--------:|
| from_path | Source Path | STRING | Path in the user's Dropbox to be moved. | true |
| to_path | Destination Path | STRING | Path in the user's Dropbox that is the destination. | true |
| autorename | Auto Rename | BOOLEAN <details> <summary> Options </summary> <span>true</span>, <span>false</span> </details> | If there's a conflict, have the Dropbox server try to autorename the folder to avoid the conflict. | false |
...
|     Name     |     Type     |     Description     |
|:------------:|:------------:|:-------------------:|
| metadata | OBJECT <details> <summary> Properties </summary> &#123;STRING\(name), STRING\(path_lower), STRING\(path_display), STRING\(id)&#125; </details> | Metadata containing details about the moved folder. |
