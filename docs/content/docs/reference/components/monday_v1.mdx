...
| workspace_id | Workspace ID | STRING | ID of the workspace where the board is located. | false |
| board_id | Board ID | STRING <details> <summary> Depends On </summary> workspace_id </details> | ID of the board where new item will be created. | true |
| group_id | Group ID | STRING <details> <summary> Depends On </summary> board_id </details> | The item's group. | false |
| item_name | Item Name | STRING | The item's name. | true |
| columnValues | | DYNAMIC_PROPERTIES <details> <summary> Depends On </summary> board_id </details> |  | false |
...
| item_id | Item ID | STRING <details> <summary> Depends On </summary> board_id </details> | ID of the item to delete. | true |
...
| column_id | Column ID | STRING <details> <summary> Depends On </summary> board_id </details> | Column ID. | true |
| item_id | Item ID | STRING <details> <summary> Depends On </summary> board_id </details> | ID of the item to update. | true |
