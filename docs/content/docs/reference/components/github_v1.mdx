...
| in | In | STRING <details> <summary> Options </summary> <span>file</span>, <span>path</span>, <span>file,path</span> </details> | Restricts your search to the contents of the source code file, the file path, or both. | false |
...
| incomplete_results | BOOLEAN <details> <summary> Options </summary> <span>true</span>, <span>false</span> </details> | Whether the results are incomplete. |
| items | ARRAY <details> <summary> Items </summary> [&#123;STRING\(name), STRING\(path), STRING\(sha), STRING\(url), STRING\(git_url), STRING\(html_url), NUMBER\(score), &#123;INTEGER\(id), STRING\(name), STRING\(full_name), STRING\(html_url), STRING\(url)&#125;\(repository)&#125;] </details> | List of code search results. |
...
| issue | Issue Number | STRING <details> <summary> Depends On </summary> repository, owner </details> | The number of the issue you want to update. | true |
| title | Title | STRING | The new title of the issue. | false |
| body | Body | STRING | The updated description of the issue. | false |
| state | State | STRING <details> <summary> Options </summary> <span>open</span>, <span>closed</span> </details> | The new state of the issue (open/closed). | false |
...
| labels | Labels | ARRAY <details> <summary> Items </summary> [STRING] </details> | A list of labels to associate with this issue. | false |
| assignees | Assignees | ARRAY <details> <summary> Items </summary> [STRING] </details> | A list of usernames to assign this issue. | false |
