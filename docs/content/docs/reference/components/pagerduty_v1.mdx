...
| assignments | Assignments | ARRAY <details> <summary> Items </summary> [STRING\($userId)] </details> | Assign the incident to these assignees. | false |
...
| escalation_policy | Escalation Policy ID | STRING | Delegate this incident to the specified escalation policy. Cannot be specified if an assignee is given. | false |
