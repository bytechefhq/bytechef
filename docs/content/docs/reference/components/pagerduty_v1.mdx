...
| urgency | Urgency | STRING <details> <summary> Options </summary> high, low </details> | The urgency level of this incident. | false |
...
| status | Status | STRING <details> <summary> Options </summary> resolved, acknowledged </details> | The new status of the incident. | false |
| assignments | Assignments | ARRAY <details> <summary> Items </summary> [STRING\($assignee)] </details> | Assign the incident to these assignees. | false |
