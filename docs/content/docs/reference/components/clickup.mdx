...
`Create a new comment for specified class.`
...
| spaceId | Space ID | STRING <details> <summary> Depends On </summary> workspaceId </details> |  | true |
| folderId | Folder ID | STRING <details> <summary> Depends On </summary> spaceId, workspaceId </details> |  | false |
| listId | List ID | STRING <details> <summary> Depends On </summary> folderId, spaceId, workspaceId </details> |  | true |
| taskId | Task ID | STRING <details> <summary> Depends On </summary> listId, folderId, spaceId, workspaceId </details> | ID of the task to which the comment will be added. | true |
| comment_text | Comment Text | STRING | Text of the comment to be added to the task. | true |
| notifty_all | Notify All | BOOLEAN <details> <summary> Options </summary> true, false </details> | Flag indicating whether notifications should be sent to all participants, including the creator of the comment. | true |
...
```json
{
  ...
  "type" : "clickup/v1/createTaskComment"
}
```
...
|     Name     |     Type     |     Description     |
|:------------:|:------------:|:-------------------:|
| id | STRING | The ID of newly created comment. |
| hist_id | STRING | The hist ID of newly created comment. |
| date | INTEGER | The date of the newly created comment. |
