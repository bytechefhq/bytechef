...
|      Name       |      Label     |     Type     |     Description     | Required |
|:---------------:|:--------------:|:------------:|:-------------------:|:--------:|
| taskGid | Task gID | STRING <details> <summary> Depends On </summary> data.workspace, data.project </details> | The task gID of the task that will be the parent of the subtask. | true |
| data | Data | OBJECT <details> <summary> Properties </summary> &#123;STRING\(workspace), STRING\(project), STRING\(name), STRING\(notes), DATE\(due_on), STRING\(assignee)&#125; </details> |  | false |
