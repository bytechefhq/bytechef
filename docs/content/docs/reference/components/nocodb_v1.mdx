...
| tableId | Table ID | STRING <details> <summary> Depends On </summary> baseId </details> | ID of the table. | true |
| tableColumns | | DYNAMIC_PROPERTIES <details> <summary> Depends On </summary> tableId </details> |  | false |
