---
description: "Elevenlabs integration for ByteChef. Connect and automate with this service in your workflows. Learn how to implement this in your ByteChef automation."
title: ElevenLabs
---
...
```json
{
  ...
  "type" : "elevenLabs/v1/streamSpeech"
}
```
