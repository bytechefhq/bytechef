---
description: 'description: Learn how to use AI Agent in ByteChef. Comprehensive guide
  with examples'
title: AI Agent
---
...
| conversationId | null | STRING | The conversation id used in conjunction with memory. | false |
