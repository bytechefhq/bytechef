...
| signingSecret | Signing Secret | STRING | The Slack app's signing secret. When set, approval request messages use in-place Approve/Discard buttons resolved directly in Slack — configure the app's Interactivity Request URL to &lt;public-url&gt;/slack/interactivity. When unset, buttons link to the hosted approval form. | false |
...
|:------------:|:------------:|:-------------------:|
| ok | BOOLEAN <details> <summary> Options </summary> <span>true</span>, <span>false</span> </details> | Indicates if the reaction was successfully added. |
| warning | STRING |  |
...
| attachments | ARRAY <details> <summary> Items </summary> [FILE_ENTRY] </details> | Files that arrived with the message. |
...
### Add Integration To Desired Channel
...
<div style={{ position: 'relative', height:0, width: '100%', overflow: 'hidden', zindex: 49, boxSizing: 'border-box', paddingBottom: 'calc(50.05219207% + 32px)'}}>
    <iframe src="https://www.guidejar.com/embed/86a2cc77-3a2d-4a26-836e-68e37be713b1?type=1&controls=on" width="100%" height="100%" style={{height:'100%', position:'absolute', inset:0}} allowFullScreen frameBorder="0"></iframe>
</div>
