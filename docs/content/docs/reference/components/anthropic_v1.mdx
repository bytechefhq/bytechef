...
|      Name       |      Label     |     Type     |     Description     | Required |
|:---------------:|:--------------:|:------------:|:-------------------:|:--------:|
| model | Model | STRING <details> <summary> Options </summary> <span>claude-3-haiku-20240307</span>, <span>claude-haiku-4-5</span>, <span>claude-opus-4-0</span>, <span>claude-opus-4-1</span>, <span>claude-opus-4-5</span>, <span>claude-opus-4-6</span>, <span>claude-sonnet-4-0</span>, <span>claude-sonnet-4-5</span>, <span>claude-sonnet-4-6</span> </details> | ID of the model to use. | true |
