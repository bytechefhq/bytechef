...
|:---------------:|:--------------:|:------------:|:-------------------:|:--------:|
| port | Port | INTEGER | `Defines the port to connect to the email server.` | true |
| protocol | Protocol | STRING <details> <summary> Options </summary> imap, pop3 </details> | `Protocol defines communication procedure. IMAP allows receiving emails. POP3 is older protocol for receiving emails.` | true |
...
| contentType | STRING |  |
| from | STRING |  |
| hasAttachments | BOOLEAN <details> <summary> Options </summary> true, false </details> |  |
| subject | STRING |  |
