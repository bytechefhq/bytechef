...
|      Name       |      Label     |     Type     |     Description     | Required |
|:---------------:|:--------------:|:------------:|:-------------------:|:--------:|
| model | Model | STRING <details> <summary> Options </summary> codestral-latest, devstral-small-latest, magistral-medium-latest, magistral-small-latest, ministral-3b-latest, ministral-8b-latest, mistral-large-latest, mistral-medium-latest, mistral-small-latest, open-mistral-nemo, pixtral-12b-2409, pixtral-large-latest </details> | ID of the model to use. | true |
...
| type | Type | STRING <details> <summary> Options </summary> image_url, document_url, file </details> | Type of the document to run OCR on. | true |
...
|      Name       |      Label     |     Type     |     Description     | Required |
|:---------------:|:--------------:|:------------:|:-------------------:|:--------:|
| purpose | Purpose | STRING <details> <summary> Options </summary> fine-tune, batch, ocr </details> | Model to use. | false |
