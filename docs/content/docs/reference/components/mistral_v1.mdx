...
|      Name       |      Label     |     Type     |     Description     | Required |
|:---------------:|:--------------:|:------------:|:-------------------:|:--------:|
| model | Model | STRING <details> <summary> Options </summary> <span>codestral-latest</span>, <span>ministral-14b-latest</span>, <span>ministral-3b-latest</span>, <span>ministral-8b-latest</span>, <span>mistral-large-latest</span>, <span>mistral-medium-latest</span>, <span>mistral-small-latest</span> </details> | ID of the model to use. | true |
