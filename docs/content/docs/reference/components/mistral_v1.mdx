...
|      Name       |      Label     |     Type     |     Description     | Required |
|:---------------:|:--------------:|:------------:|:-------------------:|:--------:|
| model | Model | STRING <details> <summary> Options </summary> <span>codestral-latest</span>, <span>devstral-medium-latest</span>, <span>devstral-small-latest</span>, <span>magistral-medium-latest</span>, <span>magistral-small-latest</span>, <span>ministral-14b-latest</span>, <span>ministral-3b-latest</span>, <span>ministral-8b-latest</span>, <span>mistral-large-latest</span>, <span>mistral-medium-latest</span>, <span>mistral-small-latest</span>, <span>open-mistral-nemo</span> </details> | ID of the model to use. | true |
