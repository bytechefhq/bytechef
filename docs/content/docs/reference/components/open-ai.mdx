...
|      Name       |      Label     |     Type     |     Description     | Required |
|:---------------:|:--------------:|:------------:|:-------------------:|:--------:|
| model | Model | STRING <details> <summary> Options </summary> gpt-4o-mini-tts, tts-1, tts-1-hd </details> | Text-to-Speech model which will generate the audio. | true |
| input | Input | STRING | The text to generate audio for. | true |
| voice | Voice | STRING <details> <summary> Options </summary> ALLOY, ASH, BALLAD, CORAL, ECHO, FABLE, NOVA, ONYX, SAGE, SHIMMER, VERSE </details> | The voice to use when generating the audio. | true |
