...
| extraction_mode | Extraction Mode | BOOLEAN <details> <summary> Options </summary> <span>true</span>, <span>false</span> </details> | When false, enables markdown conversion mode (2 credits per page). Default is true. | false |
