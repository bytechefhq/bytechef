...
|      Name       |      Label     |     Type     |     Description     | Required |
|:---------------:|:--------------:|:------------:|:-------------------:|:--------:|
| type | Type | STRING <details> <summary> Options </summary> <span>person</span>, <span>organization</span> </details> | Represents if this party is a person or an organization. | true |
