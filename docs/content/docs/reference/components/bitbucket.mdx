...
| scm | Source Control Management. | STRING <details> <summary> Options </summary> git </details> | Specifies the version control system that your repository will use. | true |
| project | Project | OBJECT <details> <summary> Properties </summary> &#123;STRING\(key)&#125; </details> | Parent project of the repository. | true |
| is_private | Is Private | BOOLEAN <details> <summary> Options </summary> true, false </details> | Whether the repository is private or not. | false |
| description | Description | STRING | The description of repository. | false |
| fork_policy | Fork Policy | STRING <details> <summary> Options </summary> allow_forks, no_public_forks, no_forks </details> | Specifies the fork policy for the repository. | false |
...
| is_private | BOOLEAN <details> <summary> Options </summary> true, false </details> | Indicates whether the repository is private. |
...
| has_issues | BOOLEAN <details> <summary> Options </summary> true, false </details> | Indicates whether the issue tracker is enabled. |
| has_wiki | BOOLEAN <details> <summary> Options </summary> true, false </details> | Indicates whether the wiki is enabled. |
...
| is_private | Is Private | BOOLEAN <details> <summary> Options </summary> true, false </details> | Whether the project is private or not. | false |
...
| is_private | BOOLEAN <details> <summary> Options </summary> true, false </details> | Indicates whether the project is private. |
...
| has_publicly_visible_repos | BOOLEAN <details> <summary> Options </summary> true, false </details> | Indicates if the project contains any public repositories. |
