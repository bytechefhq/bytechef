...
| columns | Fields | ARRAY <details> <summary> Items </summary> [&#123;STRING\(name), STRING\(type)&#125;] </details> | `The list of the table field names where corresponding values would be inserted.` | false |
...
| columns | Fields | ARRAY <details> <summary> Items </summary> [&#123;STRING\(name), STRING\(type)&#125;] </details> | `The list of the table field names where corresponding values would be updated.` | false |
| values | | DYNAMIC_PROPERTIES <details> <summary> Depends On </summary> columns </details> |  | null |
...
| orderDirection | Order Direction | STRING <details> <summary> Options </summary> ASC, DESC </details> | `The direction to sort by such that the newest rows are fetched first.` | true |
