...
- **[ByteChef Cloud](https://app.bytechef.io/)**: We host it. Zero installation. Best for testing and getting familiar with platform. We'll use this for this guide.
...
- **Your own infrastructure (Self-Hosted)**: Deploy and run ByteChef yourself. Supported on:
  ...
  - [GCP](/self-hosting/deployment/google-cloud)
...
- Go to your ByteChef dashboard on [Cloud](https://app.bytechef.io/) or Self-hosted instance
...
Every workflow in ByteChef starts with a trigger, it's event that kicks off your automation.
...
You can view and download the complete JSON representation of the workflow you just built from this link:

View this workflow's [JSON Example](https://www.npoint.io/docs/95e9a7405b87b7986698) and test in the Visual Workflow Builder.

This JSON file contains the complete workflow structure including:
- Manual Trigger configuration
- Spotify Create Playlist component setup
- Slack Send Message component with expressions
- Node connections and workflow flow

You can use this as a reference or import it directly into ByteChef to get started quickly.
