...
Choose how you want to run ByteChef. Deploy to cloud and let us handle infrastructure, or run it yourself on Docker, Kubernetes, AWS, Azure, Google Cloud, or DigitalOcean. Complete control over your data and deployment.
...
**Ready to build your first automation?** Start with the [Quick Start guide](/getting-started/quickstart) and see what's possible in just minutes.
