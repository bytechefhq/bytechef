...
- **[Automation Guide](/automation/overview)** — Learn workflow fundamentals
- **[Browse Integrations](/reference/components)** — Explore 500+ pre-built connections
- **[Developer Guide](/developer-guide/generate-component/initial-setup)** — Create custom components and extend ByteChef
