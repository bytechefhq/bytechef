...
# Getting Started with ByteChef Automation

ByteChef Automation allows you to easily build and run smart workflows that connect your apps, automate routine tasks, and include AI-driven decisions—all without heavy coding. This guide will help you understand the basics and get started with creating your first workflow.

## What is ByteChef Automation?

ByteChef Automation is a powerful platform that enables you to:
...
Before diving into creating workflows, it's helpful to understand some key concepts. Check them in the [Glossary](/platform/automation/glossary).
...
<Callout title="Quick Start Guides">
  ...
  - [Star a Repository on GitHub](/platform/automation/quick-start/star-repository-on-github)
  - [Configure workflow trigger](/platform/automation/quick-start/configure-workflow-trigger)
</Callout>
